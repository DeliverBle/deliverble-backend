...
// 추천 태그 생성
let tagTestRecommend = new Tag_1.Tag();
tagTestRecommend.name = '딜리버블 추천';
// 뉴스 별 태그, 스크립트 생성
// 1번 뉴스
let tagTest1_1 = new Tag_1.Tag();
tagTest1_1.name = '경제';
let tagTest1_2 = new Tag_1.Tag();
tagTest1_2.name = '비트코인';
let tagTest1_3 = new Tag_1.Tag();
tagTest1_3.name = '폭락';
let scriptTest1_1 = new Script_1.Script();
scriptTest1_1.startTime = new Time_1.Time(0, 0);
scriptTest1_1.endTime = new Time_1.Time(7, 7);
scriptTest1_1.text = '비트코인 가격이 1만 8천 달러선으로 폭락하면서 2020년 이후 최대치를 나타내고 있습니다.';
let scriptTest1_2 = new Script_1.Script();
scriptTest1_2.startTime = new Time_1.Time(7, 7);
scriptTest1_2.endTime = new Time_1.Time(14, 78);
scriptTest1_2.text = '가상화폐 정보 사이트 코인게코에 따르면 비트코인 가격은 오늘 오전 한때 1만 7,800달러까지 하락하기도 했습니다.';
let scriptTest1_3 = new Script_1.Script();
scriptTest1_3.startTime = new Time_1.Time(14, 78);
scriptTest1_3.endTime = new Time_1.Time(20, 55);
scriptTest1_3.text = '비트코인은 물가 상승 압력에 따른 세계적인 금리 인상 등의 여파로 12일 연속 하락했습니다.';
let scriptTest1_4 = new Script_1.Script();
scriptTest1_4.startTime = new Time_1.Time(20, 55);
scriptTest1_4.endTime = new Time_1.Time(26, 55);
scriptTest1_4.text = '시가총액 2위 이더리움의 가격은 1천 달러가 무너지는 등 다른 코인의 가격도 동반 하락했습니다.';
let scriptTest1_5 = new Script_1.Script();
scriptTest1_5.startTime = new Time_1.Time(26, 85);
scriptTest1_5.endTime = new Time_1.Time(35, 4);
scriptTest1_5.text = '가격이 폭락하면서 한때 3조 달러가 넘었던 전 세계 가상화폐 시장의 시가총액은 8천억 달러 선으로 하락했습니다.';
// 2번 뉴스
let tagTest2_1 = new Tag_1.Tag();
tagTest2_1.name = '북한';
let tagTest2_2 = new Tag_1.Tag();
tagTest2_2.name = '환경';
let tagTest2_3 = new Tag_1.Tag();
tagTest2_3.name = '임진강';
let scriptTest2_1 = new Script_1.Script();
scriptTest2_1.startTime = new Time_1.Time(0, 0);
scriptTest2_1.endTime = new Time_1.Time(8, 18);
scriptTest2_1.text = '북한이 호우로 임진강 상류 황강댐 수문을 개방한 것으로 판단하고 있다고 군 소식통이 오늘 밝혔습니다.';
let scriptTest2_2 = new Script_1.Script();
scriptTest2_2.startTime = new Time_1.Time(8, 18);
scriptTest2_2.endTime = new Time_1.Time(16, 71);
scriptTest2_2.text = '정부는 지난 28일 북한에 댐을 방류하면 사전 통지해 달라고 요청했지만, 북한은 이에 대한 응답 없이 방류에 나선 것으로 보입니다.';
let scriptTest2_3 = new Script_1.Script();
scriptTest2_3.startTime = new Time_1.Time(16, 71);
scriptTest2_3.endTime = new Time_1.Time(27, 10);
scriptTest2_3.text = '군남댐 수위와 연계되는 임진강 최북단 필승교의 수위는 지난 28일 6m까지 오르기도 했지만 이후 현재까지 안정적으로 관리되고 있는 것으로 알려졌습니다.';
let scriptTest2_4 = new Script_1.Script();
scriptTest2_4.startTime = new Time_1.Time(27, 10);
scriptTest2_4.endTime = new Time_1.Time(35, 74);
scriptTest2_4.text = '통일부는 이와 관련해 북한이 사전 통지 없이 황강댐 물을 방류한 데 대해 유감이라고 밝혔습니다.';
// 3번 뉴스
let tagTest3_1 = new Tag_1.Tag();
tagTest3_1.name = '제주';
let tagTest3_2 = new Tag_1.Tag();
tagTest3_2.name = '예산';
let tagTest3_3 = new Tag_1.Tag();
tagTest3_3.name = '무상급식';
let scriptTest3_1 = new Script_1.Script();
scriptTest3_1.startTime = new Time_1.Time(0, 0);
scriptTest3_1.endTime = new Time_1.Time(4, 74);
scriptTest3_1.text = '초중고교 무상급식 예산이 46억 원 증액됩니다.';
let scriptTest3_2 = new Script_1.Script();
scriptTest3_2.startTime = new Time_1.Time(4, 74);
scriptTest3_2.endTime = new Time_1.Time(15, 13);
scriptTest3_2.text = '오영훈 제주도지사와 김광수 제주도 교육감은 한라중학교를 찾아 올해 추경에 무상급식 예산 46억 원을 증액 반영하기로 합의했다고 밝혔습니다.';
let scriptTest3_3 = new Script_1.Script();
scriptTest3_3.startTime = new Time_1.Time(15, 13);
scriptTest3_3.endTime = new Time_1.Time(21, 62);
scriptTest3_3.text = '이에 따라 무상급식 예산이 현재 439억 원에서 485억 원으로 늘게 됐습니다.';
let scriptTest3_4 = new Script_1.Script();
scriptTest3_4.startTime = new Time_1.Time(21, 62);
scriptTest3_4.endTime = new Time_1.Time(30, 2);
scriptTest3_4.text = '중학생 1인당 1식 단가는 현재 2,980원에서 24% 인상된 3,695원으로 오르게 됐습니다.';
let scriptTest3_5 = new Script_1.Script();
scriptTest3_5.startTime = new Time_1.Time(30, 2);
scriptTest3_5.endTime = new Time_1.Time(35, 0);
scriptTest3_5.text = '인상된 단가는 다음 학기부터 적용됩니다.';
let scriptTest3_6 = new Script_1.Script();
scriptTest3_6.startTime = new Time_1.Time(35, 0);
scriptTest3_6.endTime = new Time_1.Time(37, 80);
scriptTest3_6.text = '지금까지 제주에서 전해 드렸습니다.';
// 4번 뉴스
let tagTest4_1 = new Tag_1.Tag();
tagTest4_1.name = '범죄';
let tagTest4_2 = new Tag_1.Tag();
tagTest4_2.name = '사망사고';
let tagTest4_3 = new Tag_1.Tag();
tagTest4_3.name = '공무원';
let scriptTest4_1 = new Script_1.Script();
scriptTest4_1.startTime = new Time_1.Time(0, 0);
scriptTest4_1.endTime = new Time_1.Time(4, 74);
scriptTest4_1.text = '오늘 오전 9시쯤 경북 안동시청 주차타워 2층에서 50대 여성 공무원 A 씨가 쓰러진 채 발견됐습니다.';
let scriptTest4_2 = new Script_1.Script();
scriptTest4_2.startTime = new Time_1.Time(4, 74);
scriptTest4_2.endTime = new Time_1.Time(15, 13);
scriptTest4_2.text = 'A 씨는 흉기에 복부를 찔려 크게 다친 상태로 병원으로 옮겨졌지만 1시간여 만에 숨졌습니다.';
let scriptTest4_3 = new Script_1.Script();
scriptTest4_3.startTime = new Time_1.Time(15, 13);
scriptTest4_3.endTime = new Time_1.Time(21, 62);
scriptTest4_3.text = '용의자는 시청 산하기관 직원인 40대 남성 B 씨로 범행 직후 경찰에 자수했습니다.';
let scriptTest4_4 = new Script_1.Script();
scriptTest4_4.startTime = new Time_1.Time(21, 62);
scriptTest4_4.endTime = new Time_1.Time(30, 2);
scriptTest4_4.text = '경찰은 B 씨가 사용한 흉기를 확보하고 범행 동기를 추궁하고 있습니다.';
// 5번 뉴스
let tagTest5_1 = new Tag_1.Tag();
tagTest5_1.name = '장관';
let tagTest5_2 = new Tag_1.Tag();
tagTest5_2.name = '인사';
let tagTest5_3 = new Tag_1.Tag();
tagTest5_3.name = '사퇴';
let scriptTest5_1 = new Script_1.Script();
scriptTest5_1.startTime = new Time_1.Time(0, 0);
scriptTest5_1.endTime = new Time_1.Time(5, 47);
scriptTest5_1.text = '김승희 보건복지부 장관 후보자는 오늘 오전 입장문을 내고 후보직 사퇴 의사를 밝혔습니다.';
let scriptTest5_2 = new Script_1.Script();
scriptTest5_2.startTime = new Time_1.Time(5, 47);
scriptTest5_2.endTime = new Time_1.Time(15, 74);
scriptTest5_2.text = '김 후보자는 지명 이후 객관적 근거가 없거나 관련이 없는 가족들의 사생활까지 수많은 비판이 제기됐다면서 각종 의혹이 사실이 아님을 반복적으로 설명했지만,';
let scriptTest5_3 = new Script_1.Script();
scriptTest5_3.startTime = new Time_1.Time(15, 74);
scriptTest5_3.endTime = new Time_1.Time(23, 87);
scriptTest5_3.text = '이 과정에서 공직자로서 부끄럽지 않게 살아왔던 자신의 명예는 물론이고 가족들까지 상처를 입는 것이 매우 힘들었다고 설명했습니다.';
let scriptTest5_4 = new Script_1.Script();
scriptTest5_4.startTime = new Time_1.Time(23, 87);
scriptTest5_4.endTime = new Time_1.Time(32, 43);
scriptTest5_4.text = '또 정치 자금 의혹에 대해서는 고의적으로 사적인 용도로 유용한 바가 전혀 없으며 회계 처리 과정에서 실무적인 착오로 문제가 생겼지만,';
let scriptTest5_5 = new Script_1.Script();
scriptTest5_5.startTime = new Time_1.Time(32, 43);
scriptTest5_5.endTime = new Time_1.Time(40, 0);
scriptTest5_5.text = '이러한 사실과 별개로 최종적으로 관리 책임에서 자유로울 수 없다는 지적을 겸허하게 수용한다고 덧붙였습니다.';
// 6번 뉴스
let tagTest6_1 = new Tag_1.Tag();
tagTest6_1.name = '영국';
let tagTest6_2 = new Tag_1.Tag();
tagTest6_2.name = '중국';
let tagTest6_3 = new Tag_1.Tag();
tagTest6_3.name = '홍콩';
let scriptTest6_1 = new Script_1.Script();
scriptTest6_1.startTime = new Time_1.Time(0, 0);
scriptTest6_1.endTime = new Time_1.Time(7, 23);
scriptTest6_1.text = '존슨 영국 총리는 중국이 25년 전 홍콩 주권을 돌려받을 때 약속을 지키지 않고 있다고 비판했습니다. ';
let scriptTest6_2 = new Script_1.Script();
scriptTest6_2.startTime = new Time_1.Time(7, 23);
scriptTest6_2.endTime = new Time_1.Time(16, 12);
scriptTest6_2.text = '존슨 총리는 트위터에 올린 영상 메시지에서 영국이 1997년 홍콩을 반환한 뒤 중국은 일국양제를 준수하지 않고 있다고 말했습니다.';
let scriptTest6_3 = new Script_1.Script();
scriptTest6_3.startTime = new Time_1.Time(16, 12);
scriptTest6_3.endTime = new Time_1.Time(25, 81);
scriptTest6_3.text = '영국과 중국은 1984년 공동선언을 통해 홍콩이 반환된 이후에도 50년 동안 고도의 자치와 함께 기존 체제를 유지하는 데 합의했습니다. ';
let scriptTest6_4 = new Script_1.Script();
scriptTest6_4.startTime = new Time_1.Time(25, 81);
scriptTest6_4.endTime = new Time_1.Time(38, 89);
scriptTest6_4.text = '하지만 존슨 총리는 홍콩인들의 권리와 자유, 번영이 위협받는 상황이라면서 홍콩을 포기하지 않고 25년 전 약속을 지킬 것이며 중국이 약속을 지키도록 최선을 다하겠다고 밝혔습니다.';
// 7번 뉴스
let tagTest7_1 = new Tag_1.Tag();
tagTest7_1.name = '대선';
let tagTest7_2 = new Tag_1.Tag();
tagTest7_2.name = '이재명';
let tagTest7_3 = new Tag_1.Tag();
tagTest7_3.name = '의전논란';
let scriptTest7_1 = new Script_1.Script();
scriptTest7_1.startTime = new Time_1.Time(0, 0);
scriptTest7_1.endTime = new Time_1.Time(13, 57);
scriptTest7_1.text = '더불어민주당 이재명 대선 후보의 부인 김혜경 씨가 자신에게 제기된 의전 논란과 관련해서 모든 것이 자신의 불찰이라며 국민 여러분께 심려를 끼쳐드린 데 대해 송구하다고 밝혔습니다. ';
let scriptTest7_2 = new Script_1.Script();
scriptTest7_2.startTime = new Time_1.Time(13, 57);
scriptTest7_2.endTime = new Time_1.Time(30, 9);
...
let scriptTest7_3 = new Script_1.Script();
scriptTest7_3.startTime = new Time_1.Time(30, 9);
scriptTest7_3.endTime = new Time_1.Time(42, 78);
scriptTest7_3.text = '김혜경 씨는 공과 사를 명료하게 가려야 했는데 a 비서 상관이었던 경기도 사무관 배 모 씨와 친분이 있어 도움을 받았다면서도 상시 조력을 받은 것은 아니라고 해명했습니다.';
// 8번 뉴스
let tagTest8_1 = new Tag_1.Tag();
tagTest8_1.name = '우크라이나';
let tagTest8_2 = new Tag_1.Tag();
tagTest8_2.name = '루가노선언';
let tagTest8_3 = new Tag_1.Tag();
tagTest8_3.name = '경제회복';
let scriptTest8_1 = new Script_1.Script();
scriptTest8_1.startTime = new Time_1.Time(0, 0);
scriptTest8_1.endTime = new Time_1.Time(7, 80);
scriptTest8_1.text = '이 시각 세계입니다.';
let scriptTest8_2 = new Script_1.Script();
scriptTest8_2.startTime = new Time_1.Time(7, 80);
scriptTest8_2.endTime = new Time_1.Time(15, 89);
scriptTest8_2.text = '한국을 포함한 40여 개국 정상들이 러시아의 침공으로 초토화된 우크라이나를 투명하고 민주적으로 재건하기로 약속했습니다.';
let scriptTest8_3 = new Script_1.Script();
scriptTest8_3.startTime = new Time_1.Time(15, 89);
scriptTest8_3.endTime = new Time_1.Time(26, 95);
scriptTest8_3.text = '스위스에서 이틀간 진행된 우크라이나 회의에 참석한 40여 개국 지도자들은 우크라이나의 경제 회복을 돕기 위한 루가노 선언에 서명했는데요.';
let scriptTest8_4 = new Script_1.Script();
scriptTest8_4.startTime = new Time_1.Time(26, 95);
scriptTest8_4.endTime = new Time_1.Time(37, 13);
scriptTest8_4.text = '선언에 서명한 국가들은 우크라이나의 전후 복구 지원을 약속하는 한편, 투명성을 높이고 부패를 척결하기 위한 개혁 필요성에 동의했습니다.';
let scriptTest8_5 = new Script_1.Script();
scriptTest8_5.startTime = new Time_1.Time(37, 13);
scriptTest8_5.endTime = new Time_1.Time(46, 67);
scriptTest8_5.text = '회담을 공동주최한 이그나지오 카시스 스위스 대통령은 루가노 선언은 우크라이나 재건을 위한 긴 여정의 시작이라고 평가했습니다.';
let scriptTest8_6 = new Script_1.Script();
scriptTest8_6.startTime = new Time_1.Time(46, 67);
scriptTest8_6.endTime = new Time_1.Time(56, 0);
scriptTest8_6.text = '앞서 우크라이나 정부는 자국 재건 비용으로 7,500억 달러, 약 972조 원이 필요하다고 자체 추산했습니다.';
// 9번 뉴스
let tagTest9_1 = new Tag_1.Tag();
tagTest9_1.name = '원숭이두창';
let tagTest9_2 = new Tag_1.Tag();
tagTest9_2.name = '치료제';
let tagTest9_3 = new Tag_1.Tag();
tagTest9_3.name = '중대본';
let scriptTest9_1 = new Script_1.Script();
scriptTest9_1.startTime = new Time_1.Time(0, 0);
scriptTest9_1.endTime = new Time_1.Time(6, 18);
scriptTest9_1.text = '원숭이두창 치료제인 테코비리마트 504명분이 이번 주 국내에 도입됩니다.';
let scriptTest9_2 = new Script_1.Script();
scriptTest9_2.startTime = new Time_1.Time(6, 18);
scriptTest9_2.endTime = new Time_1.Time(16, 70);
scriptTest9_2.text = '중앙방역대책본부는 오늘 도입되는 치료제 물량은 초기 대응에 충분한 수준이라며 향후 발생 양상을 고려해 추가 도입하겠다고 밝혔습니다.';
let scriptTest9_3 = new Script_1.Script();
scriptTest9_3.startTime = new Time_1.Time(16, 70);
scriptTest9_3.endTime = new Time_1.Time(29, 0);
scriptTest9_3.text = '방대본은 백신 접종 계획에 대해선 원숭이두창의 전파력은 강하지 않다며 일반 국민이 광범위하게 예방접종을 할 필요성이 있다고 보지 않는다고 답했습니다.';
// 10번 뉴스
let tagTest10_1 = new Tag_1.Tag();
tagTest10_1.name = 'WHO';
let tagTest10_2 = new Tag_1.Tag();
tagTest10_2.name = '원숭이두창';
let tagTest10_3 = new Tag_1.Tag();
tagTest10_3.name = '확산';
let scriptTest10_1 = new Script_1.Script();
scriptTest10_1.startTime = new Time_1.Time(0, 0);
scriptTest10_1.endTime = new Time_1.Time(8, 87);
scriptTest10_1.text = '세계보건기구 WHO가 올여름 휴가철 원숭이두창 전파 속도가 더 빨라질 수 있다고 경고했습니다.';
let scriptTest10_2 = new Script_1.Script();
scriptTest10_2.startTime = new Time_1.Time(9, 0);
scriptTest10_2.endTime = new Time_1.Time(25, 17);
...
let scriptTest10_3 = new Script_1.Script();
scriptTest10_3.startTime = new Time_1.Time(25, 17);
scriptTest10_3.endTime = new Time_1.Time(36, 0);
scriptTest10_3.text = '또 현재 코로나19와 같은 방역 조처가 필요하지는 않을 것이지만 바이러스 확산을 완벽하게 억제할 수 있을지는 아직 알 수 없다고 우려했습니다.';
// 11번 뉴스
let tagTest11_1 = new Tag_1.Tag();
tagTest11_1.name = '일본';
let tagTest11_2 = new Tag_1.Tag();
tagTest11_2.name = '선진국';
let tagTest11_3 = new Tag_1.Tag();
tagTest11_3.name = '경제';
let scriptTest11_1 = new Script_1.Script();
scriptTest11_1.startTime = new Time_1.Time(0, 0);
scriptTest11_1.endTime = new Time_1.Time(2, 19);
scriptTest11_1.text = '선진국 탈락이 임박했다.';
let scriptTest11_2 = new Script_1.Script();
scriptTest11_2.startTime = new Time_1.Time(2, 19);
scriptTest11_2.endTime = new Time_1.Time(5, 9);
scriptTest11_2.text = '몰락 전 중국 청나라 말기 같다.';
let scriptTest11_3 = new Script_1.Script();
scriptTest11_3.startTime = new Time_1.Time(5, 9);
scriptTest11_3.endTime = new Time_1.Time(10, 20);
scriptTest11_3.text = '요즘 일본 경제에 대해 내부에서 잇따라 나오는 혹독한 경고음들입니다.';
let scriptTest11_4 = new Script_1.Script();
scriptTest11_4.startTime = new Time_1.Time(10, 20);
scriptTest11_4.endTime = new Time_1.Time(20, 81);
scriptTest11_4.text = '1990년대 버블 붕괴 뒤 나온 잃어버린 10년이라는 말은 아직도 회복하지 못한 장기 침체 때문에 잃어버린 30년으로 바뀌게 됐습니다.';
let scriptTest11_5 = new Script_1.Script();
scriptTest11_5.startTime = new Time_1.Time(20, 81);
scriptTest11_5.endTime = new Time_1.Time(24, 57);
scriptTest11_5.text = '어느 정도인지 도쿄에서 고현승 특파원이 전합니다.';
// 12번 뉴스
let tagTest12_1 = new Tag_1.Tag();
tagTest12_1.name = '서울';
let tagTest12_2 = new Tag_1.Tag();
tagTest12_2.name = '경찰';
let tagTest12_3 = new Tag_1.Tag();
tagTest12_3.name = '마약';
let scriptTest12_1 = new Script_1.Script();
scriptTest12_1.startTime = new Time_1.Time(0, 0);
scriptTest12_1.endTime = new Time_1.Time(12, 16);
scriptTest12_1.text = '서울의 한 유흥주점 여 종업원이 손님이 건넨 술을 마신 뒤에 숨지는 사건이 발생해서 경찰이 수사에 나섰다는 기사도 많이 봤습니다.';
let scriptTest12_2 = new Script_1.Script();
scriptTest12_2.startTime = new Time_1.Time(12, 16);
scriptTest12_2.endTime = new Time_1.Time(20, 27);
scriptTest12_2.text = '어제 오전 7시 50분쯤 서울 강남의 한 유흥주점에서 30대 여 종업원 A 씨가 의식을 잃고 쓰러졌습니다.';
let scriptTest12_3 = new Script_1.Script();
scriptTest12_3.startTime = new Time_1.Time(20, 27);
scriptTest12_3.endTime = new Time_1.Time(28, 82);
scriptTest12_3.text = '유흥주점 동료는 A 씨가 손님들이 건넨 술을 마신 뒤에 쓰러졌다며 마약이 의심된다고 119와 경찰에 신고했습니다.';
let scriptTest12_4 = new Script_1.Script();
scriptTest12_4.startTime = new Time_1.Time(28, 82);
scriptTest12_4.endTime = new Time_1.Time(32, 94);
scriptTest12_4.text = 'A 씨는 인근 병원으로 옮겨졌지만 결국 숨졌습니다.';
let scriptTest12_5 = new Script_1.Script();
scriptTest12_5.startTime = new Time_1.Time(32, 94);
scriptTest12_5.endTime = new Time_1.Time(42, 17);
scriptTest12_5.text = '그런데 비슷한 시각 이 술자리에 함께 있었던 남성이 유흥주점에서 약 700m 떨어진 도심 한복판에서 교통사고를 냈습니다.';
let scriptTest12_6 = new Script_1.Script();
scriptTest12_6.startTime = new Time_1.Time(42, 17);
scriptTest12_6.endTime = new Time_1.Time(48, 47);
scriptTest12_6.text = '경찰이 출동했을 당시 차량에서 마약으로 추정되는 봉투가 발견된 것으로 알려졌는데요.';
let scriptTest12_7 = new Script_1.Script();
scriptTest12_7.startTime = new Time_1.Time(48, 47);
scriptTest12_7.endTime = new Time_1.Time(52, 28);
scriptTest12_7.text = '남성도 병원으로 옮겨졌지만 숨졌습니다.';
let scriptTest12_8 = new Script_1.Script();
scriptTest12_8.startTime = new Time_1.Time(52, 28);
scriptTest12_8.endTime = new Time_1.Time(61, 0);
scriptTest12_8.text = '경찰은 술에 섞인 물질과 손님들의 인적 사항을 확인하는 동시에 두 사건 사이의 관련성을 수사하고 있습니다.';
// 13번 뉴스
let tagTest13_1 = new Tag_1.Tag();
tagTest13_1.name = '코로나';
let tagTest13_2 = new Tag_1.Tag();
tagTest13_2.name = '경제';
let tagTest13_3 = new Tag_1.Tag();
tagTest13_3.name = '인테리어';
let scriptTest13_1 = new Script_1.Script();
scriptTest13_1.startTime = new Time_1.Time(0, 0);
scriptTest13_1.endTime = new Time_1.Time(7, 22);
scriptTest13_1.text = '코로나19로 폐업하거나 일자리를 잃은 사람도 많지만 반대로 몸값이 뛴 직종이 있습니다.';
let scriptTest13_2 = new Script_1.Script();
scriptTest13_2.startTime = new Time_1.Time(7, 22);
scriptTest13_2.endTime = new Time_1.Time(13, 21);
scriptTest13_2.text = '코로나19 사태 이후 인테리어 수요 급증으로 시공 인력이 부족해지면서 일당이 껑충 뛰었습니다.';
let scriptTest13_3 = new Script_1.Script();
scriptTest13_3.startTime = new Time_1.Time(13, 21);
scriptTest13_3.endTime = new Time_1.Time(22, 68);
scriptTest13_3.text = '업계에 따르면 올해 도배나 도장, 타일 등 인테리어 시공 직종의 일당은 1년 새 최대 40%, 많게는 10만 원 이상 올랐다는데요.';
let scriptTest13_4 = new Script_1.Script();
scriptTest13_4.startTime = new Time_1.Time(22, 68);
scriptTest13_4.endTime = new Time_1.Time(29, 5);
scriptTest13_4.text = '도장 일당은 최대 40만 원에 이르고 도배사도 20만 원 후반대 수입을 올리는 것으로 알려졌습니다.';
let scriptTest13_5 = new Script_1.Script();
scriptTest13_5.startTime = new Time_1.Time(29, 5);
scriptTest13_5.endTime = new Time_1.Time(36, 0);
scriptTest13_5.text = '경력으로 쌓인 노하우와 기술이 중요한 직종인 만큼 이들의 몸값은 더 높아질 것으로 보입니다.';
// 14번 뉴스
let tagTest14_1 = new Tag_1.Tag();
tagTest14_1.name = '과학';
let tagTest14_2 = new Tag_1.Tag();
tagTest14_2.name = '우주';
let tagTest14_3 = new Tag_1.Tag();
tagTest14_3.name = '누리호';
let scriptTest14_1 = new Script_1.Script();
scriptTest14_1.startTime = new Time_1.Time(0, 0);
scriptTest14_1.endTime = new Time_1.Time(1, 23);
scriptTest14_1.text = '여러분 안녕하십니까.';
let scriptTest14_2 = new Script_1.Script();
scriptTest14_2.startTime = new Time_1.Time(1, 23);
scriptTest14_2.endTime = new Time_1.Time(10, 66);
scriptTest14_2.text = '하늘은 파란 크레파스로 칠한 듯 선명했고, 그 안에 누리호가 동그란 점으로 희미해질 때까지 마음 졸이면서 1초 1초를 지켜봤습니다.';
let scriptTest14_3 = new Script_1.Script();
scriptTest14_3.startTime = new Time_1.Time(10, 66);
scriptTest14_3.endTime = new Time_1.Time(17, 43);
scriptTest14_3.text = '수많은 사람들의 우주를 향한 꿈이 한 걸음 앞으로 나아간 날, 특집 9시 뉴스 시작합니다.';
let scriptTest14_4 = new Script_1.Script();
scriptTest14_4.startTime = new Time_1.Time(17, 43);
scriptTest14_4.endTime = new Time_1.Time(25, 84);
scriptTest14_4.text = '누리호는 700킬로미터 상공, 목표 궤도까지 오르면서 여덟 달 전, 끝내지 못한 숙제를 성공적으로 마무리했습니다.';
let scriptTest14_5 = new Script_1.Script();
scriptTest14_5.startTime = new Time_1.Time(25, 84);
scriptTest14_5.endTime = new Time_1.Time(29, 47);
scriptTest14_5.text = '먼저 발사 순간, 김민아 기자가 전해드립니다.';
// 15번 뉴스
let tagTest15_1 = new Tag_1.Tag();
tagTest15_1.name = '송해';
let tagTest15_2 = new Tag_1.Tag();
tagTest15_2.name = '별세';
let tagTest15_3 = new Tag_1.Tag();
tagTest15_3.name = '빈소';
let scriptTest15_1 = new Script_1.Script();
scriptTest15_1.startTime = new Time_1.Time(0, 0);
scriptTest15_1.endTime = new Time_1.Time(1, 98);
scriptTest15_1.text = '여러분 안녕하십니까.';
let scriptTest15_2 = new Script_1.Script();
scriptTest15_2.startTime = new Time_1.Time(1, 98);
scriptTest15_2.endTime = new Time_1.Time(7, 52);
scriptTest15_2.text = '"그는 바다 해(海) 자를 따서 마음속으로 자신을 \'송해\' 라고 불러보았다.”';
let scriptTest15_3 = new Script_1.Script();
scriptTest15_3.startTime = new Time_1.Time(7, 52);
scriptTest15_3.endTime = new Time_1.Time(13, 55);
scriptTest15_3.text = '이름 두 글자에 바다를 품었던 희극인 송해 선생이 우리 곁을 떠났습니다.';
let scriptTest15_4 = new Script_1.Script();
scriptTest15_4.startTime = new Time_1.Time(13, 55);
scriptTest15_4.endTime = new Time_1.Time(16, 26);
scriptTest15_4.text = '향년, 우리 나이 아흔 다섯입니다.';
let scriptTest15_5 = new Script_1.Script();
scriptTest15_5.startTime = new Time_1.Time(16, 26);
scriptTest15_5.endTime = new Time_1.Time(27, 52);
scriptTest15_5.text = '자연인 송복희가 아닌 국민 진행자 송해로, 34년 동안 일요일 오후를 행복하게 만들어줬던 송해 선생 별세 소식으로, 오늘 9시 뉴스 시작합니다.';
let scriptTest15_6 = new Script_1.Script();
scriptTest15_6.startTime = new Time_1.Time(27, 52);
scriptTest15_6.endTime = new Time_1.Time(31, 2);
scriptTest15_6.text = '먼저 빈소가 마련된 서울대병원 연결하겠습니다.';
// 16번 뉴스
let tagTest16_1 = new Tag_1.Tag();
tagTest16_1.name = '윤석열';
let tagTest16_2 = new Tag_1.Tag();
tagTest16_2.name = '권력사유화';
let tagTest16_3 = new Tag_1.Tag();
tagTest16_3.name = '친인척';
let scriptTest16_1 = new Script_1.Script();
scriptTest16_1.startTime = new Time_1.Time(0, 0);
scriptTest16_1.endTime = new Time_1.Time(14, 4);
...
let scriptTest16_2 = new Script_1.Script();
scriptTest16_2.startTime = new Time_1.Time(14, 4);
scriptTest16_2.endTime = new Time_1.Time(20, 59);
scriptTest16_2.text = '윤 대통령은 출근길에 기자들과 만나 권력 사유화라는 비판에 어떤 입장이냐는 질문에 이같이 말했습니다.';
let scriptTest16_3 = new Script_1.Script();
scriptTest16_3.startTime = new Time_1.Time(20, 59);
scriptTest16_3.endTime = new Time_1.Time(28, 93);
scriptTest16_3.text = '윤 대통령은 8촌인 최 씨는 부속실에서 이른바 관저팀 소속 팀장을 맡으며 김 여사 보좌 업무를 주로 담당한 것으로 알려졌습니다.';
let scriptTest16_4 = new Script_1.Script();
scriptTest16_4.startTime = new Time_1.Time(28, 93);
scriptTest16_4.endTime = new Time_1.Time(35, 81);
scriptTest16_4.text = '윤 대통령은 또 나토 수행팀 문제는 이미 대변인이 말씀드린 것 같다며 말을 아꼈습니다.';
// 17번 뉴스
let tagTest17_1 = new Tag_1.Tag();
tagTest17_1.name = '의학';
let tagTest17_2 = new Tag_1.Tag();
tagTest17_2.name = '식중독';
let tagTest17_3 = new Tag_1.Tag();
tagTest17_3.name = '버섯';
let scriptTest17_1 = new Script_1.Script();
scriptTest17_1.startTime = new Time_1.Time(0, 0);
scriptTest17_1.endTime = new Time_1.Time(7, 84);
scriptTest17_1.text = '장마철 야생에서 채취한 버섯은 식중독 위험이 높아 되도록 먹지 말 것을 식품의약품안전처가 권고했습니다.';
let scriptTest17_2 = new Script_1.Script();
scriptTest17_2.startTime = new Time_1.Time(7, 84);
scriptTest17_2.endTime = new Time_1.Time(21, 16);
...
let scriptTest17_3 = new Script_1.Script();
scriptTest17_3.startTime = new Time_1.Time(21, 16);
scriptTest17_3.endTime = new Time_1.Time(29, 41);
scriptTest17_3.text = '버섯을 먹은 뒤 통증이 생기면 즉시 토해내고, 먹은 버섯을 가지고 즉시 병원에 방문하라고 식약처는 당부했습니다.';
// 18번 뉴스
let tagTest18_1 = new Tag_1.Tag();
tagTest18_1.name = '법원';
let tagTest18_2 = new Tag_1.Tag();
tagTest18_2.name = '사기';
let tagTest18_3 = new Tag_1.Tag();
tagTest18_3.name = '마약';
let scriptTest18_1 = new Script_1.Script();
scriptTest18_1.startTime = new Time_1.Time(0, 0);
scriptTest18_1.endTime = new Time_1.Time(11, 36);
scriptTest18_1.text = '20대 20여 명이 모여 사기 행각을 벌이고 마약 파티를 했던 이른바 검단 식구들의 주범, A 씨에 대해 1심 법원이 징역 5년을 선고했습니다.';
let scriptTest18_2 = new Script_1.Script();
scriptTest18_2.startTime = new Time_1.Time(11, 36);
scriptTest18_2.endTime = new Time_1.Time(18, 50);
scriptTest18_2.text = '인천지법은 오늘 열린 선고공판에서 A씨의 죄질이 가볍지 않다며 징역 5년을 선고했습니다.';
let scriptTest18_3 = new Script_1.Script();
scriptTest18_3.startTime = new Time_1.Time(18, 50);
scriptTest18_3.endTime = new Time_1.Time(28, 92);
scriptTest18_3.text = 'A 씨는 지인 여성들에게 접근해 취업을 대가로 대출을 받게 하고 돈을 가로챘고 이들 가운데 일부를 감금, 폭행한 혐의를 받고 있습니다.';
// 19번 뉴스
let tagTest19_1 = new Tag_1.Tag();
tagTest19_1.name = '가격';
let tagTest19_2 = new Tag_1.Tag();
tagTest19_2.name = '담합';
let tagTest19_3 = new Tag_1.Tag();
tagTest19_3.name = '토종닭';
let scriptTest19_1 = new Script_1.Script();
scriptTest19_1.startTime = new Time_1.Time(0, 0);
scriptTest19_1.endTime = new Time_1.Time(8, 83);
scriptTest19_1.text = '국내 토종닭 신선육 가격을 4년 가까이 담합해 온 사업자들에게 공정거래위원회가 과징금을 부과하기로 했습니다.';
let scriptTest19_2 = new Script_1.Script();
scriptTest19_2.startTime = new Time_1.Time(8, 83);
scriptTest19_2.endTime = new Time_1.Time(21, 67);
scriptTest19_2.text = '공정위는 하림과 올품, 체리부로, 참프레 등 국내 9개 토종닭 신선육 제조·판매사업자에게 시정명령과 함께 5억 9,500만 원의 과징금을 부과하기로 결정했다고 밝혔습니다.';
let scriptTest19_3 = new Script_1.Script();
scriptTest19_3.startTime = new Time_1.Time(21, 67);
scriptTest19_3.endTime = new Time_1.Time(34, 19);
scriptTest19_3.text = '이들은 2013년부터 2017년 사이 4차례에 걸쳐 토종닭의 판매 가격과 출고량을 합의하고 가격에 영향을 미치는 비용 등을 공동으로 결정한 것으로 조사됐습니다.';
// 20번 뉴스
let tagTest20_1 = new Tag_1.Tag();
tagTest20_1.name = '통행료';
let tagTest20_2 = new Tag_1.Tag();
tagTest20_2.name = '국토부';
let tagTest20_3 = new Tag_1.Tag();
tagTest20_3.name = '친환경차';
let scriptTest20_1 = new Script_1.Script();
scriptTest20_1.startTime = new Time_1.Time(0, 0);
scriptTest20_1.endTime = new Time_1.Time(7, 47);
scriptTest20_1.text = '올해 말 종료 예정이었던 전기·수소차와 화물차 통행료 감면 제도가 2년 더 연장됩니다.';
let scriptTest20_2 = new Script_1.Script();
scriptTest20_2.startTime = new Time_1.Time(7, 47);
scriptTest20_2.endTime = new Time_1.Time(14, 51);
scriptTest20_2.text = '국토부는 이런 내용을 담은 유료도로법 시행령 개정안을 다음 달 11일까지 입법 예고한다고 밝혔습니다.';
let scriptTest20_3 = new Script_1.Script();
scriptTest20_3.startTime = new Time_1.Time(14, 51);
scriptTest20_3.endTime = new Time_1.Time(24, 74);
scriptTest20_3.text = '정부는 미세먼지 저감과 친환경차 보급 확대를 위해 2017년 9월부터 전기 수소차에 대한 고속도로 통행료를 50% 감면해주고 있습니다.';
let scriptTest20_4 = new Script_1.Script();
scriptTest20_4.startTime = new Time_1.Time(24, 74);
scriptTest20_4.endTime = new Time_1.Time(34, 46);
scriptTest20_4.text = '애초 이 제도는 연말에 종료될 예정이었지만 시행령이 개정되면 해당 운전자는 2024년 12월까지 감면 혜택을 받을 수 있습니다.';
let scriptTest20_5 = new Script_1.Script();
scriptTest20_5.startTime = new Time_1.Time(34, 46);
scriptTest20_5.endTime = new Time_1.Time(40, 50);
scriptTest20_5.text = '또 화물차에 대한 고속도로 통행료 심야 할인 역시 2년 더 연장하기로 했습니다.';
// 21번 뉴스
let tagTest21_1 = new Tag_1.Tag();
tagTest21_1.name = 'IMF';
let tagTest21_2 = new Tag_1.Tag();
tagTest21_2.name = '경제전망';
let tagTest21_3 = new Tag_1.Tag();
tagTest21_3.name = '경기침체';
let scriptTest21_1 = new Script_1.Script();
scriptTest21_1.startTime = new Time_1.Time(0, 0);
scriptTest21_1.endTime = new Time_1.Time(11, 57);
scriptTest21_1.text = '크리스탈리나 게이오르에바 IMF 총재가 현지 시간 6일 글로벌 경제 전망이 상당히 어두워졌다며 내년에 전 세계적인 경기침체가 닥칠 가능성이 있다고 경고했습니다.';
let scriptTest21_2 = new Script_1.Script();
scriptTest21_2.startTime = new Time_1.Time(11, 57);
scriptTest21_2.endTime = new Time_1.Time(26, 78);
...
let scriptTest21_3 = new Script_1.Script();
scriptTest21_3.startTime = new Time_1.Time(26, 78);
scriptTest21_3.endTime = new Time_1.Time(36, 0);
scriptTest21_3.text = '또 조만간 올해 세계 경제성장률 전망을 하향 조정하겠다고 밝혔는데 이럴 경우 올 들어 세 번째 이루어지는 IMF의 전망치 하향 조정입니다.';
// 22번 뉴스
let tagTest22_1 = new Tag_1.Tag();
tagTest22_1.name = 'BTS';
let tagTest22_2 = new Tag_1.Tag();
tagTest22_2.name = '대면공연';
let tagTest22_3 = new Tag_1.Tag();
tagTest22_3.name = '미국';
let scriptTest22_1 = new Script_1.Script();
scriptTest22_1.startTime = new Time_1.Time(0, 0);
scriptTest22_1.endTime = new Time_1.Time(6, 28);
scriptTest22_1.text = '오늘 이 소식을 전하기 위해 저희 스튜디오도 보랏빛으로 물들여봤는데요.';
let scriptTest22_2 = new Script_1.Script();
scriptTest22_2.startTime = new Time_1.Time(6, 28);
scriptTest22_2.endTime = new Time_1.Time(8, 52);
scriptTest22_2.text = '바로 BTS 이야기입니다.';
let scriptTest22_3 = new Script_1.Script();
scriptTest22_3.startTime = new Time_1.Time(8, 52);
scriptTest22_3.endTime = new Time_1.Time(13, 24);
scriptTest22_3.text = '방탄소년단이 미국 LA에서 2년 만에 대면 공연을 열었습니다.';
let scriptTest22_4 = new Script_1.Script();
scriptTest22_4.startTime = new Time_1.Time(13, 24);
scriptTest22_4.endTime = new Time_1.Time(16, 50);
scriptTest22_4.text = '오늘만 무려 5만 명이 넘는 팬들이 몰렸는데요.';
let scriptTest22_5 = new Script_1.Script();
scriptTest22_5.startTime = new Time_1.Time(16, 50);
scriptTest22_5.endTime = new Time_1.Time(21, 39);
scriptTest22_5.text = '이번 공연의 제목은 BTS 퍼미션 투 댄스 온 스테이지입니다.';
let scriptTest22_6 = new Script_1.Script();
scriptTest22_6.startTime = new Time_1.Time(21, 39);
scriptTest22_6.endTime = new Time_1.Time(27, 73);
scriptTest22_6.text = 'BTS의 노래 제목이기도 하고 팬들과 드디어 만나게 되는 기쁨을 담은 것 같기도 한데요.';
let scriptTest22_7 = new Script_1.Script();
scriptTest22_7.startTime = new Time_1.Time(27, 73);
scriptTest22_7.endTime = new Time_1.Time(33, 47);
scriptTest22_7.text = '어떤 팬이 공연 제목의 알파벳을 재조합해 봤더니 스토리즈 온 팬데믹이 됐다고 합니다.';
let scriptTest22_8 = new Script_1.Script();
scriptTest22_8.startTime = new Time_1.Time(33, 47);
scriptTest22_8.endTime = new Time_1.Time(38, 61);
scriptTest22_8.text = '아직 코로나의 유행은 끝나지 않았지만, BTS는 어떤 스토리를 전했을까요?';
let scriptTest22_9 = new Script_1.Script();
scriptTest22_9.startTime = new Time_1.Time(38, 61);
scriptTest22_9.endTime = new Time_1.Time(41, 33);
scriptTest22_9.text = 'LA에서 김수진 특파원입니다.';
// 23번 뉴스
let tagTest23_1 = new Tag_1.Tag();
tagTest23_1.name = '코로나';
let tagTest23_2 = new Tag_1.Tag();
tagTest23_2.name = '중국';
let tagTest23_3 = new Tag_1.Tag();
tagTest23_3.name = '연휴';
let scriptTest23_1 = new Script_1.Script();
scriptTest23_1.startTime = new Time_1.Time(0, 0);
scriptTest23_1.endTime = new Time_1.Time(5, 76);
scriptTest23_1.text = '중국에서 정부 수립을 기념하는 국경절 연휴가 올해는 무려 팔 일이나 이어졌는데요.';
let scriptTest23_2 = new Script_1.Script();
scriptTest23_2.startTime = new Time_1.Time(5, 76);
scriptTest23_2.endTime = new Time_1.Time(11, 35);
scriptTest23_2.text = '연휴 동안 중국 국내 관광객만 육 억 삼천만 명에 달했다고 합니다.';
let scriptTest23_3 = new Script_1.Script();
scriptTest23_3.startTime = new Time_1.Time(11, 35);
scriptTest23_3.endTime = new Time_1.Time(18, 20);
scriptTest23_3.text = '관광지 곳곳이 이렇게 중국 사람들로 가득 찼는데 마스크 안 쓴 사람들도 자주 눈에 띄었습니다.';
let scriptTest23_4 = new Script_1.Script();
scriptTest23_4.startTime = new Time_1.Time(18, 20);
scriptTest23_4.endTime = new Time_1.Time(26, 67);
scriptTest23_4.text = '이렇게 중국은 코로나가 종식됐다고 과시하려는 것으로 보이지만 이러다 또 코로나가 퍼질 수 있다는 것은 간과했다는 지적이 나옵니다.';
let scriptTest23_5 = new Script_1.Script();
scriptTest23_5.startTime = new Time_1.Time(26, 67);
scriptTest23_5.endTime = new Time_1.Time(28, 99);
scriptTest23_5.text = '강연섭 기자가 보도합니다.';
// 24번 뉴스
let tagTest24_1 = new Tag_1.Tag();
tagTest24_1.name = '윤여정';
let tagTest24_2 = new Tag_1.Tag();
tagTest24_2.name = '오스카';
let tagTest24_3 = new Tag_1.Tag();
tagTest24_3.name = '시상';
let scriptTest24_1 = new Script_1.Script();
scriptTest24_1.startTime = new Time_1.Time(0, 0);
scriptTest24_1.endTime = new Time_1.Time(8, 73);
scriptTest24_1.text = '지난해 영화 미나리로 아카데미 여우조연상을 수상한 윤여정 배우가 올해는 시상자로 오스카 무대에 다시 올랐습니다.';
let scriptTest24_2 = new Script_1.Script();
scriptTest24_2.startTime = new Time_1.Time(8, 73);
scriptTest24_2.endTime = new Time_1.Time(16, 11);
scriptTest24_2.text = '난민을 지지하는 의미의 파란 리본을 달고 등장했는데 올해도 특유의 유머와 재치를 뽐냈습니다.';
let scriptTest24_3 = new Script_1.Script();
scriptTest24_3.startTime = new Time_1.Time(16, 11);
scriptTest24_3.endTime = new Time_1.Time(22, 33);
scriptTest24_3.text = '특히 청각 장애인 수상자에게 수어로 축하인사를 전해서 감동을 안기기도 했습니다.';
let scriptTest24_4 = new Script_1.Script();
scriptTest24_4.startTime = new Time_1.Time(22, 33);
scriptTest24_4.endTime = new Time_1.Time(25, 81);
scriptTest24_4.text = '임소정 기자가 전해드리겠습니다.';
// 25번 뉴스
let tagTest25_1 = new Tag_1.Tag();
tagTest25_1.name = '아베';
let tagTest25_2 = new Tag_1.Tag();
tagTest25_2.name = '총리';
let tagTest25_3 = new Tag_1.Tag();
tagTest25_3.name = '우익';
let scriptTest25_1 = new Script_1.Script();
scriptTest25_1.startTime = new Time_1.Time(0, 0);
scriptTest25_1.endTime = new Time_1.Time(9, 0);
scriptTest25_1.text = '아베 전 총리는 일본 역사상 가장 젊은 나이에 총리 자리에 올라서 가장 오래 권력을 잡았던 인물입니다.';
let scriptTest25_2 = new Script_1.Script();
scriptTest25_2.startTime = new Time_1.Time(9, 0);
scriptTest25_2.endTime = new Time_1.Time(22, 30);
scriptTest25_2.text = '일본 우익의 상징으로 총리에서 물러난 뒤에도 막강한 영향력을 행사했던 아베 전 총리는 야스쿠니 심사 참배를 놓고 우리 과거사 문제를 놓고 우리와는 자주 부딪혔던 정치인이기도 합니다.';
let scriptTest25_3 = new Script_1.Script();
scriptTest25_3.startTime = new Time_1.Time(22, 30);
scriptTest25_3.endTime = new Time_1.Time(27, 27);
scriptTest25_3.text = '앞으로 일본 사회에 변화가 있을지는 정형태 기자가 짚어봤습니다.';
// 26번 뉴스
let tagTest26_1 = new Tag_1.Tag();
tagTest26_1.name = '정준영';
let tagTest26_2 = new Tag_1.Tag();
tagTest26_2.name = '최종훈';
let tagTest26_3 = new Tag_1.Tag();
tagTest26_3.name = '성폭행';
let scriptTest26_1 = new Script_1.Script();
scriptTest26_1.startTime = new Time_1.Time(0, 0);
scriptTest26_1.endTime = new Time_1.Time(9, 25);
scriptTest26_1.text = '술에 취한 여성을 집단 성폭행하고 또 영상을 찍어서 퍼뜨린 혐의를 받는 가수 정준영 씨에게 법원이 징역 6년을 선고했습니다.';
let scriptTest26_2 = new Script_1.Script();
scriptTest26_2.startTime = new Time_1.Time(9, 25);
scriptTest26_2.endTime = new Time_1.Time(13, 34);
scriptTest26_2.text = '또 가수 최종훈 씨에게도 징역 5년이 선고됐습니다.';
let scriptTest26_3 = new Script_1.Script();
scriptTest26_3.startTime = new Time_1.Time(13, 34);
scriptTest26_3.endTime = new Time_1.Time(21, 20);
scriptTest26_3.text = '법원은 사회적 책임을 다해야 할 유명 연예인들이 여성을 성적 쾌락의 도구로 여겼다며 중형을 선고했습니다.';
let scriptTest26_4 = new Script_1.Script();
scriptTest26_4.startTime = new Time_1.Time(21, 20);
scriptTest26_4.endTime = new Time_1.Time(23, 87);
scriptTest26_4.text = '안상우 기자입니다.';
// 27번 뉴스
let tagTest27_1 = new Tag_1.Tag();
tagTest27_1.name = '영화배우';
let tagTest27_2 = new Tag_1.Tag();
tagTest27_2.name = '강수연';
let tagTest27_3 = new Tag_1.Tag();
tagTest27_3.name = '심정지';
let scriptTest27_1 = new Script_1.Script();
scriptTest27_1.startTime = new Time_1.Time(0, 0);
scriptTest27_1.endTime = new Time_1.Time(4, 65);
scriptTest27_1.text = '영화배우 강수연 씨가 심정지 상태로 병원에 옮겨졌습니다.';
let scriptTest27_2 = new Script_1.Script();
scriptTest27_2.startTime = new Time_1.Time(4, 65);
scriptTest27_2.endTime = new Time_1.Time(13, 70);
scriptTest27_2.text = '강 씨는 오늘 오후 5시 50분쯤, 서울 강남구 자택에서 통증을 호소하다 심정지 상태로 소방 구조대에 의해 인근 병원으로 이송됐습니다.';
let scriptTest27_3 = new Script_1.Script();
scriptTest27_3.startTime = new Time_1.Time(13, 70);
scriptTest27_3.endTime = new Time_1.Time(17, 86);
scriptTest27_3.text = '강 씨는 현재 의식이 없는 상태에서 치료를 받고 있는 것으로 전해졌습니다.';
let scriptTest27_4 = new Script_1.Script();
scriptTest27_4.startTime = new Time_1.Time(17, 86);
scriptTest27_4.endTime = new Time_1.Time(29, 56);
scriptTest27_4.text = '올해 55살인 강 씨는 만 4살에 아역 배우로 데뷔한 뒤 영화 \'씨받이\'로 1987년 베니스 국제 영화제 여우주연상을 받는 등 대한민국을 대표하는 배우로 활약해왔습니다.';
// 28번 뉴스
let tagTest28_1 = new Tag_1.Tag();
tagTest28_1.name = '항공권';
let tagTest28_2 = new Tag_1.Tag();
tagTest28_2.name = '환불';
let tagTest28_3 = new Tag_1.Tag();
tagTest28_3.name = '수수료';
let scriptTest28_1 = new Script_1.Script();
scriptTest28_1.startTime = new Time_1.Time(0, 0);
scriptTest28_1.endTime = new Time_1.Time(4, 65);
scriptTest28_1.text = '지난달 국제선 탑승객이 120만 명을 넘어섰습니다.';
let scriptTest28_2 = new Script_1.Script();
scriptTest28_2.startTime = new Time_1.Time(4, 65);
scriptTest28_2.endTime = new Time_1.Time(9, 81);
scriptTest28_2.text = '코로나19로 발이 묶였던 지난해와 비교하면 5배 넘게 급증한 겁니다.';
let scriptTest28_3 = new Script_1.Script();
scriptTest28_3.startTime = new Time_1.Time(9, 81);
scriptTest28_3.endTime = new Time_1.Time(15, 83);
scriptTest28_3.text = '점차 국제선 항공편이 회복된다는 소식에 표 구하는 사람도 빠르게 느는 모습입니다.';
let scriptTest28_4 = new Script_1.Script();
scriptTest28_4.startTime = new Time_1.Time(15, 83);
scriptTest28_4.endTime = new Time_1.Time(26, 41);
scriptTest28_4.text = '하지만 항공편 늘어나는 속도는 수요를 못 따라가고, 여기에 고유가로 유류 할증료까지 올라 항공권 가격은 말 그대로 하늘 높은 줄 모릅니다.';
let scriptTest28_5 = new Script_1.Script();
scriptTest28_5.startTime = new Time_1.Time(26, 41);
scriptTest28_5.endTime = new Time_1.Time(39, 24);
scriptTest28_5.text = '조금이라도 부담을 덜어볼까, 온라인 해외 사이트에서 직접 표를 사는 소비자들도 적지 않은데 운항 일정이 일방적으로 바뀌어도 환불이나 취소가 까다로워서 각별한 주의가 필요합니다.';
let scriptTest28_6 = new Script_1.Script();
scriptTest28_6.startTime = new Time_1.Time(39, 24);
scriptTest28_6.endTime = new Time_1.Time(41, 41);
scriptTest28_6.text = '최은진 기자가 보도합니다.';
// 29번 뉴스
let tagTest29_1 = new Tag_1.Tag();
tagTest29_1.name = '윤석열';
let tagTest29_2 = new Tag_1.Tag();
tagTest29_2.name = '삼부토건';
let tagTest29_3 = new Tag_1.Tag();
tagTest29_3.name = '봐주기의혹';
let scriptTest29_1 = new Script_1.Script();
scriptTest29_1.startTime = new Time_1.Time(0, 0);
scriptTest29_1.endTime = new Time_1.Time(5, 13);
scriptTest29_1.text = '윤석열 후보와 가까운 사이로 알려진 조남욱 전 삼부토건 회장.';
let scriptTest29_2 = new Script_1.Script();
scriptTest29_2.startTime = new Time_1.Time(5, 13);
scriptTest29_2.endTime = new Time_1.Time(9, 25);
scriptTest29_2.text = '그의 후계자인 둘째 아들의 말이 공개가 되면서 논란이 일고 있는데요.';
let scriptTest29_3 = new Script_1.Script();
scriptTest29_3.startTime = new Time_1.Time(9, 25);
scriptTest29_3.endTime = new Time_1.Time(12, 35);
scriptTest29_3.text = '윤석열 총장한테 세 번이나 걸렸다.';
let scriptTest29_4 = new Script_1.Script();
scriptTest29_4.startTime = new Time_1.Time(12, 35);
scriptTest29_4.endTime = new Time_1.Time(14, 71);
scriptTest29_4.text = '아버지가 봐달라고 난리 쳤다.';
let scriptTest29_5 = new Script_1.Script();
scriptTest29_5.startTime = new Time_1.Time(14, 71);
scriptTest29_5.endTime = new Time_1.Time(23, 21);
scriptTest29_5.text = '과거 윤 후보의 검사 시절 삼부토건이 검찰 수사를 번번이 빠져나갔던 배경으로 의심되는 봐주기 의혹이 짙어지고 있습니다.';
let scriptTest29_6 = new Script_1.Script();
scriptTest29_6.startTime = new Time_1.Time(23, 21);
scriptTest29_6.endTime = new Time_1.Time(25, 12);
scriptTest29_6.text = '이재욱 기자가 취재했습니다.';
// 30번 뉴스
let tagTest30_1 = new Tag_1.Tag();
tagTest30_1.name = '물가';
let tagTest30_2 = new Tag_1.Tag();
tagTest30_2.name = '월급';
let tagTest30_3 = new Tag_1.Tag();
tagTest30_3.name = '중산층';
let scriptTest30_1 = new Script_1.Script();
scriptTest30_1.startTime = new Time_1.Time(0, 0);
scriptTest30_1.endTime = new Time_1.Time(8, 91);
scriptTest30_1.text = '경기침체 공포에도 방금 전해드린 대로 미국 연준이 금리를 올리겠다는 의지를 가지는 건 그만큼 물가상승 폭이 크기 때문입니다.';
let scriptTest30_2 = new Script_1.Script();
scriptTest30_2.startTime = new Time_1.Time(8, 91);
scriptTest30_2.endTime = new Time_1.Time(16, 74);
scriptTest30_2.text = '이 정도로 물가는 뛰는데 월급은 그만큼 오르지 않아서 중산층은 실질소득이 오히려 줄어든 것으로 나타났습니다.';
let scriptTest30_3 = new Script_1.Script();
scriptTest30_3.startTime = new Time_1.Time(16, 74);
scriptTest30_3.endTime = new Time_1.Time(22, 43);
scriptTest30_3.text = '당장 월급 올려달라는 요구가 거센데 정부가 물가가 더 오를까 봐 자제를 요청하고 있습니다.';
let scriptTest30_4 = new Script_1.Script();
scriptTest30_4.startTime = new Time_1.Time(22, 43);
scriptTest30_4.endTime = new Time_1.Time(24, 3);
scriptTest30_4.text = '정혜진 기자입니다.';
// 31번 뉴스
let tagTest31_1 = new Tag_1.Tag();
tagTest31_1.name = '미국';
let tagTest31_2 = new Tag_1.Tag();
tagTest31_2.name = '시위';
let tagTest31_3 = new Tag_1.Tag();
tagTest31_3.name = '트럼프';
let scriptTest31_1 = new Script_1.Script();
scriptTest31_1.startTime = new Time_1.Time(0, 0);
scriptTest31_1.endTime = new Time_1.Time(9, 26);
scriptTest31_1.text = '흑인 남성 \'조지 플로이드\'가 백인 경찰의 강압적인 체포 과정에서 숨진 사건에 대한 항의 시위가 미국 전역에서 8일째 이어지고 있습니다.';
let scriptTest31_2 = new Script_1.Script();
scriptTest31_2.startTime = new Time_1.Time(9, 26);
scriptTest31_2.endTime = new Time_1.Time(17, 6);
scriptTest31_2.text = '수도 워싱턴 DC에 주 방위군 1500명이 추가로 투입될 예정인 가운데 트럼프 대통령은 강경 대응 방침을 굽히지 않고 있습니다.';
let scriptTest31_3 = new Script_1.Script();
scriptTest31_3.startTime = new Time_1.Time(17, 6);
scriptTest31_3.endTime = new Time_1.Time(22, 19);
scriptTest31_3.text = '이번 시위로 지금까지 체포된 사람은 5600명이 넘고 부상자가 속출하고 있습니다.';
let scriptTest31_4 = new Script_1.Script();
scriptTest31_4.startTime = new Time_1.Time(22, 19);
scriptTest31_4.endTime = new Time_1.Time(31, 18);
scriptTest31_4.text = '전쟁터를 방불케 하는 상황이 곳곳에서 펼쳐지고 있습니다. 워싱턴과 뉴욕, LA 등 주요 도시에는 야간 통행 금지령이 계속해서 내려졌습니다.';
let scriptTest31_5 = new Script_1.Script();
scriptTest31_5.startTime = new Time_1.Time(31, 18);
scriptTest31_5.endTime = new Time_1.Time(34, 7);
scriptTest31_5.text = '워싱턴에서 임종주 특파원이 소식 전해왔습니다.';
// 32번 뉴스
let tagTest32_1 = new Tag_1.Tag();
tagTest32_1.name = '경제성장률';
let tagTest32_2 = new Tag_1.Tag();
tagTest32_2.name = '불황';
let tagTest32_3 = new Tag_1.Tag();
tagTest32_3.name = '경제';
let scriptTest32_1 = new Script_1.Script();
scriptTest32_1.startTime = new Time_1.Time(0, 0);
scriptTest32_1.endTime = new Time_1.Time(8, 95);
scriptTest32_1.text = '어느 정도 경제 발전을 이룬 나라가 계속해서 몇 퍼센트씩 높은 경제 성장률을 유지하기는 사실 쉽지는 않습니다.';
let scriptTest32_2 = new Script_1.Script();
scriptTest32_2.startTime = new Time_1.Time(8, 95);
scriptTest32_2.endTime = new Time_1.Time(16, 56);
scriptTest32_2.text = '그렇다고 해도 갈수록 경제 활력이 떨어지고 또 경기가 부진한 지금 상황은 심각하게 볼 필요가 있습니다.';
let scriptTest32_3 = new Script_1.Script();
scriptTest32_3.startTime = new Time_1.Time(16, 56);
scriptTest32_3.endTime = new Time_1.Time(21, 7);
scriptTest32_3.text = '박민하 기자가 우리 경제의 문제점과 그 해법까지 함께 짚어봤습니다.';
// 33번 뉴스
let tagTest33_1 = new Tag_1.Tag();
tagTest33_1.name = '필리핀';
let tagTest33_2 = new Tag_1.Tag();
tagTest33_2.name = '대선';
let tagTest33_3 = new Tag_1.Tag();
tagTest33_3.name = '독재';
let scriptTest33_1 = new Script_1.Script();
scriptTest33_1.startTime = new Time_1.Time(0, 0);
scriptTest33_1.endTime = new Time_1.Time(8, 43);
scriptTest33_1.text = '필리핀에서 20여 년 동안 독재와 부정 축재를 일삼다 쫓겨난 마르코스 이멜다 부부, 기억하시는지요.';
let scriptTest33_2 = new Script_1.Script();
scriptTest33_2.startTime = new Time_1.Time(8, 43);
scriptTest33_2.endTime = new Time_1.Time(13, 35);
scriptTest33_2.text = '이멜다가 다시 필리핀 대통령궁으로 들어갈 가능성이 높아지고 있습니다.';
let scriptTest33_3 = new Script_1.Script();
scriptTest33_3.startTime = new Time_1.Time(13, 35);
scriptTest33_3.endTime = new Time_1.Time(20, 78);
scriptTest33_3.text = '그녀의 아들 \'봉봉 마르코스 주니어\'가 오는 5월에 있을 필리핀 대선에서 유력한 주자로 꼽히고 있습니다.';
let scriptTest33_4 = new Script_1.Script();
scriptTest33_4.startTime = new Time_1.Time(20, 78);
scriptTest33_4.endTime = new Time_1.Time(22, 81);
scriptTest33_4.text = '방콕 김원장 특파원입니다.';
// 34번 뉴스
let tagTest34_1 = new Tag_1.Tag();
tagTest34_1.name = '완도실종';
let tagTest34_2 = new Tag_1.Tag();
tagTest34_2.name = '일가족';
let tagTest34_3 = new Tag_1.Tag();
tagTest34_3.name = '부검';
let scriptTest34_1 = new Script_1.Script();
scriptTest34_1.startTime = new Time_1.Time(0, 0);
scriptTest34_1.endTime = new Time_1.Time(11, 6);
scriptTest34_1.text = '전남 완도 앞바다에서 숨진 채 발견된 조유나 양 일가족 3명의 정확한 사망 원인을 밝히기 위해 경찰이 1차 부검을 진행한 결과 \'사인 불명\'으로 나왔습니다.';
let scriptTest34_2 = new Script_1.Script();
scriptTest34_2.startTime = new Time_1.Time(11, 6);
scriptTest34_2.endTime = new Time_1.Time(20, 85);
scriptTest34_2.text = '광주 남부경찰서는 국립과학수사연구원으로부터 사인은 불명이지만 익사 가능성을 배제할 수 없다는 1차 부검 결과를 통보받았다고 밝혔습니다. ';
let scriptTest34_3 = new Script_1.Script();
scriptTest34_3.startTime = new Time_1.Time(20, 85);
scriptTest34_3.endTime = new Time_1.Time(29, 0);
scriptTest34_3.text = '경찰은 정확한 사인 파악을 위해 정밀 검사를 의뢰했고 최종 결과가 나오려면 한 달가량 걸릴 것으로 보입니다.';
// 35번 뉴스
let tagTest35_1 = new Tag_1.Tag();
tagTest35_1.name = '허준이';
let tagTest35_2 = new Tag_1.Tag();
tagTest35_2.name = '필즈상';
let tagTest35_3 = new Tag_1.Tag();
tagTest35_3.name = '수학자';
let scriptTest35_1 = new Script_1.Script();
scriptTest35_1.startTime = new Time_1.Time(0, 0);
scriptTest35_1.endTime = new Time_1.Time(3, 25);
scriptTest35_1.text = '오늘 반가운 소식이 하나 전해졌습니다.';
let scriptTest35_2 = new Script_1.Script();
scriptTest35_2.startTime = new Time_1.Time(3, 25);
scriptTest35_2.endTime = new Time_1.Time(8, 70);
scriptTest35_2.text = '수학계에서 가장 권위 있는 상으로 수학계 노벨상이라고 불리는 필즈상.';
let scriptTest35_3 = new Script_1.Script();
scriptTest35_3.startTime = new Time_1.Time(8, 70);
scriptTest35_3.endTime = new Time_1.Time(16, 47);
scriptTest35_3.text = '미국 프린스턴 대학의 교수이자 한국 고등과학원의 석학 교수인 허준이 교수가 수상자로 선정이 됐습니다.';
let scriptTest35_4 = new Script_1.Script();
scriptTest35_4.startTime = new Time_1.Time(16, 47);
scriptTest35_4.endTime = new Time_1.Time(22, 95);
scriptTest35_4.text = '한국계 수학자로서는 첫 수상인데 한국 수학의 발전을 보여준 쾌거라고 할 수 있겠습니다.';
let scriptTest35_5 = new Script_1.Script();
scriptTest35_5.startTime = new Time_1.Time(22, 95);
scriptTest35_5.endTime = new Time_1.Time(25, 49);
scriptTest35_5.text = '먼저 박소희 기자가 전해드리겠습니다.';
// 36번 뉴스
let tagTest36_1 = new Tag_1.Tag();
tagTest36_1.name = '오징어게임';
let tagTest36_2 = new Tag_1.Tag();
tagTest36_2.name = '오일남';
let tagTest36_3 = new Tag_1.Tag();
tagTest36_3.name = '골든글로브';
let scriptTest36_1 = new Script_1.Script();
scriptTest36_1.startTime = new Time_1.Time(0, 0);
scriptTest36_1.endTime = new Time_1.Time(8, 23);
scriptTest36_1.text = '깐부 할아버지로 잘 알려진 배우 오영수 씨가 드라마 \'오징어 게임\'으로 한국 배우 최초로 미국 골든글로브 연기상을 수상했습니다.';
let scriptTest36_2 = new Script_1.Script();
scriptTest36_2.startTime = new Time_1.Time(8, 23);
scriptTest36_2.endTime = new Time_1.Time(12, 56);
scriptTest36_2.text = '오 씨가 수상한 부문은 골든글로브 TV 드라마 남우조연상입니다.';
let scriptTest36_3 = new Script_1.Script();
scriptTest36_3.startTime = new Time_1.Time(12, 56);
scriptTest36_3.endTime = new Time_1.Time(20, 4);
scriptTest36_3.text = 'TV 드라마 남우주연상은 석세션의 제레미 스트롱에게 돌아가서 후보에 오른 이정재 씨의 수상은 불발됐습니다.';
let scriptTest36_4 = new Script_1.Script();
scriptTest36_4.startTime = new Time_1.Time(20, 4);
scriptTest36_4.endTime = new Time_1.Time(30, 0);
scriptTest36_4.text = '오징어게임은 456억 원의 상금을 차지하기 위해서 목숨을 걸고 벌이는 서바이벌 게임을 그린 드라마로 오 씨는 게임 참가자 오일남 역을 맡았습니다.';
// 37번 뉴스
let tagTest37_1 = new Tag_1.Tag();
tagTest37_1.name = '커피콩';
let tagTest37_2 = new Tag_1.Tag();
tagTest37_2.name = '부가가치세';
let tagTest37_3 = new Tag_1.Tag();
tagTest37_3.name = '수입';
let scriptTest37_1 = new Script_1.Script();
scriptTest37_1.startTime = new Time_1.Time(10, 33);
scriptTest37_1.endTime = new Time_1.Time(13, 97);
scriptTest37_1.text = '화제의 경제 뉴스를 빠르게 전해드리는 신선한 경제 시간입니다.';
let scriptTest37_2 = new Script_1.Script();
scriptTest37_2.startTime = new Time_1.Time(13, 97);
scriptTest37_2.endTime = new Time_1.Time(22, 98);
scriptTest37_2.text = '커피콩이라고 하죠. 커피 생두에 붙이던 수입 부가가치세 10%를 면제하기로 하면서 커피 가격도 내릴까 기대가 큰데요.';
let scriptTest37_3 = new Script_1.Script();
scriptTest37_3.startTime = new Time_1.Time(22, 98);
scriptTest37_3.endTime = new Time_1.Time(25, 39);
scriptTest37_3.text = '과연 내려갈까요?';
let scriptTest37_4 = new Script_1.Script();
scriptTest37_4.startTime = new Time_1.Time(25, 39);
scriptTest37_4.endTime = new Time_1.Time(35, 52);
scriptTest37_4.text = '국내 커피 생두의 25%를 수입하는 동서식품은 이미 생두 가격이 2년 새 2배나 오른 상황이라 가격을 내릴 계획이 없다고 밝혔습니다.';
let scriptTest37_5 = new Script_1.Script();
scriptTest37_5.startTime = new Time_1.Time(35, 52);
scriptTest37_5.endTime = new Time_1.Time(43, 77);
scriptTest37_5.text = '인하 방침을 밝힌 수입업체도 있긴 하지만 통관부터 배송까지 걸리는 시간을 감안하면 두 달 뒤에야 효과가 나타날 것으로 보이고요.';
let scriptTest37_6 = new Script_1.Script();
scriptTest37_6.startTime = new Time_1.Time(43, 77);
scriptTest37_6.endTime = new Time_1.Time(55, 53);
scriptTest37_6.text = '이들 업체로부터 생두를 구매하는 카페들이 커피 가격을 내려야 소비자들이 혜택을 볼 텐데 임대료와 인건비 부담이 많이 늘어난 상황이라 실제 가격 인하로 이어질지는 미지수입니다.';
let scriptTest37_7 = new Script_1.Script();
scriptTest37_7.startTime = new Time_1.Time(55, 53);
scriptTest37_7.endTime = new Time_1.Time(65, 34);
scriptTest37_7.text = '또 카페 프랜차이즈 1위 업체인 스타벅스 코리아는 생두 대신 볶은 원두를 수입해 부가세 면제 혜택을 볼 수 없다고 하네요.';
// 38번 뉴스
let tagTest38_1 = new Tag_1.Tag();
tagTest38_1.name = '현대자동차';
let tagTest38_2 = new Tag_1.Tag();
tagTest38_2.name = '디자이너';
let tagTest38_3 = new Tag_1.Tag();
tagTest38_3.name = '과로자살';
let scriptTest38_1 = new Script_1.Script();
scriptTest38_1.startTime = new Time_1.Time(0, 0);
scriptTest38_1.endTime = new Time_1.Time(5, 33);
scriptTest38_1.text = '현대자동차 남양연구소는 현대차의 심장 같은 곳입니다.';
let scriptTest38_2 = new Script_1.Script();
scriptTest38_2.startTime = new Time_1.Time(5, 33);
scriptTest38_2.endTime = new Time_1.Time(12, 32);
scriptTest38_2.text = '1년 4개월 전 이 연구소 디자인 센터의 한 팀장급 직원이 스스로 생을 정리했습니다.';
let scriptTest38_3 = new Script_1.Script();
scriptTest38_3.startTime = new Time_1.Time(12, 32);
scriptTest38_3.endTime = new Time_1.Time(19, 41);
scriptTest38_3.text = 'MBC는 고인이 남긴 기록, 유가족과 여러 동료의 증언 그리고 회사의 입장을 취재했습니다.';
let scriptTest38_4 = new Script_1.Script();
scriptTest38_4.startTime = new Time_1.Time(19, 41);
scriptTest38_4.endTime = new Time_1.Time(25, 44);
scriptTest38_4.text = '그 결과 이 죽음이 개인의 선택을 넘어 사회적 죽음이라고 판단하기로 했습니다.';
let scriptTest38_5 = new Script_1.Script();
scriptTest38_5.startTime = new Time_1.Time(25, 44);
scriptTest38_5.endTime = new Time_1.Time(31, 43);
scriptTest38_5.text = '우리에게는 아직 생소한 과로 자살. 차주혁 기자의 보도로 시작합니다.';
// 39번 뉴스
let tagTest39_1 = new Tag_1.Tag();
tagTest39_1.name = '통일부';
let tagTest39_2 = new Tag_1.Tag();
tagTest39_2.name = '북한';
let tagTest39_3 = new Tag_1.Tag();
tagTest39_3.name = '어민';
let scriptTest39_1 = new Script_1.Script();
scriptTest39_1.startTime = new Time_1.Time(0, 0);
scriptTest39_1.endTime = new Time_1.Time(9, 85);
scriptTest39_1.text = '2019년 11월 북한 어민 2명이 북송된 사건과 관련해 통일부가 당시 잘못된 부분이 있었다는 입장을 밝혔습니다. ';
let scriptTest39_2 = new Script_1.Script();
scriptTest39_2.startTime = new Time_1.Time(9, 85);
scriptTest39_2.endTime = new Time_1.Time(15, 55);
scriptTest39_2.text = '헌법상 대한민국 국민인 탈북 어민들이 적절한 조치를 받지 못했다는 건데요.';
let scriptTest39_3 = new Script_1.Script();
scriptTest39_3.startTime = new Time_1.Time(15, 55);
scriptTest39_3.endTime = new Time_1.Time(22, 64);
scriptTest39_3.text = '검찰 수사가 시작된 가운데 당시 어민들의 귀순 의사에 진정성이 있었는지가 쟁점이 될 것으로 보입니다.';
let scriptTest39_4 = new Script_1.Script();
scriptTest39_4.startTime = new Time_1.Time(22, 64);
scriptTest39_4.endTime = new Time_1.Time(24, 9);
scriptTest39_4.text = '김수연 기자입니다.';
// 40번 뉴스
let tagTest40_1 = new Tag_1.Tag();
tagTest40_1.name = '이은해';
let tagTest40_2 = new Tag_1.Tag();
tagTest40_2.name = '조현수';
let tagTest40_3 = new Tag_1.Tag();
tagTest40_3.name = '보험사기';
let scriptTest40_1 = new Script_1.Script();
scriptTest40_1.startTime = new Time_1.Time(0, 0);
scriptTest40_1.endTime = new Time_1.Time(7, 15);
scriptTest40_1.text = '3년 전 수영을 못하는 한 30대 남성이 계곡에서 다이빙을 하다가 숨진 사건이 있었습니다.';
let scriptTest40_2 = new Script_1.Script();
scriptTest40_2.startTime = new Time_1.Time(7, 15);
scriptTest40_2.endTime = new Time_1.Time(10, 62);
scriptTest40_2.text = '단순한 사망 사고로 끝날 뻔했던 이 사건.';
let scriptTest40_3 = new Script_1.Script();
scriptTest40_3.startTime = new Time_1.Time(10, 62);
scriptTest40_3.endTime = new Time_1.Time(17, 21);
scriptTest40_3.text = '부인이 숨진 남편의 명의로 8억 원이 넘는 보험금을 타려고 하면서 재수사가 시작됐는데요.';
let scriptTest40_4 = new Script_1.Script();
scriptTest40_4.startTime = new Time_1.Time(17, 21);
scriptTest40_4.endTime = new Time_1.Time(24, 24);
scriptTest40_4.text = '검찰이 숨진 남성의 부인 그리고 공범인 30대 남성을 살인 혐의로 공개 수배했습니다.';
let scriptTest40_5 = new Script_1.Script();
scriptTest40_5.startTime = new Time_1.Time(24, 24);
scriptTest40_5.endTime = new Time_1.Time(26, 19);
scriptTest40_5.text = '차현진 기자가 취재했습니다.';
// 41번 뉴스
let tagTest41_1 = new Tag_1.Tag();
tagTest41_1.name = '스리랑카';
let tagTest41_2 = new Tag_1.Tag();
tagTest41_2.name = '국가부도';
let tagTest41_3 = new Tag_1.Tag();
tagTest41_3.name = '대통령사임';
let scriptTest41_1 = new Script_1.Script();
scriptTest41_1.startTime = new Time_1.Time(0, 0);
scriptTest41_1.endTime = new Time_1.Time(4, 88);
scriptTest41_1.text = '이번에는 국가 부도 상태에 빠진 스리랑카 소식 전해드립니다.';
let scriptTest41_2 = new Script_1.Script();
scriptTest41_2.startTime = new Time_1.Time(4, 88);
scriptTest41_2.endTime = new Time_1.Time(11, 57);
scriptTest41_2.text = '전기도 끊기고 연료도 살 수 없게 되자 분노한 국민들이 정권 퇴진을 외치며 거리로 나왔는데요.';
let scriptTest41_3 = new Script_1.Script();
scriptTest41_3.startTime = new Time_1.Time(11, 57);
scriptTest41_3.endTime = new Time_1.Time(18, 81);
scriptTest41_3.text = '대통령 집무실과 관저를 점거한 지 하루 만에 스리랑카 대통령이 전격 사임 의사를 밝혔습니다.';
let scriptTest41_4 = new Script_1.Script();
scriptTest41_4.startTime = new Time_1.Time(18, 81);
scriptTest41_4.endTime = new Time_1.Time(23, 33);
scriptTest41_4.text = '최악의 경제난에 이어 정치권까지 격랑에 빠지게 됐습니다.';
let scriptTest41_5 = new Script_1.Script();
scriptTest41_5.startTime = new Time_1.Time(23, 33);
scriptTest41_5.endTime = new Time_1.Time(25, 10);
scriptTest41_5.text = '조재형 기자입니다.';
// 42번 뉴스
let tagTest42_1 = new Tag_1.Tag();
tagTest42_1.name = '대선';
let tagTest42_2 = new Tag_1.Tag();
tagTest42_2.name = '청년';
let tagTest42_3 = new Tag_1.Tag();
tagTest42_3.name = '가난';
let scriptTest42_1 = new Script_1.Script();
scriptTest42_1.startTime = new Time_1.Time(0, 0);
scriptTest42_1.endTime = new Time_1.Time(6, 28);
scriptTest42_1.text = '이번 대선에서 후보들이 가장 공들이는 대상은 2030 청년세대입니다.';
let scriptTest42_2 = new Script_1.Script();
scriptTest42_2.startTime = new Time_1.Time(6, 28);
scriptTest42_2.endTime = new Time_1.Time(19, 46);
scriptTest42_2.text = '이들 표심에 따라서 판도 자체가 확 바뀔 수 있다고 해도 과언이 아닌데, 청년들이 후보들에게 요구하는 내용, 얼마 전 청년 시민단체 38개의 합동 기자회견에 단서가 있습니다.';
let scriptTest42_3 = new Script_1.Script();
scriptTest42_3.startTime = new Time_1.Time(19, 46);
scriptTest42_3.endTime = new Time_1.Time(37, 49);
...
let scriptTest42_4 = new Script_1.Script();
scriptTest42_4.startTime = new Time_1.Time(37, 49);
scriptTest42_4.endTime = new Time_1.Time(43, 63);
scriptTest42_4.text = '그렇다면 2030 청년들, 어떤 특징을 가지고 있고, 가장 고민하는 게 뭘까요?';
let scriptTest42_5 = new Script_1.Script();
scriptTest42_5.startTime = new Time_1.Time(43, 63);
scriptTest42_5.endTime = new Time_1.Time(46, 24);
scriptTest42_5.text = '강병수 기자가 자세히 들여다봤습니다.';
// 43번 뉴스
let tagTest43_1 = new Tag_1.Tag();
tagTest43_1.name = '방탄소년단';
let tagTest43_2 = new Tag_1.Tag();
tagTest43_2.name = 'AMA';
let tagTest43_3 = new Tag_1.Tag();
tagTest43_3.name = '그래미';
let scriptTest43_1 = new Script_1.Script();
scriptTest43_1.startTime = new Time_1.Time(0, 0);
scriptTest43_1.endTime = new Time_1.Time(11, 21);
scriptTest43_1.text = '방탄소년단 BTS가 미국의 3대 대중 음악 시상식으로 꼽히는 아메리칸 뮤직어워즈에서 대상에 해당하는 올해의 아티스트상을 받았습니다.';
let scriptTest43_2 = new Script_1.Script();
scriptTest43_2.startTime = new Time_1.Time(11, 21);
scriptTest43_2.endTime = new Time_1.Time(19, 13);
scriptTest43_2.text = '아시아 가수가 이 상을 받은 건 사상 처음인데, 내년 초에 열릴 그래미 시상식에 대한 기대감도 높아지고 있습니다.';
let scriptTest43_3 = new Script_1.Script();
scriptTest43_3.startTime = new Time_1.Time(19, 13);
scriptTest43_3.endTime = new Time_1.Time(21, 4);
scriptTest43_3.text = '워싱턴 김윤수 특파원입니다.';
// 44번 뉴스
let tagTest44_1 = new Tag_1.Tag();
tagTest44_1.name = '승리';
let tagTest44_2 = new Tag_1.Tag();
tagTest44_2.name = '빅뱅';
let tagTest44_3 = new Tag_1.Tag();
tagTest44_3.name = '성매매';
let scriptTest44_1 = new Script_1.Script();
scriptTest44_1.startTime = new Time_1.Time(0, 0);
scriptTest44_1.endTime = new Time_1.Time(4, 76);
scriptTest44_1.text = '여러분, 안녕하십니까? 8월 12일 목요일 MBC 5시 뉴스입니다.';
let scriptTest44_2 = new Script_1.Script();
scriptTest44_2.startTime = new Time_1.Time(4, 76);
scriptTest44_2.endTime = new Time_1.Time(18, 91);
...
let scriptTest44_3 = new Script_1.Script();
scriptTest44_3.startTime = new Time_1.Time(18, 91);
scriptTest44_3.endTime = new Time_1.Time(30, 67);
scriptTest44_3.text = '경기 용인시 소재 지사 작전사령부 보통군사법원은 오늘 성매매 알선 등 9개 혐의로 기소된 승리에게 징역 3년의 추징금 11억 5,000만 원을 선고했습니다.';
let scriptTest44_4 = new Script_1.Script();
scriptTest44_4.startTime = new Time_1.Time(30, 67);
scriptTest44_4.endTime = new Time_1.Time(47, 14);
...
// 45번 뉴스
let tagTest45_1 = new Tag_1.Tag();
tagTest45_1.name = '아이돌학교';
let tagTest45_2 = new Tag_1.Tag();
tagTest45_2.name = '투표조작';
let tagTest45_3 = new Tag_1.Tag();
tagTest45_3.name = '구속영장';
let scriptTest45_1 = new Script_1.Script();
scriptTest45_1.startTime = new Time_1.Time(0, 0);
scriptTest45_1.endTime = new Time_1.Time(9, 80);
scriptTest45_1.text = '시청자 투표로 아이돌 가수를 뽑는 프로그램에서 그 투표 결과를 조작한 혐의로 구속된 엠넷의 제작진이 지금 재판을 받고 있습니다.';
let scriptTest45_2 = new Script_1.Script();
scriptTest45_2.startTime = new Time_1.Time(9, 80);
scriptTest45_2.endTime = new Time_1.Time(18, 46);
scriptTest45_2.text = '그런데 같은 회사의 다른 오디션 프로그램에서도 결과를 조작했다는 정황이 드러나서 제작진 2명에 대해 구속영장이 청구됐습니다.';
let scriptTest45_3 = new Script_1.Script();
scriptTest45_3.startTime = new Time_1.Time(18, 46);
scriptTest45_3.endTime = new Time_1.Time(20, 2);
scriptTest45_3.text = '전연남 기자입니다.';
// 46번 뉴스
let tagTest46_1 = new Tag_1.Tag();
tagTest46_1.name = '가상화폐';
let tagTest46_2 = new Tag_1.Tag();
tagTest46_2.name = '루나';
let tagTest46_3 = new Tag_1.Tag();
tagTest46_3.name = '권도형';
let scriptTest46_1 = new Script_1.Script();
scriptTest46_1.startTime = new Time_1.Time(0, 0);
scriptTest46_1.endTime = new Time_1.Time(9, 58);
scriptTest46_1.text = '가상화폐인 테라, 루나의 폭락 사태 이후 우리나라와 미국 검찰이 수사에 나섰지만, 아직 이렇다 할 성과를 내지 못하고 있습니다.';
let scriptTest46_2 = new Script_1.Script();
scriptTest46_2.startTime = new Time_1.Time(9, 58);
scriptTest46_2.endTime = new Time_1.Time(19, 6);
scriptTest46_2.text = '그러자 그 발행업체의 대표인 권도형 씨를 추적하고 또 의혹을 밝히기 위해서 가상화폐에 투자했던 사람들이 직접 나섰습니다.';
let scriptTest46_3 = new Script_1.Script();
scriptTest46_3.startTime = new Time_1.Time(19, 6);
scriptTest46_3.endTime = new Time_1.Time(21, 33);
scriptTest46_3.text = '이 내용 김혜민 기자가 전하겠습니다.';
// 47번 뉴스
let tagTest47_1 = new Tag_1.Tag();
tagTest47_1.name = '북한';
let tagTest47_2 = new Tag_1.Tag();
tagTest47_2.name = '바이든';
let tagTest47_3 = new Tag_1.Tag();
tagTest47_3.name = '미사일';
let scriptTest47_1 = new Script_1.Script();
scriptTest47_1.startTime = new Time_1.Time(0, 0);
scriptTest47_1.endTime = new Time_1.Time(9, 86);
scriptTest47_1.text = '방금 이야기한 대로 정부는 북한의 움직임을 예의주시하고 있는데 이르면 이번 주 안에 북한이 장거리 탄도미사일을 추가로 쏠 거란 관측이 나오고 있습니다.';
let scriptTest47_2 = new Script_1.Script();
scriptTest47_2.startTime = new Time_1.Time(9, 86);
scriptTest47_2.endTime = new Time_1.Time(18, 97);
scriptTest47_2.text = '지난주 바이든 미국 대통령이 우리나라에 왔을 때 북한이 도발에 나설 수 있다는 분석도 있었는데 조용히 지나갔던 이유가 있었습니다.';
let scriptTest47_3 = new Script_1.Script();
scriptTest47_3.startTime = new Time_1.Time(18, 97);
scriptTest47_3.endTime = new Time_1.Time(22, 0);
scriptTest47_3.text = '안정식 북한 전문기자가 그 이유를 설명해 드리겠습니다.';
// 48번 뉴스
let tagTest48_1 = new Tag_1.Tag();
tagTest48_1.name = '베이징올림픽';
let tagTest48_2 = new Tag_1.Tag();
tagTest48_2.name = '쇼트트랙';
let tagTest48_3 = new Tag_1.Tag();
tagTest48_3.name = '편파판정';
let scriptTest48_1 = new Script_1.Script();
scriptTest48_1.startTime = new Time_1.Time(0, 0);
scriptTest48_1.endTime = new Time_1.Time(6, 88);
scriptTest48_1.text = '지금부터는 남자 쇼트트랙, 분노의 편파 판정 논란 자세하게 보도해드립니다.';
let scriptTest48_2 = new Script_1.Script();
scriptTest48_2.startTime = new Time_1.Time(6, 88);
scriptTest48_2.endTime = new Time_1.Time(16, 0);
scriptTest48_2.text = '왜 하필 중국 선수 앞에 섰다가 실격이 되고 그래서 맨 먼저 들어오지도 않은 중국 선수가 결국 금메달을 목에 걸었는지.';
let scriptTest48_3 = new Script_1.Script();
scriptTest48_3.startTime = new Time_1.Time(16, 0);
scriptTest48_3.endTime = new Time_1.Time(25, 80);
scriptTest48_3.text = '심판의 판정이라는 절차적 이유만 앞세울 게 아니라 그 한참 위에 있는 올림픽 정신에 부끄럽지 않은 답이 나와야 할 겁니다.';
let scriptTest48_4 = new Script_1.Script();
scriptTest48_4.startTime = new Time_1.Time(25, 80);
scriptTest48_4.endTime = new Time_1.Time(32, 28);
scriptTest48_4.text = '한국 팀은 황당한 편파 판정을 국제스포츠중재재판소에 제소하기로 했습니다.';
let scriptTest48_5 = new Script_1.Script();
scriptTest48_5.startTime = new Time_1.Time(32, 28);
scriptTest48_5.endTime = new Time_1.Time(39, 16);
scriptTest48_5.text = '먼저 바람만 스쳐도 실격될 거라는 우려가 현실이 된 과정을 이명노 기자가 보도합니다.';
// 49번 뉴스
let tagTest49_1 = new Tag_1.Tag();
tagTest49_1.name = '농협';
let tagTest49_2 = new Tag_1.Tag();
tagTest49_2.name = '직원';
let tagTest49_3 = new Tag_1.Tag();
tagTest49_3.name = '횡령';
let scriptTest49_1 = new Script_1.Script();
scriptTest49_1.startTime = new Time_1.Time(0, 0);
scriptTest49_1.endTime = new Time_1.Time(6, 57);
scriptTest49_1.text = '농협 직원이 도박 손실을 막으려고 회삿돈 40억 원을 횡령했다는 사건, YTN이 단독으로 전해드렸죠.';
let scriptTest49_2 = new Script_1.Script();
scriptTest49_2.startTime = new Time_1.Time(6, 57);
scriptTest49_2.endTime = new Time_1.Time(11, 3);
scriptTest49_2.text = '이 농협 직원은 복권을 사는 데도 10억 원 넘게 쓴 거로 알려졌습니다.';
let scriptTest49_3 = new Script_1.Script();
scriptTest49_3.startTime = new Time_1.Time(11, 33);
scriptTest49_3.endTime = new Time_1.Time(19, 49);
scriptTest49_3.text = '그런데 YTN 취재 결과 복권을 대신 사달라는 부탁을 받은 복권방 사장이 횡령금을 몰래 빼돌렸을 가능성이 새롭게 제기됐습니다.';
let scriptTest49_4 = new Script_1.Script();
scriptTest49_4.startTime = new Time_1.Time(19, 49);
scriptTest49_4.endTime = new Time_1.Time(23, 63);
scriptTest49_4.text = '경찰도 수사 범위를 확대해 복권방과 사무실을 압수수색 했습니다.';
let scriptTest49_5 = new Script_1.Script();
scriptTest49_5.startTime = new Time_1.Time(23, 63);
scriptTest49_5.endTime = new Time_1.Time(27, 59);
scriptTest49_5.text = '취재기자 연결해 자세한 내용 알아보겠습니다. 강민경 기자!';
// 50번 뉴스
let tagTest50_1 = new Tag_1.Tag();
tagTest50_1.name = '연세대';
let tagTest50_2 = new Tag_1.Tag();
tagTest50_2.name = '청소노동자';
let tagTest50_3 = new Tag_1.Tag();
tagTest50_3.name = '손해배상';
let scriptTest50_1 = new Script_1.Script();
scriptTest50_1.startTime = new Time_1.Time(0, 0);
scriptTest50_1.endTime = new Time_1.Time(7, 9);
scriptTest50_1.text = '연세대학교 청소 노동자들이 근로 조건을 개선해달라며, 넉 달째 집회를 이어가고 있습니다.';
let scriptTest50_2 = new Script_1.Script();
scriptTest50_2.startTime = new Time_1.Time(7, 9);
scriptTest50_2.endTime = new Time_1.Time(14, 73);
scriptTest50_2.text = '그런데, 몇몇 학생들이 집회 소음으로 수업권이 침해됐다며 소송을 제기해 논란이 커지고 있습니다.';
let scriptTest50_3 = new Script_1.Script();
scriptTest50_3.startTime = new Time_1.Time(14, 73);
scriptTest50_3.endTime = new Time_1.Time(20, 70);
scriptTest50_3.text = '이 학생들에 대한 비판도 나오는 가운데 문제를 풀어야 할 학교는 침묵하고 있습니다.';
let scriptTest50_4 = new Script_1.Script();
scriptTest50_4.startTime = new Time_1.Time(20, 70);
scriptTest50_4.endTime = new Time_1.Time(22, 75);
scriptTest50_4.text = '김성수 기잡니다.';
// 51번 뉴스
let tagTest51_1 = new Tag_1.Tag();
tagTest51_1.name = '코로나19';
let tagTest51_2 = new Tag_1.Tag();
tagTest51_2.name = '재확산';
let tagTest51_3 = new Tag_1.Tag();
tagTest51_3.name = 'BA5변이';
let scriptTest51_1 = new Script_1.Script();
scriptTest51_1.startTime = new Time_1.Time(0, 0);
scriptTest51_1.endTime = new Time_1.Time(5, 93);
scriptTest51_1.text = '3년 만에 즐기는 시원한 물놀이에 본격적인 휴가철도 이제 시작됐죠.';
let scriptTest51_2 = new Script_1.Script();
scriptTest51_2.startTime = new Time_1.Time(5, 93);
scriptTest51_2.endTime = new Time_1.Time(10, 63);
scriptTest51_2.text = '그동안 타격이 컸던 관광업계는 올여름 기대를 좀 하고 있을 텐데요.';
let scriptTest51_3 = new Script_1.Script();
scriptTest51_3.startTime = new Time_1.Time(10, 63);
scriptTest51_3.endTime = new Time_1.Time(15, 95);
scriptTest51_3.text = 'BA.5 변이로 인한 코로나 재유행이 발목을 잡는 모양새입니다.';
let scriptTest51_4 = new Script_1.Script();
scriptTest51_4.startTime = new Time_1.Time(15, 95);
scriptTest51_4.endTime = new Time_1.Time(26, 26);
scriptTest51_4.text = '신규 확진자가 하루 2만 명을 넘어섰는데 정부는 재유행이 예상보다 더 빨리 찾아왔다고 판단하고 다음 주 새 방역 대책을 발표하기로 했습니다.';
let scriptTest51_5 = new Script_1.Script();
scriptTest51_5.startTime = new Time_1.Time(26, 26);
scriptTest51_5.endTime = new Time_1.Time(28, 14);
scriptTest51_5.text = '양소연 기자가 보도합니다.';
// 52번 뉴스
let tagTest52_1 = new Tag_1.Tag();
tagTest52_1.name = '이준석';
let tagTest52_2 = new Tag_1.Tag();
tagTest52_2.name = '국민의힘';
let tagTest52_3 = new Tag_1.Tag();
tagTest52_3.name = '사퇴압박';
let scriptTest52_1 = new Script_1.Script();
scriptTest52_1.startTime = new Time_1.Time(0, 0);
scriptTest52_1.endTime = new Time_1.Time(7, 72);
scriptTest52_1.text = '국민의힘 이준석 대표에 대한 당 윤리위의 중징계 결정 이후 이 대표의 잠행은 오늘도 계속되고 있는데요.';
let scriptTest52_2 = new Script_1.Script();
scriptTest52_2.startTime = new Time_1.Time(7, 72);
scriptTest52_2.endTime = new Time_1.Time(12, 21);
scriptTest52_2.text = ' 당 내부에서는 앞으로 당 대표 직무 대행 체제로 가야 한다.';
let scriptTest52_3 = new Script_1.Script();
scriptTest52_3.startTime = new Time_1.Time(12, 21);
scriptTest52_3.endTime = new Time_1.Time(18, 2);
scriptTest52_3.text = '아니다. 대표직을 사퇴하고 조기 전당대회를 여는 게 맞다 의견이 갈리고 있습니다.';
let scriptTest52_4 = new Script_1.Script();
scriptTest52_4.startTime = new Time_1.Time(18, 2);
scriptTest52_4.endTime = new Time_1.Time(23, 88);
scriptTest52_4.text = '국민의힘은 내일 의원총회 등을 통해 당 수습 방안을 논의할 예정인데 격론이 예상됩니다.';
let scriptTest52_5 = new Script_1.Script();
scriptTest52_5.startTime = new Time_1.Time(23, 88);
scriptTest52_5.endTime = new Time_1.Time(25, 31);
scriptTest52_5.text = '김민찬 기자입니다.';
// 53번 뉴스
let tagTest53_1 = new Tag_1.Tag();
tagTest53_1.name = '의학';
let tagTest53_2 = new Tag_1.Tag();
tagTest53_2.name = '암검사';
let tagTest53_3 = new Tag_1.Tag();
tagTest53_3.name = '액체생검';
let scriptTest53_1 = new Script_1.Script();
scriptTest53_1.startTime = new Time_1.Time(0, 0);
scriptTest53_1.endTime = new Time_1.Time(6, 50);
scriptTest53_1.text = '\'암 검사\' 하면 조직 일부를 떼어 검사하는 조직생검을 떠올리실 텐데요.';
let scriptTest53_2 = new Script_1.Script();
scriptTest53_2.startTime = new Time_1.Time(6, 50);
scriptTest53_2.endTime = new Time_1.Time(10, 27);
scriptTest53_2.text = '이제는 피 검사로도 암을 진단할 수 있다고 합니다.';
let scriptTest53_3 = new Script_1.Script();
scriptTest53_3.startTime = new Time_1.Time(10, 27);
scriptTest53_3.endTime = new Time_1.Time(16, 42);
scriptTest53_3.text = '\'액체생검\'이라고 하는데, 보다 빠르고 간편해서 차세대 진단법으로 주목받고 있습니다.';
let scriptTest53_4 = new Script_1.Script();
scriptTest53_4.startTime = new Time_1.Time(16, 42);
scriptTest53_4.endTime = new Time_1.Time(18, 86);
scriptTest53_4.text = '이충헌 의학 전문기자의 보돕니다.';
// 54번 뉴스
let tagTest54_1 = new Tag_1.Tag();
tagTest54_1.name = 'BA';
let tagTest54_2 = new Tag_1.Tag();
tagTest54_2.name = '변이';
let tagTest54_3 = new Tag_1.Tag();
tagTest54_3.name = '코로나19';
let scriptTest54_1 = new Script_1.Script();
scriptTest54_1.startTime = new Time_1.Time(0, 0);
scriptTest54_1.endTime = new Time_1.Time(1, 71);
scriptTest54_1.text = '여러분, 안녕하십니까.';
let scriptTest54_2 = new Script_1.Script();
scriptTest54_2.startTime = new Time_1.Time(1, 71);
scriptTest54_2.endTime = new Time_1.Time(11, 36);
scriptTest54_2.text = '코로나 환자 숫자가 일주일 전보다 2배씩 늘어나는 현상이 열흘 넘게 이어지고 있는데 걱정스러운 소식이 하나 더 있습니다.';
let scriptTest54_3 = new Script_1.Script();
scriptTest54_3.startTime = new Time_1.Time(11, 36);
scriptTest54_3.endTime = new Time_1.Time(19, 90);
scriptTest54_3.text = '코로나 변이 가운데 전파력이 가장 강하다고 알려진 새 변이에 감염된 사람이 우리나라에서도 처음 확인된 겁니다.';
let scriptTest54_4 = new Script_1.Script();
scriptTest54_4.startTime = new Time_1.Time(19, 90);
scriptTest54_4.endTime = new Time_1.Time(27, 25);
scriptTest54_4.text = '그 환자는 최근 외국에 다녀온 적도 없어서 변이가 이미 국내 다른 곳으로 퍼진 것 아니냐는 이야기도 나옵니다.';
let scriptTest54_5 = new Script_1.Script();
scriptTest54_5.startTime = new Time_1.Time(27, 25);
scriptTest54_5.endTime = new Time_1.Time(30, 97);
scriptTest54_5.text = '오늘 첫 소식 김덕현 기자가 전하겠습니다.';
// 55번 뉴스
let tagTest55_1 = new Tag_1.Tag();
tagTest55_1.name = '베이징올림픽';
let tagTest55_2 = new Tag_1.Tag();
tagTest55_2.name = '발리예바';
let tagTest55_3 = new Tag_1.Tag();
tagTest55_3.name = '도핑';
let scriptTest55_1 = new Script_1.Script();
scriptTest55_1.startTime = new Time_1.Time(0, 0);
scriptTest55_1.endTime = new Time_1.Time(3, 96);
scriptTest55_1.text = '전 세계의 주목을 받고 있는 피겨 스타죠.';
let scriptTest55_2 = new Script_1.Script();
scriptTest55_2.startTime = new Time_1.Time(3, 96);
scriptTest55_2.endTime = new Time_1.Time(9, 63);
scriptTest55_2.text = '러시아의 발리예바 선수가 금지 약물을 사용했다는 의혹이 사실로 드러났습니다.';
let scriptTest55_3 = new Script_1.Script();
scriptTest55_3.startTime = new Time_1.Time(9, 63);
scriptTest55_3.endTime = new Time_1.Time(14, 34);
scriptTest55_3.text = '올림픽위원회가 공식 발표와 함께 긴급 청문회를 요청했는데요.';
let scriptTest55_4 = new Script_1.Script();
scriptTest55_4.startTime = new Time_1.Time(14, 34);
scriptTest55_4.endTime = new Time_1.Time(22, 20);
scriptTest55_4.text = '결과에 따라서 단체전 금메달이 박탈되는 건 물론이고 여자 싱글 경기에도 나서지 못하게 될 수 있습니다.';
let scriptTest55_5 = new Script_1.Script();
scriptTest55_5.startTime = new Time_1.Time(22, 20);
scriptTest55_5.endTime = new Time_1.Time(25, 28);
scriptTest55_5.text = '손병산 기자가 취재했습니다.';
// 56번 뉴스
let tagTest56_1 = new Tag_1.Tag();
tagTest56_1.name = '스포츠';
let tagTest56_2 = new Tag_1.Tag();
tagTest56_2.name = '테니스';
let tagTest56_3 = new Tag_1.Tag();
tagTest56_3.name = '나달';
let scriptTest56_1 = new Script_1.Script();
scriptTest56_1.startTime = new Time_1.Time(0, 0);
scriptTest56_1.endTime = new Time_1.Time(7, 75);
scriptTest55_1.text = '여기저기 반창고를 붙인 손으로 힘을 실어 보낸 서브, 공을 바라보던 나달은 붉은 코트에 그대로 주저앉았습니다.';
let scriptTest56_2 = new Script_1.Script();
scriptTest56_2.startTime = new Time_1.Time(7, 75);
scriptTest56_2.endTime = new Time_1.Time(11, 7);
scriptTest56_2.text = '세계 1·2위의 대결은 이렇게 끝났습니다.';
let scriptTest56_3 = new Script_1.Script();
scriptTest56_3.startTime = new Time_1.Time(11, 7);
scriptTest56_3.endTime = new Time_1.Time(23, 15);
...
let scriptTest56_4 = new Script_1.Script();
scriptTest56_4.startTime = new Time_1.Time(23, 15);
scriptTest56_4.endTime = new Time_1.Time(24, 75);
scriptTest56_4.text = '최하은 기자입니다.';
// 57번 뉴스
let tagTest57_1 = new Tag_1.Tag();
tagTest57_1.name = '박지현';
let tagTest57_2 = new Tag_1.Tag();
tagTest57_2.name = '더불어민주당';
let tagTest57_3 = new Tag_1.Tag();
tagTest57_3.name = '당대표';
let scriptTest57_1 = new Script_1.Script();
scriptTest57_1.startTime = new Time_1.Time(0, 0);
scriptTest57_1.endTime = new Time_1.Time(8, 44);
scriptTest57_1.text = '박지현 더불어민주당 전 공동비상대책위원장이 8월 전당대회에서 당 대표에 출마하겠다고 공식 선언했습니다.';
let scriptTest57_2 = new Script_1.Script();
scriptTest57_2.startTime = new Time_1.Time(8, 44);
scriptTest57_2.endTime = new Time_1.Time(18, 93);
scriptTest57_2.text = '박 전 위원장은 어제 MBC 뉴스데스크에 출연해 민주당을 국민을 위한 정당, 청년의 목소리를 듣는 정당으로 만들고자 당 대표 출마를 결심했다고 밝혔습니다.';
let scriptTest57_3 = new Script_1.Script();
scriptTest57_3.startTime = new Time_1.Time(18, 93);
scriptTest57_3.endTime = new Time_1.Time(34, 78);
...
// 58번 뉴스
let tagTest58_1 = new Tag_1.Tag();
tagTest58_1.name = '코로나19';
let tagTest58_2 = new Tag_1.Tag();
tagTest58_2.name = '거리두기';
let tagTest58_3 = new Tag_1.Tag();
tagTest58_3.name = '대리운전기사';
let scriptTest58_1 = new Script_1.Script();
scriptTest58_1.startTime = new Time_1.Time(0, 0);
scriptTest58_1.endTime = new Time_1.Time(5, 52);
scriptTest58_1.text = '수도권 거리두기 4단계로 도심의 밤거리가 말 그대로 썰렁해졌습니다.';
let scriptTest58_2 = new Script_1.Script();
scriptTest58_2.startTime = new Time_1.Time(5, 52);
scriptTest58_2.endTime = new Time_1.Time(11, 60);
scriptTest58_2.text = '이 여파로 생계가 막막해진 사람들 중 하나가 대리 운전기사들인데요.';
let scriptTest58_3 = new Script_1.Script();
scriptTest58_3.startTime = new Time_1.Time(11, 60);
scriptTest58_3.endTime = new Time_1.Time(16, 37);
scriptTest58_3.text = '소상공인이 아니어서 손실 보상 논의에서도 빠져있다고 합니다.​';
let scriptTest58_4 = new Script_1.Script();
scriptTest58_4.startTime = new Time_1.Time(16, 37);
scriptTest58_4.endTime = new Time_1.Time(20, 77);
scriptTest58_4.text = '이들의 깊은 한숨, 신지수 기자가 들어봤습니다.';
// 59번 뉴스
let tagTest59_1 = new Tag_1.Tag();
tagTest59_1.name = '의학';
let tagTest59_2 = new Tag_1.Tag();
tagTest59_2.name = '의료사고';
let tagTest59_3 = new Tag_1.Tag();
tagTest59_3.name = '신생아';
let scriptTest59_1 = new Script_1.Script();
scriptTest59_1.startTime = new Time_1.Time(0, 0);
scriptTest59_1.endTime = new Time_1.Time(7, 0);
scriptTest59_1.text = '분당차병원에서 의료진이 갓 태어난 신생아를 수술실 바닥에 떨어뜨려 숨지게 한 사실이 3년 만에 드러났습니다.';
let scriptTest59_2 = new Script_1.Script();
scriptTest59_2.startTime = new Time_1.Time(7, 0);
scriptTest59_2.endTime = new Time_1.Time(15, 44);
scriptTest59_2.text = '병원에선 의료 기록을 은폐하고 단순 병사로 처리를 했는데 경찰이 당시 의사 2명에 대해서 구속영장을 신청했습니다.';
let scriptTest59_3 = new Script_1.Script();
scriptTest59_3.startTime = new Time_1.Time(15, 44);
scriptTest59_3.endTime = new Time_1.Time(22, 80);
scriptTest59_3.text = '병원 측은 공식 사과를 하면서도 아기를 떨어뜨린 게 직접적인 사망 원인은 아니라고 주장했습니다.​';
let scriptTest59_4 = new Script_1.Script();
scriptTest59_4.startTime = new Time_1.Time(22, 80);
scriptTest59_4.endTime = new Time_1.Time(24, 85);
scriptTest59_4.text = '이기주 기잡니다.';
// 60번 뉴스
let tagTest60_1 = new Tag_1.Tag();
tagTest60_1.name = '미국';
let tagTest60_2 = new Tag_1.Tag();
tagTest60_2.name = '낙태권';
let tagTest60_3 = new Tag_1.Tag();
tagTest60_3.name = '시위';
let scriptTest60_1 = new Script_1.Script();
scriptTest60_1.startTime = new Time_1.Time(0, 0);
scriptTest60_1.endTime = new Time_1.Time(4, 86);
scriptTest60_1.text = '미국 대법원이 낙태를 허용해 왔던 50년 전 판결을 폐기했습니다.';
let scriptTest60_2 = new Script_1.Script();
scriptTest60_2.startTime = new Time_1.Time(4, 86);
scriptTest60_2.endTime = new Time_1.Time(10, 93);
scriptTest60_2.text = '앞으로는 각 주별로 낙태를 허용할지 말지 판단이 달라지는데요.';
let scriptTest60_3 = new Script_1.Script();
scriptTest60_3.startTime = new Time_1.Time(10, 93);
scriptTest60_3.endTime = new Time_1.Time(17, 57);
scriptTest60_3.text = '진보와 보수 진영이 첨예하게 대립하는 사안인 만큼 오늘 미 전역에서는 대규모 시위가 열렸습니다.​';
let scriptTest60_4 = new Script_1.Script();
scriptTest60_4.startTime = new Time_1.Time(17, 57);
scriptTest60_4.endTime = new Time_1.Time(20, 42);
scriptTest60_4.text = '뉴욕에서 김종원 특파원입니다.';
// 61번 뉴스
let tagTest61_1 = new Tag_1.Tag();
tagTest61_1.name = '미국';
let tagTest61_2 = new Tag_1.Tag();
tagTest61_2.name = '물가';
let tagTest61_3 = new Tag_1.Tag();
tagTest61_3.name = '코로나';
let scriptTest61_1 = new Script_1.Script();
scriptTest61_1.startTime = new Time_1.Time(0, 0);
scriptTest61_1.endTime = new Time_1.Time(1, 36);
scriptTest61_1.text = '다음 소식입니다.';
let scriptTest61_2 = new Script_1.Script();
scriptTest61_2.startTime = new Time_1.Time(1, 36);
scriptTest61_2.endTime = new Time_1.Time(7, 91);
scriptTest61_2.text = '일상을 회복해 가고 있는 미국은 최근 물가가 13년 만에 최고치를 기록했습니다.';
let scriptTest61_3 = new Script_1.Script();
scriptTest61_3.startTime = new Time_1.Time(7, 91);
scriptTest61_3.endTime = new Time_1.Time(18, 46);
scriptTest61_3.text = '코로나 극복을 위해 시중에 천문학적인 돈을 풀어온 미국 정부가 이제는 돈줄을 조일 준비를 하고 있는데 우리 경제에도 영향을 미칠 것으로 보입니다.​';
let scriptTest61_4 = new Script_1.Script();
scriptTest61_4.startTime = new Time_1.Time(18, 46);
scriptTest61_4.endTime = new Time_1.Time(21, 32);
scriptTest61_4.text = '뉴욕에서 김종원 특파원입니다.';
// 62번 뉴스
let tagTest62_1 = new Tag_1.Tag();
tagTest62_1.name = 'BTS';
let tagTest62_2 = new Tag_1.Tag();
tagTest62_2.name = '아미';
let tagTest62_3 = new Tag_1.Tag();
tagTest62_3.name = '새로운문화';
let scriptTest62_1 = new Script_1.Script();
scriptTest62_1.startTime = new Time_1.Time(0, 0);
scriptTest62_1.endTime = new Time_1.Time(3, 79);
scriptTest62_1.text = '그룹 방탄소년단과 팬클럽 아미.';
let scriptTest62_2 = new Script_1.Script();
scriptTest62_2.startTime = new Time_1.Time(3, 79);
scriptTest62_2.endTime = new Time_1.Time(9, 67);
scriptTest62_2.text = '새로운 문화 생태계를 만들어온 이들을 연구하는 전 세계 학자들이 한국에 모였습니다.';
let scriptTest62_3 = new Script_1.Script();
scriptTest62_3.startTime = new Time_1.Time(9, 67);
scriptTest62_3.endTime = new Time_1.Time(19, 3);
scriptTest62_3.text = '방탄소년단의 성공 못지않게 세계 각지에서 더 나은 세상을 위해서 분투하는 아미들의 활약에 많은 관심이 쏠리고 있습니다.​';
let scriptTest62_4 = new Script_1.Script();
scriptTest62_4.startTime = new Time_1.Time(19, 3);
scriptTest62_4.endTime = new Time_1.Time(22, 8);
scriptTest62_4.text = '김석 기자가 취재했습니다.';
// 63번 뉴스
let tagTest63_1 = new Tag_1.Tag();
tagTest63_1.name = '코로나19';
let tagTest63_2 = new Tag_1.Tag();
tagTest63_2.name = '4차접종';
let tagTest63_3 = new Tag_1.Tag();
tagTest63_3.name = '거리두기';
let scriptTest63_1 = new Script_1.Script();
scriptTest63_1.startTime = new Time_1.Time(0, 0);
scriptTest63_1.endTime = new Time_1.Time(6, 71);
scriptTest63_1.text = '코로나 유행이 확산세로 돌아선 가운데 신규 확진자는 두 달여 만에 4만 명대로 급증했습니다.';
let scriptTest63_2 = new Script_1.Script();
scriptTest63_2.startTime = new Time_1.Time(6, 71);
scriptTest63_2.endTime = new Time_1.Time(16, 17);
scriptTest63_2.text = '재유행이 시작됐다고 판단한 정부는 4차 접종 대상에 50대를 포함하는 것을 주요 내용으로 하는 대응 방안을 발표했는데요.';
let scriptTest63_3 = new Script_1.Script();
scriptTest63_3.startTime = new Time_1.Time(16, 17);
scriptTest63_3.endTime = new Time_1.Time(19, 28);
scriptTest63_3.text = '이번에 거리두기 조치는 없었습니다.';
let scriptTest63_4 = new Script_1.Script();
scriptTest63_4.startTime = new Time_1.Time(19, 30);
scriptTest63_4.endTime = new Time_1.Time(22, 29);
scriptTest63_4.text = '원동희 기자가 보도합니다.';
// 64번 뉴스
let tagTest64_1 = new Tag_1.Tag();
tagTest64_1.name = '포괄임금제';
let tagTest64_2 = new Tag_1.Tag();
tagTest64_2.name = '연장수당';
let tagTest64_3 = new Tag_1.Tag();
tagTest64_3.name = '야근수당';
let scriptTest64_1 = new Script_1.Script();
scriptTest64_1.startTime = new Time_1.Time(0, 0);
scriptTest64_1.endTime = new Time_1.Time(7, 18);
scriptTest64_1.text = '많이 달라졌다고는 하지만 한국은 여전히 OECD 국가들 가운데 가장 과로하는 나라입니다.';
let scriptTest64_2 = new Script_1.Script();
scriptTest64_2.startTime = new Time_1.Time(7, 18);
scriptTest64_2.endTime = new Time_1.Time(11, 67);
scriptTest64_2.text = '멕시코, 코스타리카에 이어서 노동시간이 세 번째로 긴데요.';
let scriptTest64_3 = new Script_1.Script();
scriptTest64_3.startTime = new Time_1.Time(11, 67);
scriptTest64_3.endTime = new Time_1.Time(15, 14);
scriptTest64_3.text = '이 장시간 노동의 주범으로 지목되는 제도가 있습니다​.';
let scriptTest64_4 = new Script_1.Script();
scriptTest64_4.startTime = new Time_1.Time(15, 14);
scriptTest64_4.endTime = new Time_1.Time(17, 33);
scriptTest64_4.text = '바로 포괄임금제.';
let scriptTest64_5 = new Script_1.Script();
scriptTest64_5.startTime = new Time_1.Time(17, 33);
scriptTest64_5.endTime = new Time_1.Time(21, 76);
scriptTest64_5.text = '실제로 얼마를 일 하든 미리 정해놓은 수당만 지급하는 제도죠.';
let scriptTest64_6 = new Script_1.Script();
scriptTest64_6.startTime = new Time_1.Time(21, 76);
scriptTest64_6.endTime = new Time_1.Time(27, 78);
scriptTest64_6.text = '우리나라 대기업 10곳 중의 6곳이 사무직들에게 포괄임금제를 적용하고 있습니다.';
let scriptTest64_7 = new Script_1.Script();
scriptTest64_7.startTime = new Time_1.Time(27, 78);
scriptTest64_7.endTime = new Time_1.Time(29, 83);
scriptTest64_7.text = '이대로 놔둬도 되는 걸까.​';
let scriptTest64_8 = new Script_1.Script();
scriptTest64_8.startTime = new Time_1.Time(29, 83);
scriptTest64_8.endTime = new Time_1.Time(34, 67);
scriptTest64_8.text = '뉴스데스크는 오늘과 내일 이 문제를 집중적으로 다뤄보겠습니다.';
let scriptTest64_9 = new Script_1.Script();
scriptTest64_9.startTime = new Time_1.Time(34, 67);
scriptTest64_9.endTime = new Time_1.Time(37, 47);
scriptTest64_9.text = '차주혁 기자가 전해드리겠습니다.';
// 65번 뉴스
let tagTest65_1 = new Tag_1.Tag();
tagTest65_1.name = '물가';
let tagTest65_2 = new Tag_1.Tag();
tagTest65_2.name = '식자재';
let tagTest65_3 = new Tag_1.Tag();
tagTest65_3.name = '자영업자';
let scriptTest65_1 = new Script_1.Script();
scriptTest65_1.startTime = new Time_1.Time(0, 0);
scriptTest65_1.endTime = new Time_1.Time(7, 37);
scriptTest65_1.text = '요즘 물가 상승으로 식자재 가격이 크게 오르면서 식당을 운영하는 자영업자들의 고민도 깊어지고 있습니다.';
let scriptTest65_2 = new Script_1.Script();
scriptTest65_2.startTime = new Time_1.Time(7, 37);
scriptTest65_2.endTime = new Time_1.Time(14, 94);
scriptTest65_2.text = '음식 가격을 올리자니 손님이 줄어들 것 같고 그렇다고 가격을 그대로 두면 원가를 맞출 수가 없기 때문인데요.';
let scriptTest65_3 = new Script_1.Script();
scriptTest65_3.startTime = new Time_1.Time(14, 94);
scriptTest65_3.endTime = new Time_1.Time(19, 86);
scriptTest65_3.text = '그래서 반찬의 가짓수나 양을 줄이는 등 고육지책을 마련하고 있습니다.​';
let scriptTest65_4 = new Script_1.Script();
scriptTest65_4.startTime = new Time_1.Time(19, 86);
scriptTest65_4.endTime = new Time_1.Time(22, 58);
scriptTest65_4.text = '오상현 기자가 현장에 다녀왔습니다.';
// 66번 뉴스
let tagTest66_1 = new Tag_1.Tag();
tagTest66_1.name = '베이징올림픽';
let tagTest66_2 = new Tag_1.Tag();
tagTest66_2.name = '홈어드밴티지';
let tagTest66_3 = new Tag_1.Tag();
tagTest66_3.name = '중국';
let scriptTest66_1 = new Script_1.Script();
scriptTest66_1.startTime = new Time_1.Time(0, 0);
scriptTest66_1.endTime = new Time_1.Time(8, 9);
scriptTest66_1.text = '올림픽에서 개최국 선수들은 경기장 적응하는 데 아무래도 더 유리하고, 또 홈팬들의 뜨거운 응원도 받을 수 있습니다.';
let scriptTest66_2 = new Script_1.Script();
scriptTest66_2.startTime = new Time_1.Time(8, 9);
scriptTest66_2.endTime = new Time_1.Time(13, 71);
scriptTest66_2.text = '그런데 이번 대회는 그것 말고도 개최국의 이점이 더 있는 것 같습니다.';
let scriptTest66_3 = new Script_1.Script();
scriptTest66_3.startTime = new Time_1.Time(13, 71);
scriptTest66_3.endTime = new Time_1.Time(23, 12);
scriptTest66_3.text = '앞서 보신 대로 쇼트트랙에서 우리를 비롯해 다른 나라들에게는 심판이 엄격한 잣대를 적용하고 있지만 중국 선수들에게는 그렇지 않았습니다.​';
let scriptTest66_4 = new Script_1.Script();
scriptTest66_4.startTime = new Time_1.Time(23, 12);
scriptTest66_4.endTime = new Time_1.Time(26, 8);
scriptTest66_4.text = '이 내용은 김형열 기자가 정리했습니다.';
// 67번 뉴스
let tagTest67_1 = new Tag_1.Tag();
tagTest67_1.name = '트럼프';
let tagTest67_2 = new Tag_1.Tag();
tagTest67_2.name = '시위';
let tagTest67_3 = new Tag_1.Tag();
tagTest67_3.name = '노마스크';
let scriptTest67_1 = new Script_1.Script();
scriptTest67_1.startTime = new Time_1.Time(0, 0);
scriptTest67_1.endTime = new Time_1.Time(5, 25);
scriptTest67_1.text = '미국에서는 또 하루 사이 확진자가 무려 십칠만 명 넘게 나왔는데요.';
let scriptTest67_2 = new Script_1.Script();
scriptTest67_2.startTime = new Time_1.Time(5, 25);
scriptTest67_2.endTime = new Time_1.Time(12, 33);
scriptTest67_2.text = '이런 상황에서 트럼프 지지자들이 수도 워싱턴 DC에 모여 대규모 대선 불복 집회를 열었습니다.';
let scriptTest67_3 = new Script_1.Script();
scriptTest67_3.startTime = new Time_1.Time(12, 33);
scriptTest67_3.endTime = new Time_1.Time(17, 57);
scriptTest67_3.text = '​그런데 마스크 쓰지 않은 사람이 너무 많아서 마스크 찾아보기가 어려울 정도였다고 합니다.';
let scriptTest67_4 = new Script_1.Script();
scriptTest67_4.startTime = new Time_1.Time(17, 57);
scriptTest67_4.endTime = new Time_1.Time(20, 32);
scriptTest67_4.text = '워싱턴에서 임종주 특파원이 보도합니다.';
// 68번 뉴스
let tagTest68_1 = new Tag_1.Tag();
tagTest68_1.name = '일본';
let tagTest68_2 = new Tag_1.Tag();
tagTest68_2.name = '한일관계';
let tagTest68_3 = new Tag_1.Tag();
tagTest68_3.name = '한류';
let scriptTest68_1 = new Script_1.Script();
scriptTest68_1.startTime = new Time_1.Time(0, 0);
scriptTest68_1.endTime = new Time_1.Time(5, 73);
scriptTest68_1.text = '워싱턴에서 임종주 특파원이 보도합니다.';
let scriptTest68_2 = new Script_1.Script();
scriptTest68_2.startTime = new Time_1.Time(5, 73);
scriptTest68_2.endTime = new Time_1.Time(16, 39);
scriptTest68_2.text = '우리나라 동네 슈퍼마켓을 그대로 옮긴 듯한 가게가 도쿄 도심도 아닌 지방의 한 주택가에 생길 정도인데요, 소문을 듣고 찾아가기까지 한다고 합니다.';
let scriptTest68_3 = new Script_1.Script();
scriptTest68_3.startTime = new Time_1.Time(16, 39);
scriptTest68_3.endTime = new Time_1.Time(19, 24);
scriptTest68_3.text = '도쿄에서 유성재 특파원입니다.';
// 69번 뉴스
let tagTest69_1 = new Tag_1.Tag();
tagTest69_1.name = '미국대선';
let tagTest69_2 = new Tag_1.Tag();
tagTest69_2.name = '바이든';
let tagTest69_3 = new Tag_1.Tag();
tagTest69_3.name = '트럼프';
let scriptTest69_1 = new Script_1.Script();
scriptTest69_1.startTime = new Time_1.Time(0, 0);
scriptTest69_1.endTime = new Time_1.Time(1, 75);
scriptTest69_1.text = '여러분, 안녕하십니까?';
let scriptTest69_2 = new Script_1.Script();
scriptTest69_2.startTime = new Time_1.Time(1, 75);
scriptTest69_2.endTime = new Time_1.Time(11, 6);
scriptTest69_2.text = '미국 대통령 선거, 아직도 개표가 끝나지 않은 가운데 민주당 바이든 후보가 백악관을 향해서 한 발짝 더 다가섰습니다.';
let scriptTest69_3 = new Script_1.Script();
scriptTest69_3.startTime = new Time_1.Time(11, 6);
scriptTest69_3.endTime = new Time_1.Time(18, 1);
scriptTest69_3.text = '트럼프 대통령에게 뒤지고 있던 경합 지역에서 역전하거나 또 격차를 계속 좁혀가고 있습니다.​';
let scriptTest69_4 = new Script_1.Script();
scriptTest69_4.startTime = new Time_1.Time(18, 1);
scriptTest69_4.endTime = new Time_1.Time(29, 43);
scriptTest69_4.text = '지금 가장 치열한 지역이 펜실베이니아와 조지아 두 곳인데 약 1시간 반 전에 이 조지아에서 바이든 후보가 트럼프를 앞서가기 시작했습니다.';
let scriptTest69_5 = new Script_1.Script();
scriptTest69_5.startTime = new Time_1.Time(29, 43);
scriptTest69_5.endTime = new Time_1.Time(36, 45);
scriptTest69_5.text = '트럼프 대통령은 개표 과정에 문제가 있다며 소송을 냈었는데 그게 법원에서 잇따라 기각됐습니다.';
let scriptTest69_6 = new Script_1.Script();
scriptTest69_6.startTime = new Time_1.Time(36, 45);
scriptTest69_6.endTime = new Time_1.Time(39, 13);
scriptTest69_6.text = '오늘 첫 소식 먼저 정준영 기자입니다.';
// 70번 뉴스
let tagTest70_1 = new Tag_1.Tag();
tagTest70_1.name = '일본';
let tagTest70_2 = new Tag_1.Tag();
tagTest70_2.name = '신사참배';
let tagTest70_3 = new Tag_1.Tag();
tagTest70_3.name = '전쟁';
let scriptTest70_1 = new Script_1.Script();
scriptTest70_1.startTime = new Time_1.Time(0, 0);
scriptTest70_1.endTime = new Time_1.Time(7, 94);
scriptTest70_1.text = '일본 국회의원들이 태평양전쟁 A급 전범이 합사된 야스쿠니 신사를 2년 2개월 만에 집단 참배했습니다.';
let scriptTest70_2 = new Script_1.Script();
scriptTest70_2.startTime = new Time_1.Time(7, 94);
scriptTest70_2.endTime = new Time_1.Time(20, 23);
...
let scriptTest70_3 = new Script_1.Script();
scriptTest70_3.startTime = new Time_1.Time(20, 23);
scriptTest70_3.endTime = new Time_1.Time(26, 73);
scriptTest70_3.text = '이 모임의 야스쿠니 신사 참배는 2019년 10월 18일 이후 약 2년 2개월 만입니다.';
let scriptTest70_4 = new Script_1.Script();
scriptTest70_4.startTime = new Time_1.Time(26, 73);
scriptTest70_4.endTime = new Time_1.Time(34, 99);
scriptTest70_4.text = '정부 측 인사로는 호소다 겐이치로 경제산업성 부대신과 무타이 슌스케 환경성 부대신 등이 포함됐습니다.';
// 71번 뉴스
let tagTest71_1 = new Tag_1.Tag();
tagTest71_1.name = '의료사고';
let tagTest71_2 = new Tag_1.Tag();
tagTest71_2.name = '사망사고';
let tagTest71_3 = new Tag_1.Tag();
tagTest71_3.name = '국민청원';
let scriptTest71_1 = new Script_1.Script();
scriptTest71_1.startTime = new Time_1.Time(0, 0);
scriptTest71_1.endTime = new Time_1.Time(7, 42);
scriptTest71_1.text = '저희 KBS는 지난해 편도 제거 수술을 받고 숨진 5살 김동이 군 사건을 심층 보도한 바 있는데요.';
let scriptTest71_2 = new Script_1.Script();
scriptTest71_2.startTime = new Time_1.Time(7, 42);
scriptTest71_2.endTime = new Time_1.Time(12, 58);
scriptTest71_2.text = '다시 수술을 집도 했던 의사는 업무상 과실치사 혐의로 경찰 조사를 받고 있습니다.';
let scriptTest71_3 = new Script_1.Script();
scriptTest71_3.startTime = new Time_1.Time(12, 58);
scriptTest71_3.endTime = new Time_1.Time(19, 84);
scriptTest71_3.text = '그런데 한 30대 여성이 이 의사로부터 똑같은 수술을 받은 뒤 심각한 후유증을 앓게 된 사실이 또 드러났습니다.';
let scriptTest71_4 = new Script_1.Script();
scriptTest71_4.startTime = new Time_1.Time(19, 84);
scriptTest71_4.endTime = new Time_1.Time(22, 23);
scriptTest71_4.text = '이영광 기자의 보도입니다.';
// 72번 뉴스
let tagTest72_1 = new Tag_1.Tag();
tagTest72_1.name = '수술실CCTV';
let tagTest72_2 = new Tag_1.Tag();
tagTest72_2.name = '의료사고';
let tagTest72_3 = new Tag_1.Tag();
tagTest72_3.name = '의료법';
let scriptTest72_1 = new Script_1.Script();
scriptTest72_1.startTime = new Time_1.Time(0, 0);
scriptTest72_1.endTime = new Time_1.Time(2, 4);
scriptTest72_1.text = '다음 소식 전해드리겠습니다.';
let scriptTest72_2 = new Script_1.Script();
scriptTest72_2.startTime = new Time_1.Time(2, 4);
scriptTest72_2.endTime = new Time_1.Time(13, 5);
scriptTest72_2.text = '12년 무사고라고 홍보를 해왔던 서울 강남의 한 유명 성형외과에서 안면 윤곽 수술을 받던 20대 대학생이 숨진 사고를 전해드린 바 있는데요.';
let scriptTest72_3 = new Script_1.Script();
scriptTest72_3.startTime = new Time_1.Time(13, 5);
scriptTest72_3.endTime = new Time_1.Time(24, 34);
scriptTest72_3.text = '사건이 발생한 지 1년이 지난 최근에서야 유족들이 당시 수술실 안에서 무슨 일이 있었는지 담겨 있는 3시간 분량의 CCTV 영상을 확보할 수 있었습니다.​';
let scriptTest72_4 = new Script_1.Script();
scriptTest72_4.startTime = new Time_1.Time(24, 34);
scriptTest72_4.endTime = new Time_1.Time(29, 4);
scriptTest72_4.text = '영상을 보니까 한 수술실 안에 수술대가 두 개가 있었고요.';
let scriptTest72_5 = new Script_1.Script();
scriptTest72_5.startTime = new Time_1.Time(29, 4);
scriptTest72_5.endTime = new Time_1.Time(34, 38);
scriptTest72_5.text = '마취과 의사 한 명이 환자 두 명을 동시에 담당해서 수술이 이루어지고 있었습니다.';
let scriptTest72_6 = new Script_1.Script();
scriptTest72_6.startTime = new Time_1.Time(34, 38);
scriptTest72_6.endTime = new Time_1.Time(38, 26);
scriptTest72_6.text = '먼저 신재웅 기자의 단독보도 보시겠습니다.';
// 73번 뉴스
let tagTest73_1 = new Tag_1.Tag();
tagTest73_1.name = '백내장';
let tagTest73_2 = new Tag_1.Tag();
tagTest73_2.name = '부작용';
let tagTest73_3 = new Tag_1.Tag();
tagTest73_3.name = '브로커';
let scriptTest73_1 = new Script_1.Script();
scriptTest73_1.startTime = new Time_1.Time(0, 0);
scriptTest73_1.endTime = new Time_1.Time(10, 56);
scriptTest73_1.text = '일부 병원들이 브로커를 통해서 백내장 환자를 소개 받고 또 꼭 하지 않아도 될 수술을 해서 피해가 끊이질 않고 있습니다.';
let scriptTest73_2 = new Script_1.Script();
scriptTest73_2.startTime = new Time_1.Time(10, 56);
scriptTest73_2.endTime = new Time_1.Time(17, 83);
scriptTest73_2.text = '수술 받은 이후에 부작용을 겪는 사람이 적지 않고 보상 받는 것도 쉽지 않아서 주의가 필요합니다.';
let scriptTest73_3 = new Script_1.Script();
scriptTest73_3.startTime = new Time_1.Time(17, 83);
scriptTest73_3.endTime = new Time_1.Time(20, 18);
scriptTest73_3.text = '한성희 기자가 취재했습니다.';
// 74번 뉴스
let tagTest74_1 = new Tag_1.Tag();
tagTest74_1.name = '2030';
let tagTest74_2 = new Tag_1.Tag();
tagTest74_2.name = '주식';
let tagTest74_3 = new Tag_1.Tag();
tagTest74_3.name = '영끌';
let scriptTest74_1 = new Script_1.Script();
scriptTest74_1.startTime = new Time_1.Time(0, 0);
scriptTest74_1.endTime = new Time_1.Time(1, 43);
scriptTest74_1.text = '네, 다음 소식입니다.';
let scriptTest74_2 = new Script_1.Script();
scriptTest74_2.startTime = new Time_1.Time(1, 43);
scriptTest74_2.endTime = new Time_1.Time(5, 44);
scriptTest74_2.text = '고물가, 고환율, 그리고 고금리의 3고의 시대.';
let scriptTest74_3 = new Script_1.Script();
scriptTest74_3.startTime = new Time_1.Time(5, 44);
scriptTest74_3.endTime = new Time_1.Time(12, 37);
scriptTest74_3.text = '대출 이자는 끊임없이 오르는데 주식이나 코인 시세는 반대로 곤두박질치면서 투자가 쉽지 않은 시기인데요.​';
let scriptTest74_4 = new Script_1.Script();
scriptTest74_4.startTime = new Time_1.Time(12, 37);
scriptTest74_4.endTime = new Time_1.Time(19, 71);
scriptTest74_4.text = '그동안 주식이나 가상화폐 투자를 당연시해왔던 2030세대의 경제 사정은 특히 심상치 않습니다.';
let scriptTest74_5 = new Script_1.Script();
scriptTest74_5.startTime = new Time_1.Time(19, 71);
scriptTest74_5.endTime = new Time_1.Time(28, 47);
scriptTest74_5.text = '영혼까지 끌어모아 대출받고 빚내서 투자했다가 큰 손실을 보는 사례도 속출하고 있어서 사회적 파장이 만만치 않을 것으로 우려됩니다.';
let scriptTest74_6 = new Script_1.Script();
scriptTest74_6.startTime = new Time_1.Time(28, 47);
scriptTest74_6.endTime = new Time_1.Time(30, 43);
scriptTest74_6.text = '강민경 기자입니다.';
// 75번 뉴스
let tagTest75_1 = new Tag_1.Tag();
tagTest75_1.name = '2030';
let tagTest75_2 = new Tag_1.Tag();
tagTest75_2.name = '코인';
let tagTest75_3 = new Tag_1.Tag();
tagTest75_3.name = '희망절벽세대';
let scriptTest75_1 = new Script_1.Script();
scriptTest75_1.startTime = new Time_1.Time(0, 0);
scriptTest75_1.endTime = new Time_1.Time(7, 2);
scriptTest75_1.text = '국내 거래소에 상장된 코인 등 가상화폐 시가총액이 열흘 새 40% 넘게 빠졌습니다.';
let scriptTest75_2 = new Script_1.Script();
scriptTest75_2.startTime = new Time_1.Time(7, 2);
scriptTest75_2.endTime = new Time_1.Time(14, 30);
scriptTest75_2.text = 'KB·하나·우리은행은 너무 위험하기 때문에, 가상화폐 거래소와는 계약하지 않는 쪽으로 가닥을 잡았습니다.';
let scriptTest75_3 = new Script_1.Script();
scriptTest75_3.startTime = new Time_1.Time(14, 30);
scriptTest75_3.endTime = new Time_1.Time(19, 22);
scriptTest75_3.text = '그럼에도 "코인 같은 고위험 투자를 안 할 수 없다"는 2030이 많은데요.​';
let scriptTest75_4 = new Script_1.Script();
scriptTest75_4.startTime = new Time_1.Time(19, 22);
scriptTest75_4.endTime = new Time_1.Time(25, 45);
scriptTest75_4.text = '저희가 만난 한 청년은 우리는 희망절벽 세대라 더 이런 투자에 매달리게 된다고 했습니다.';
let scriptTest75_5 = new Script_1.Script();
scriptTest75_5.startTime = new Time_1.Time(25, 45);
scriptTest75_5.endTime = new Time_1.Time(27, 9);
scriptTest75_5.text = '정종문 기자입니다.';
// 76번 뉴스
let tagTest76_1 = new Tag_1.Tag();
tagTest76_1.name = '퀴어문화축제';
let tagTest76_2 = new Tag_1.Tag();
tagTest76_2.name = '서울시';
let tagTest76_3 = new Tag_1.Tag();
tagTest76_3.name = '차별';
let scriptTest76_1 = new Script_1.Script();
scriptTest76_1.startTime = new Time_1.Time(0, 0);
scriptTest76_1.endTime = new Time_1.Time(6, 77);
scriptTest76_1.text = '성 소수자의 인권을 알리는 퀴어축제가 온라인을 벗어나 서울광장에서 대면으로 열립니다.';
let scriptTest76_2 = new Script_1.Script();
scriptTest76_2.startTime = new Time_1.Time(6, 77);
scriptTest76_2.endTime = new Time_1.Time(8, 13);
scriptTest76_2.text = '3년 만입니다.';
let scriptTest76_3 = new Script_1.Script();
scriptTest76_3.startTime = new Time_1.Time(8, 13);
scriptTest76_3.endTime = new Time_1.Time(10, 28);
scriptTest76_3.text = '하지만 과정이 순탄치 않습니다.​';
let scriptTest76_4 = new Script_1.Script();
scriptTest76_4.startTime = new Time_1.Time(10, 28);
scriptTest76_4.endTime = new Time_1.Time(17, 5);
scriptTest76_4.text = '주최 측은 엿새 동안 열겠다고 신청을 했는데, 서울시는 단 하루만 허용을 했습니다.';
let scriptTest76_5 = new Script_1.Script();
scriptTest76_5.startTime = new Time_1.Time(17, 5);
scriptTest76_5.endTime = new Time_1.Time(19, 37);
scriptTest76_5.text = '차별이라는 비판이 나오고 있습니다.';
let scriptTest76_6 = new Script_1.Script();
scriptTest76_6.startTime = new Time_1.Time(19, 37);
scriptTest76_6.endTime = new Time_1.Time(20, 72);
scriptTest76_6.text = '박현주 기자입니다.';
// 77번 뉴스
let tagTest77_1 = new Tag_1.Tag();
tagTest77_1.name = 'BTS';
let tagTest77_2 = new Tag_1.Tag();
tagTest77_2.name = '그래미';
let tagTest77_3 = new Tag_1.Tag();
tagTest77_3.name = '병역';
let scriptTest77_1 = new Script_1.Script();
scriptTest77_1.startTime = new Time_1.Time(0, 0);
scriptTest77_1.endTime = new Time_1.Time(8, 69);
scriptTest77_1.text = '그룹 방탄소년단, BTS의 미국 라스베이거스 공연이 이어지면서 오는 주말까지 팬 수십만 명이 몰려들 것으로 보입니다.';
let scriptTest77_2 = new Script_1.Script();
scriptTest77_2.startTime = new Time_1.Time(8, 69);
scriptTest77_2.endTime = new Time_1.Time(13, 44);
scriptTest77_2.text = 'BTS와 소속사 하이브가 현지에서 모처럼 만에 기자회견을 열었는데요.';
let scriptTest77_3 = new Script_1.Script();
scriptTest77_3.startTime = new Time_1.Time(13, 44);
scriptTest77_3.endTime = new Time_1.Time(17, 62);
scriptTest77_3.text = '그래미 시상식과 병역 문제와 관련한 입장을 언급했습니다.​';
let scriptTest77_4 = new Script_1.Script();
scriptTest77_4.startTime = new Time_1.Time(17, 62);
scriptTest77_4.endTime = new Time_1.Time(20, 0);
scriptTest77_4.text = '박기완 기자입니다.';
// 78번 뉴스
let tagTest78_1 = new Tag_1.Tag();
tagTest78_1.name = '기생충';
let tagTest78_2 = new Tag_1.Tag();
tagTest78_2.name = '아카데미';
let tagTest78_3 = new Tag_1.Tag();
tagTest78_3.name = '송강호';
let scriptTest78_1 = new Script_1.Script();
scriptTest78_1.startTime = new Time_1.Time(0, 0);
scriptTest78_1.endTime = new Time_1.Time(3, 28);
scriptTest78_1.text = '정말 반가운 얼굴들입니다.';
let scriptTest78_2 = new Script_1.Script();
scriptTest78_2.startTime = new Time_1.Time(3, 28);
scriptTest78_2.endTime = new Time_1.Time(10, 38);
scriptTest78_2.text = '92년 역사의 아카데미를 흔들었던 영화 \'기생충\'의 사람들이 오늘 돌아왔습니다.';
let scriptTest78_3 = new Script_1.Script();
scriptTest78_3.startTime = new Time_1.Time(10, 38);
scriptTest78_3.endTime = new Time_1.Time(17, 37);
scriptTest78_3.text = '오늘부터 일상으로 복귀하지만 우리에게 가슴 벅찬 순간을 선물했던 아카데미의 시간은 여전히 진행 중입니다.​';
let scriptTest78_4 = new Script_1.Script();
scriptTest78_4.startTime = new Time_1.Time(17, 37);
scriptTest78_4.endTime = new Time_1.Time(23, 15);
scriptTest78_4.text = '봉준호 감독과 기생충을 향한 신드롬은 신조어로, 그리고 패러디로 표출되고 있습니다.';
let scriptTest78_5 = new Script_1.Script();
scriptTest78_5.startTime = new Time_1.Time(23, 15);
scriptTest78_5.endTime = new Time_1.Time(27, 29);
scriptTest78_5.text = '먼저 문상혁 기자가 오늘 새벽 귀국현장을 다녀왔습니다.';
// 79번 뉴스
let tagTest79_1 = new Tag_1.Tag();
tagTest79_1.name = '미국';
let tagTest79_2 = new Tag_1.Tag();
tagTest79_2.name = '경기침체';
let tagTest79_3 = new Tag_1.Tag();
tagTest79_3.name = '경제전망';
let scriptTest79_1 = new Script_1.Script();
scriptTest79_1.startTime = new Time_1.Time(0, 0);
scriptTest79_1.endTime = new Time_1.Time(9, 72);
scriptTest79_1.text = '전 세계적으로 경기침체 우려가 제기되고 있지만, 미국의 성장이 강력하고 경기침체에 빠질 어떤 이유도 없다고 미국 고위 관리가 밝혔습니다.';
let scriptTest79_2 = new Script_1.Script();
scriptTest79_2.startTime = new Time_1.Time(9, 72);
scriptTest79_2.endTime = new Time_1.Time(17, 38);
scriptTest79_2.text = '지나 러몬도 미 상무장관은 현지 시각 10일 ABC 방송에 출연해, 자신은 경기침체를 피할 수 있다고 본다면서,';
let scriptTest79_3 = new Script_1.Script();
scriptTest79_3.startTime = new Time_1.Time(17, 38);
scriptTest79_3.endTime = new Time_1.Time(27, 33);
scriptTest79_3.text = '지난 1년 반 동안 미국 경제는 5∼6%라는 전례 없이 높은 수준으로 성장해왔다고 말했습니다.​';
// 80번 뉴스
let tagTest80_1 = new Tag_1.Tag();
tagTest80_1.name = '민주당';
let tagTest80_2 = new Tag_1.Tag();
tagTest80_2.name = '철야농성';
let tagTest80_3 = new Tag_1.Tag();
tagTest80_3.name = '예산결산위원회';
let scriptTest80_1 = new Script_1.Script();
scriptTest80_1.startTime = new Time_1.Time(0, 0);
scriptTest80_1.endTime = new Time_1.Time(7, 66);
scriptTest80_1.text = '더불어민주당이 17조 원 규모의 추가경정예산안 처리를 촉구하며 철야농성에 들어갔습니다.';
let scriptTest80_2 = new Script_1.Script();
scriptTest80_2.startTime = new Time_1.Time(7, 66);
scriptTest80_2.endTime = new Time_1.Time(15, 51);
scriptTest80_2.text = '앞서 민주당이 단독 처리하겠다며 야당을 압박하면서 국회 예산결산위원회 전체 회의가 열리기도 했습니다.';
let scriptTest80_3 = new Script_1.Script();
scriptTest80_3.startTime = new Time_1.Time(15, 51);
scriptTest80_3.endTime = new Time_1.Time(25, 42);
scriptTest80_3.text = '하지만, 국민의힘은 "방역지원금 규모 등에 이견이 크다"며 반발했고, 결국 국민의힘 소속 이종배 예결위원장이 회의를 중단시켰습니다.​';
let scriptTest80_4 = new Script_1.Script();
scriptTest80_4.startTime = new Time_1.Time(25, 42);
scriptTest80_4.endTime = new Time_1.Time(32, 22);
scriptTest80_4.text = '민주당은 전체 회의를 다시 열 것을 요구하며 예결위 회의장에서 농성을 벌이고 있습니다.';
// 81번 뉴스
let tagTest81_1 = new Tag_1.Tag();
tagTest81_1.name = '윤석열';
let tagTest81_2 = new Tag_1.Tag();
tagTest81_2.name = '김종인';
let tagTest81_3 = new Tag_1.Tag();
tagTest81_3.name = '광주';
let scriptTest81_1 = new Script_1.Script();
scriptTest81_1.startTime = new Time_1.Time(0, 0);
scriptTest81_1.endTime = new Time_1.Time(8, 19);
scriptTest81_1.text = '이번 논란의 시작은 윤석열 전 총장이 "전두환 씨가 5·18과 쿠데타 빼면 정치 잘했다" 이렇게 말한 거였죠.';
let scriptTest81_2 = new Script_1.Script();
scriptTest81_2.startTime = new Time_1.Time(8, 19);
scriptTest81_2.endTime = new Time_1.Time(15, 24);
scriptTest81_2.text = '논란이 가라앉지 않자 윤 전 총장은 어젯밤 광주의 마음을 사기 위해 노력했던 김종인 전 위원장을 찾아갔습니다.';
let scriptTest81_3 = new Script_1.Script();
scriptTest81_3.startTime = new Time_1.Time(15, 24);
scriptTest81_3.endTime = new Time_1.Time(19, 91);
scriptTest81_3.text = '그리고 오늘은 다음 달 초, 광주에 직접 가서 사과하겠다고 했습니다.​';
let scriptTest81_4 = new Script_1.Script();
scriptTest81_4.startTime = new Time_1.Time(19, 91);
scriptTest81_4.endTime = new Time_1.Time(21, 88);
scriptTest81_4.text = '계속해서 임지수 기자입니다.';
// 82번 뉴스
let tagTest82_1 = new Tag_1.Tag();
tagTest82_1.name = '세금';
let tagTest82_2 = new Tag_1.Tag();
tagTest82_2.name = '정부';
let tagTest82_3 = new Tag_1.Tag();
tagTest82_3.name = '종합부동산세';
let scriptTest82_1 = new Script_1.Script();
scriptTest82_1.startTime = new Time_1.Time(0, 0);
scriptTest82_1.endTime = new Time_1.Time(14, 46);
scriptTest82_1.text = '화제의 경제 뉴스를 빠르게 전해드리는 신선한 경제 시간입니다.';
let scriptTest82_2 = new Script_1.Script();
scriptTest82_2.startTime = new Time_1.Time(14, 46);
scriptTest82_2.endTime = new Time_1.Time(23, 8);
scriptTest82_2.text = '정부가 주택 수에 따라 세금을 물리는 현행 종합부동산세 제도를 주택 수가 아닌 주택 가격 기준으로 바꾸기로 했습니다.';
let scriptTest82_3 = new Script_1.Script();
scriptTest82_3.startTime = new Time_1.Time(23, 8);
scriptTest82_3.endTime = new Time_1.Time(30, 15);
scriptTest82_3.text = '지난 정부는 징벌적 과세 차원에서 다주택자들이 종합부동산세를 많이 내도록 세율을 고쳤는데요.​';
let scriptTest82_4 = new Script_1.Script();
scriptTest82_4.startTime = new Time_1.Time(30, 15);
scriptTest82_4.endTime = new Time_1.Time(36, 73);
scriptTest82_4.text = '현행 종부세율은 1주택자의 경우 최고 3%지만 다주택자는 6%까지 늘어납니다.';
let scriptTest82_5 = new Script_1.Script();
scriptTest82_5.startTime = new Time_1.Time(36, 73);
scriptTest82_5.endTime = new Time_1.Time(45, 96);
scriptTest82_5.text = '하지만 초고가 아파트 한 채를 가진 사람보다 저가 아파트 두 채를 보유한 사람이 세율이 더 높아 과세 형평성에 어긋난다는 지적을 받아왔는데요.​';
let scriptTest82_6 = new Script_1.Script();
scriptTest82_6.startTime = new Time_1.Time(45, 96);
scriptTest82_6.endTime = new Time_1.Time(53, 5);
scriptTest82_6.text = '정부는 오는 21일 이 같은 종부세 개편 방안을 담은 세법 개정안을 발표할 예정입니다.';
// 83번 뉴스
let tagTest83_1 = new Tag_1.Tag();
tagTest83_1.name = '손흥민';
let tagTest83_2 = new Tag_1.Tag();
tagTest83_2.name = '득점왕';
let tagTest83_3 = new Tag_1.Tag();
tagTest83_3.name = '토트넘';
let scriptTest83_1 = new Script_1.Script();
scriptTest83_1.startTime = new Time_1.Time(0, 0);
scriptTest83_1.endTime = new Time_1.Time(8, 55);
scriptTest83_1.text = '토트넘의 손흥민 선수가 아시아 선수 최초로 세계 최고의 프로축구 리그인 잉글랜드 프리미어리그 득점왕에 오르는 새 역사를 썼습니다.';
let scriptTest83_2 = new Script_1.Script();
scriptTest83_2.startTime = new Time_1.Time(8, 55);
scriptTest83_2.endTime = new Time_1.Time(20, 76);
scriptTest83_2.text = '손흥민은 노리치 시티와 마지막 원정경기에서 후반에 22호와 23호 골을 잇달아 터트려 마지막 경기에서 한 골을 추가한 리버풀의 모하메드 살라와 공동 득점왕에 올랐습니다.';
let scriptTest83_3 = new Script_1.Script();
scriptTest83_3.startTime = new Time_1.Time(20, 76);
scriptTest83_3.endTime = new Time_1.Time(30, 44);
scriptTest83_3.text = '토트넘은 손흥민과 클루셉스키의 멀티 골로 노리치를 5대 0으로 대파하고 4위를 확정해 다음 시즌 챔피언스리그 진출 티켓도 손에 넣었습니다.​';
let scriptTest83_4 = new Script_1.Script();
scriptTest83_4.startTime = new Time_1.Time(30, 44);
scriptTest83_4.endTime = new Time_1.Time(37, 60);
scriptTest83_4.text = '손흥민은 올 시즌 기록한 스물세 골을 모두 필드골로 채워 득점 순도도 굉장히 높다는 평가를 받습니다.';
let scriptTest83_5 = new Script_1.Script();
scriptTest83_5.startTime = new Time_1.Time(37, 60);
scriptTest83_5.endTime = new Time_1.Time(51, 54);
...
// 84번 뉴스
let tagTest84_1 = new Tag_1.Tag();
tagTest84_1.name = '경기침체';
let tagTest84_2 = new Tag_1.Tag();
tagTest84_2.name = 'OECD';
let tagTest84_3 = new Tag_1.Tag();
tagTest84_3.name = '성장률';
let scriptTest84_1 = new Script_1.Script();
scriptTest84_1.startTime = new Time_1.Time(0, 0);
scriptTest84_1.endTime = new Time_1.Time(9, 11);
scriptTest84_1.text = '경제협력개발기구 OECD는 올해 한국의 성장률 전망치를 3%에서 2.7%로 내려 잡았습니다.';
let scriptTest84_2 = new Script_1.Script();
scriptTest84_2.startTime = new Time_1.Time(9, 11);
scriptTest84_2.endTime = new Time_1.Time(14, 76);
scriptTest84_2.text = '내년 전망치는 2.5%로 더 낮춰 잡았습니다. 이뿐만이 아닙니다.';
let scriptTest84_3 = new Script_1.Script();
scriptTest84_3.startTime = new Time_1.Time(14, 76);
scriptTest84_3.endTime = new Time_1.Time(19, 66);
scriptTest84_3.text = '주요 수출 시장인 중국과 미국의 성장률 전망치도 떨어졌는데,​';
let scriptTest84_4 = new Script_1.Script();
scriptTest84_4.startTime = new Time_1.Time(19, 66);
scriptTest84_4.endTime = new Time_1.Time(25, 89);
scriptTest84_4.text = '우리 경제 상황 점점 어두워져 가는 분위기입니다. 계속해서 박혜진 기자입니다.';
// 85번 뉴스
let tagTest85_1 = new Tag_1.Tag();
tagTest85_1.name = '스포츠';
let tagTest85_2 = new Tag_1.Tag();
tagTest85_2.name = '육상';
let tagTest85_3 = new Tag_1.Tag();
tagTest85_3.name = '한국신기록';
let scriptTest85_1 = new Script_1.Script();
scriptTest85_1.startTime = new Time_1.Time(0, 0);
scriptTest85_1.endTime = new Time_1.Time(8, 80);
scriptTest85_1.text = '지난달 전국소년체전에 출전한 대구의 한 중학생이 육상 100미터에서 중학생 부문 한국 신기록을 세웠습니다.';
let scriptTest85_2 = new Script_1.Script();
scriptTest85_2.startTime = new Time_1.Time(8, 80);
scriptTest85_2.endTime = new Time_1.Time(21, 66);
scriptTest85_2.text = '대한민국의 중학생 가운데 가장 빠른 이 학생은 신체 조건이나 주법이 또래 선수들에 비해 월등해 장차 한국 육상 단거리를 빛낼 유망주로 큰 기대를 모으고 있습니다.';
let scriptTest85_3 = new Script_1.Script();
scriptTest85_3.startTime = new Time_1.Time(21, 66);
scriptTest85_3.endTime = new Time_1.Time(24, 23);
scriptTest85_3.text = '권기준 기자가 취재했습니다.​';
// 86번 뉴스
let tagTest86_1 = new Tag_1.Tag();
tagTest86_1.name = '환율';
let tagTest86_2 = new Tag_1.Tag();
tagTest86_2.name = '유학';
let tagTest86_3 = new Tag_1.Tag();
tagTest86_3.name = '달러';
let scriptTest86_1 = new Script_1.Script();
scriptTest86_1.startTime = new Time_1.Time(0, 0);
scriptTest86_1.endTime = new Time_1.Time(6, 38);
scriptTest86_1.text = '원·달러 환율도 13년 만에 최고 수준을 기록하면서, 환율에 가장 민감한 사람들이죠.';
let scriptTest86_2 = new Script_1.Script();
scriptTest86_2.startTime = new Time_1.Time(6, 38);
scriptTest86_2.endTime = new Time_1.Time(9, 31);
scriptTest86_2.text = '해외 유학생들의 부담이 커지고 있습니다.';
let scriptTest86_3 = new Script_1.Script();
scriptTest86_3.startTime = new Time_1.Time(9, 31);
scriptTest86_3.endTime = new Time_1.Time(18, 31);
scriptTest86_3.text = '보내는 돈은 같지만 받는 돈은 줄어들면서 해외에서 생활하는 학생들도, 또 돈을 보내는 부모님들도 그만큼 힘들어졌는데요.​';
let scriptTest86_4 = new Script_1.Script();
scriptTest86_4.startTime = new Time_1.Time(18, 31);
scriptTest86_4.endTime = new Time_1.Time(21, 96);
scriptTest86_4.text = '뉴욕에서 이용주 특파원이 유학생들을 만나봤습니다.';
// 87번 뉴스
let tagTest87_1 = new Tag_1.Tag();
tagTest87_1.name = '코로나19';
let tagTest87_2 = new Tag_1.Tag();
tagTest87_2.name = '거리두기';
let tagTest87_3 = new Tag_1.Tag();
tagTest87_3.name = '서울';
let scriptTest87_1 = new Script_1.Script();
scriptTest87_1.startTime = new Time_1.Time(0, 0);
scriptTest87_1.endTime = new Time_1.Time(7, 86);
scriptTest87_1.text = '거리두기가 2단계로 격상된 서울, 경기지역에서는 이제 실외에서도 백 명이 넘는 모임은 자제해야 합니다.';
let scriptTest87_2 = new Script_1.Script();
scriptTest87_2.startTime = new Time_1.Time(7, 86);
scriptTest87_2.endTime = new Time_1.Time(16, 83);
scriptTest87_2.text = '또 최근 관중을 조금씩 늘려온 스포츠 경기는 내일부터 무관중 경기로 돌아가고, 학교 원격수업, 공공기관 재택근무도 늘어납니다.';
let scriptTest87_3 = new Script_1.Script();
scriptTest87_3.startTime = new Time_1.Time(16, 83);
scriptTest87_3.endTime = new Time_1.Time(23, 37);
scriptTest87_3.text = '불가피하게 다시 위축돼야만 하는 우리 일상, 무엇이 달라지는지 송금한 기자가 정리했습니다.​';
// 88번 뉴스
let tagTest88_1 = new Tag_1.Tag();
tagTest88_1.name = '우상혁';
let tagTest88_2 = new Tag_1.Tag();
tagTest88_2.name = '다이아몬드리그';
let tagTest88_3 = new Tag_1.Tag();
tagTest88_3.name = '우승';
let scriptTest88_1 = new Script_1.Script();
scriptTest88_1.startTime = new Time_1.Time(0, 0);
scriptTest88_1.endTime = new Time_1.Time(9, 53);
scriptTest88_1.text = '높이뛰기의 희망 우상혁 선수가 첫 출전한 다이아몬드 리그에서 한국 육상 사상 첫 우승을 차지하며 새 역사를 써냈습니다.';
let scriptTest88_2 = new Script_1.Script();
scriptTest88_2.startTime = new Time_1.Time(9, 53);
scriptTest88_2.endTime = new Time_1.Time(18, 10);
scriptTest88_2.text = '세계 정상급 선수들이 출전하는 대회에서 우상혁 선수는 특유의 긍정 에너지로 올림픽 챔피언까지 꺾으며 정상에 섰습니다.';
let scriptTest88_3 = new Script_1.Script();
scriptTest88_3.startTime = new Time_1.Time(18, 10);
scriptTest88_3.endTime = new Time_1.Time(20, 97);
scriptTest88_3.text = '문영규 기자의 보도입니다.​';
// 89번 뉴스
let tagTest89_1 = new Tag_1.Tag();
tagTest89_1.name = '윤석열';
let tagTest89_2 = new Tag_1.Tag();
tagTest89_2.name = '대통령';
let tagTest89_3 = new Tag_1.Tag();
tagTest89_3.name = '검찰';
let scriptTest89_1 = new Script_1.Script();
scriptTest89_1.startTime = new Time_1.Time(0, 0);
scriptTest89_1.endTime = new Time_1.Time(2, 99);
scriptTest89_1.text = '아마 많은 국민들이 같은 마음일 겁니다.';
let scriptTest89_2 = new Script_1.Script();
scriptTest89_2.startTime = new Time_1.Time(2, 99);
scriptTest89_2.endTime = new Time_1.Time(7, 28);
scriptTest89_2.text = '윤석열 당선인은 서울에서 태어나 서울대 법대를 졸업했습니다.';
let scriptTest89_3 = new Script_1.Script();
scriptTest89_3.startTime = new Time_1.Time(7, 28);
scriptTest89_3.endTime = new Time_1.Time(14, 24);
scriptTest89_3.text = '9번 만에 사법시험에 붙는 늦깎이였지만 검찰총장을 지내며 \'적폐 청산 수사\'를 진두지휘했고,​';
let scriptTest89_4 = new Script_1.Script();
scriptTest89_4.startTime = new Time_1.Time(14, 24);
scriptTest89_4.endTime = new Time_1.Time(20, 66);
scriptTest89_4.text = '정치에 뛰어든 후에는 여의도의 숱한 정치인들을 물리치며 대통령에 당선되는 파란을 만들어냈습니다.';
let scriptTest89_5 = new Script_1.Script();
scriptTest89_5.startTime = new Time_1.Time(20, 66);
scriptTest89_5.endTime = new Time_1.Time(22, 56);
scriptTest89_5.text = '정규진 기자입니다.';
// 90번 뉴스
let tagTest90_1 = new Tag_1.Tag();
tagTest90_1.name = '오징어게임';
let tagTest90_2 = new Tag_1.Tag();
tagTest90_2.name = '이정재';
let tagTest90_3 = new Tag_1.Tag();
tagTest90_3.name = '뉴욕타임스';
let scriptTest90_1 = new Script_1.Script();
scriptTest90_1.startTime = new Time_1.Time(0, 0);
scriptTest90_1.endTime = new Time_1.Time(8, 51);
scriptTest90_1.text = '세계적으로 인기를 끈 넷플릭스 드라마 \'오징어게임\'의 주연 배우 이정재가 뉴욕타임스의 올해 문화계 샛별로 선정됐습니다.';
let scriptTest90_2 = new Script_1.Script();
scriptTest90_2.startTime = new Time_1.Time(8, 51);
scriptTest90_2.endTime = new Time_1.Time(16, 16);
scriptTest90_2.text = '뉴욕타임스는 올해 음악과 영화, 연극 등 문화계에서 새롭게 두각을 나타낸 스타로 TV 분야에서는 이정재를 꼽았습니다.';
let scriptTest90_3 = new Script_1.Script();
scriptTest90_3.startTime = new Time_1.Time(16, 16);
scriptTest90_3.endTime = new Time_1.Time(29, 15);
scriptTest90_3.text = '뉴욕타임스는 이정재가 한국에서 여러 영화에 출연한 모델 출신 연기자라고 소개하며 빚더미에 앉은 도박 중독자 성기훈을 비통하면서도 놀랄 정도로 섬세하게 그려냈다고 평가했습니다.​';
// 91번 뉴스
let tagTest91_1 = new Tag_1.Tag();
tagTest91_1.name = '루나';
let tagTest91_2 = new Tag_1.Tag();
tagTest91_2.name = '금융사기';
let tagTest91_3 = new Tag_1.Tag();
tagTest91_3.name = 'IMF';
let scriptTest91_1 = new Script_1.Script();
scriptTest91_1.startTime = new Time_1.Time(0, 0);
scriptTest91_1.endTime = new Time_1.Time(5, 75);
scriptTest91_1.text = '국내는 물론 해외까지 파장을 미치고 있는 가상화폐 \'루나\'의 폭락 사태.';
let scriptTest91_2 = new Script_1.Script();
scriptTest91_2.startTime = new Time_1.Time(5, 75);
scriptTest91_2.endTime = new Time_1.Time(13, 89);
scriptTest91_2.text = '국제통화기금 총재가 "피라미드 사기"라고까지 언급하고 나섰는데, 검찰과 경찰의 수사 속도도 빨라지고 있습니다.';
let scriptTest91_3 = new Script_1.Script();
scriptTest91_3.startTime = new Time_1.Time(13, 89);
scriptTest91_3.endTime = new Time_1.Time(19, 89);
scriptTest91_3.text = '금융당국은 루나 가격이 떨어지기 시작한 뒤 거래량이 오히려 더 늘어난 것으로 분석했습니다.​';
let scriptTest91_4 = new Script_1.Script();
scriptTest91_4.startTime = new Time_1.Time(19, 89);
scriptTest91_4.endTime = new Time_1.Time(22, 20);
scriptTest91_4.text = '김상훈 기자의 보도입니다.';
// 92번 뉴스
let tagTest92_1 = new Tag_1.Tag();
tagTest92_1.name = '미술품';
let tagTest92_2 = new Tag_1.Tag();
tagTest92_2.name = '롯데월드몰';
let tagTest92_3 = new Tag_1.Tag();
tagTest92_3.name = '경찰';
let scriptTest92_1 = new Script_1.Script();
scriptTest92_1.startTime = new Time_1.Time(0, 0);
scriptTest92_1.endTime = new Time_1.Time(8, 12);
scriptTest92_1.text = '서울 롯데월드몰에 전시된 5억 원 상당의 미술품에 누군가 낙서를 하면서 경찰이 출동하는 일이 있었습니다.';
let scriptTest92_2 = new Script_1.Script();
scriptTest92_2.startTime = new Time_1.Time(8, 12);
scriptTest92_2.endTime = new Time_1.Time(17, 68);
scriptTest92_2.text = '그림에 덧칠을 한 건 20대 남녀였는데 알록달록한 대형 작품 앞에 붓과 페인트통이 놓여있어서 참여 예술인 줄 알았다고 말했습니다.';
let scriptTest92_3 = new Script_1.Script();
scriptTest92_3.startTime = new Time_1.Time(17, 68);
scriptTest92_3.endTime = new Time_1.Time(19, 72);
scriptTest92_3.text = '유수환 기자입니다.​';
// 93번 뉴스
let tagTest93_1 = new Tag_1.Tag();
tagTest93_1.name = '더불어민주당';
let tagTest93_2 = new Tag_1.Tag();
tagTest93_2.name = '지방선거';
let tagTest93_3 = new Tag_1.Tag();
tagTest93_3.name = '선거참패';
let scriptTest93_1 = new Script_1.Script();
scriptTest93_1.startTime = new Time_1.Time(0, 0);
scriptTest93_1.endTime = new Time_1.Time(9, 27);
scriptTest93_1.text = '이번 지방선거에서 더불어민주당이 고전할 거라는 건 대부분 예상했지만, 성적표 받아보니 예상보다 더 참담했습니다.';
let scriptTest93_2 = new Script_1.Script();
scriptTest93_2.startTime = new Time_1.Time(9, 27);
scriptTest93_2.endTime = new Time_1.Time(22, 64);
...
let scriptTest93_3 = new Script_1.Script();
scriptTest93_3.startTime = new Time_1.Time(22, 64);
scriptTest93_3.endTime = new Time_1.Time(24, 87);
scriptTest93_3.text = '김재경 기자의 보도입니다.​';
// 94번 뉴스
let tagTest94_1 = new Tag_1.Tag();
tagTest94_1.name = '금리';
let tagTest94_2 = new Tag_1.Tag();
tagTest94_2.name = '백스텝';
let tagTest94_3 = new Tag_1.Tag();
tagTest94_3.name = '한국은행';
let scriptTest94_1 = new Script_1.Script();
scriptTest94_1.startTime = new Time_1.Time(7, 23);
scriptTest94_1.endTime = new Time_1.Time(13, 88);
scriptTest94_1.text = '화제의 경제 뉴스를 빠르게 전해드리는 신선한 경제 시간입니다.';
let scriptTest94_2 = new Script_1.Script();
scriptTest94_2.startTime = new Time_1.Time(13, 88);
scriptTest94_2.endTime = new Time_1.Time(22, 98);
scriptTest94_2.text = '한국은행이 어제 기준금리를 한꺼번에 0.5%포인트 올리는 빅스텝에 나서면서 금리가 2.25%까지 상승했는데요.';
let scriptTest94_3 = new Script_1.Script();
scriptTest94_3.startTime = new Time_1.Time(22, 98);
scriptTest94_3.endTime = new Time_1.Time(27, 6);
scriptTest94_3.text = '오늘부터 일부 시중은행의 예적금 금리도 오릅니다.​';
let scriptTest94_4 = new Script_1.Script();
scriptTest94_4.startTime = new Time_1.Time(27, 6);
scriptTest94_4.endTime = new Time_1.Time(35, 72);
scriptTest94_4.text = '하나은행은 오늘부터 예적금 30종의 기본 금리를 0.25%포인트에서 최대 0.9%포인트 올리기로 했습니다.';
let scriptTest94_5 = new Script_1.Script();
scriptTest94_5.startTime = new Time_1.Time(35, 72);
scriptTest94_5.endTime = new Time_1.Time(44, 5);
scriptTest94_5.text = '이에 따라 1년 만기 적금 상품의 금리는 5.5%까지, 1년짜리의 정기 예금은 2.8%로 오르는데요.​';
let scriptTest94_6 = new Script_1.Script();
scriptTest94_6.startTime = new Time_1.Time(44, 5);
scriptTest94_6.endTime = new Time_1.Time(59, 71);
...
let scriptTest94_7 = new Script_1.Script();
scriptTest94_7.startTime = new Time_1.Time(59, 71);
scriptTest94_7.endTime = new Time_1.Time(69, 41);
scriptTest94_7.text = '연말까지 기준금리가 최대 3%까지 오를 것으로 전망되고 있는 만큼 예적금에 가입한다면 만기는 되도록 짧게 가져가는 게 유리합니다.';
// 95번 뉴스
let tagTest95_1 = new Tag_1.Tag();
tagTest95_1.name = '월드컵';
let tagTest95_2 = new Tag_1.Tag();
tagTest95_2.name = '조추첨';
let tagTest95_3 = new Tag_1.Tag();
tagTest95_3.name = '벤투호';
let scriptTest95_1 = new Script_1.Script();
scriptTest95_1.startTime = new Time_1.Time(0, 0);
scriptTest95_1.endTime = new Time_1.Time(10, 95);
scriptTest95_1.text = '벤투 감독이 이끄는 축구 대표팀이 카타르 월드컵 아시아 지역 최종 예선 조 추첨에서 중동 팀들과 한 조에 묶이는 역대 최악의 조에 편성됐습니다.';
let scriptTest95_2 = new Script_1.Script();
scriptTest95_2.startTime = new Time_1.Time(10, 95);
scriptTest95_2.endTime = new Time_1.Time(20, 26);
scriptTest95_2.text = '우리나라는 말레이시아에서 열린 조 추첨에서 이란과 아랍에미리트, 이라크와 시리아, 레바논 등 중동 국가와 A조에 포함됐습니다.';
let scriptTest95_3 = new Script_1.Script();
scriptTest95_3.startTime = new Time_1.Time(20, 26);
scriptTest95_3.endTime = new Time_1.Time(29, 69);
scriptTest95_3.text = '중동 팀들과만 한 조에 묶인 건 홈 앤드 어웨이 방식이 시작된 이후 처음으로, 강호 이란과는 4회 연속 같은 조에서 맞붙게 됐습니다.​';
let scriptTest95_4 = new Script_1.Script();
scriptTest95_4.startTime = new Time_1.Time(29, 69);
scriptTest95_4.endTime = new Time_1.Time(35, 48);
scriptTest95_4.text = '대표팀은 오는 9월 2일, 홈에서 이라크와 첫 경기를 치릅니다.';
// 96번 뉴스
let tagTest96_1 = new Tag_1.Tag();
tagTest96_1.name = '미국';
let tagTest96_2 = new Tag_1.Tag();
tagTest96_2.name = '금리';
let tagTest96_3 = new Tag_1.Tag();
tagTest96_3.name = '연방준비제도';
let scriptTest96_1 = new Script_1.Script();
scriptTest96_1.startTime = new Time_1.Time(0, 0);
scriptTest96_1.endTime = new Time_1.Time(10, 34);
scriptTest96_1.text = '미국 연방준비제도가 기준금리를 0.75%포인트 인상할 것으로 보여 한국과 미국의 기준금리 역전이 불가피할 전망입니다.';
let scriptTest96_2 = new Script_1.Script();
scriptTest96_2.startTime = new Time_1.Time(10, 34);
scriptTest96_2.endTime = new Time_1.Time(19, 86);
scriptTest96_2.text = '외신에 따르면 연준이 오는 27일 연방공개시장위원회 회의에서 기준금리를 0.75%포인트 인상하는 것이 확실시되고 있습니다.';
let scriptTest96_3 = new Script_1.Script();
scriptTest96_3.startTime = new Time_1.Time(19, 86);
scriptTest96_3.endTime = new Time_1.Time(30, 31);
scriptTest96_3.text = '연준이 예상대로 결정하면 미국 기준금리는 오는 27일에 1.5∼1.75%에서 2.25∼2.5%로 오르게 됩니다.​';
let scriptTest96_4 = new Script_1.Script();
scriptTest96_4.startTime = new Time_1.Time(30, 31);
scriptTest96_4.endTime = new Time_1.Time(38, 39);
scriptTest96_4.text = '이렇게 되면 현재 한국의 기준금리 2.25%보다 높아져 한미 기준금리가 역전됩니다.';
// 97번 뉴스
let tagTest97_1 = new Tag_1.Tag();
tagTest97_1.name = '코로나';
let tagTest97_2 = new Tag_1.Tag();
tagTest97_2.name = '유학생';
let tagTest97_3 = new Tag_1.Tag();
tagTest97_3.name = '미국대학';
let scriptTest97_1 = new Script_1.Script();
scriptTest97_1.startTime = new Time_1.Time(0, 0);
scriptTest97_1.endTime = new Time_1.Time(11, 74);
scriptTest97_1.text = '코로나 사태 속에서 미국 트럼프 대통령이 올가을에 미국 대학에 입학하는 외국인 유학생 중에 인터넷 수업만 듣는 경우는 비자를 내주지 않겠다고 공식 발표를 했습니다.';
let scriptTest97_2 = new Script_1.Script();
scriptTest97_2.startTime = new Time_1.Time(11, 74);
scriptTest97_2.endTime = new Time_1.Time(18, 19);
scriptTest97_2.text = '우리나라 학생들까지, 전 세계에서 25만 명이 합격증 받아 놓고 미국에 못 갈 상황입니다.';
let scriptTest97_3 = new Script_1.Script();
scriptTest97_3.startTime = new Time_1.Time(18, 19);
scriptTest97_3.endTime = new Time_1.Time(20, 17);
scriptTest97_3.text = '김영아 기자입니다.​';
// 98번 뉴스
let tagTest98_1 = new Tag_1.Tag();
tagTest98_1.name = '차별';
let tagTest98_2 = new Tag_1.Tag();
tagTest98_2.name = '예멘';
let tagTest98_3 = new Tag_1.Tag();
tagTest98_3.name = '내전';
let scriptTest98_1 = new Script_1.Script();
scriptTest98_1.startTime = new Time_1.Time(0, 0);
scriptTest98_1.endTime = new Time_1.Time(6, 63);
scriptTest98_1.text = '이번에는 내전 중인 고국을 떠나 한국에 왔던 한 예멘 청년의 이야기를 전해 드립니다.';
let scriptTest98_2 = new Script_1.Script();
scriptTest98_2.startTime = new Time_1.Time(6, 63);
scriptTest98_2.endTime = new Time_1.Time(15, 32);
scriptTest98_2.text = '우리나라를 제2의 고향으로 삼고 싶었다던 청년은 차별과 냉대를 견디다 못해 4년 만에 다른 나라로 떠나고 말았는데요.';
let scriptTest98_3 = new Script_1.Script();
scriptTest98_3.startTime = new Time_1.Time(15, 32);
scriptTest98_3.endTime = new Time_1.Time(21, 76);
scriptTest98_3.text = '우리 사회가 반성해야 할 부분은 없는지 신정은 기자가 모하메드 이야기를 취재했습니다.​';
// 99번 뉴스
let tagTest99_1 = new Tag_1.Tag();
tagTest99_1.name = '부동산';
let tagTest99_2 = new Tag_1.Tag();
tagTest99_2.name = '전세대출';
let tagTest99_3 = new Tag_1.Tag();
tagTest99_3.name = '금리';
let scriptTest99_1 = new Script_1.Script();
scriptTest99_1.startTime = new Time_1.Time(8, 84);
scriptTest99_1.endTime = new Time_1.Time(13, 65);
scriptTest99_1.text = '화제의 경제 뉴스를 빠르게 전해드리는 신선한 경제 시간입니다.';
let scriptTest99_2 = new Script_1.Script();
scriptTest99_2.startTime = new Time_1.Time(13, 65);
scriptTest99_2.endTime = new Time_1.Time(18, 63);
scriptTest99_2.text = '전세자금 대출 금리가 약 12년 만에 6%를 넘었습니다.';
let scriptTest99_3 = new Script_1.Script();
scriptTest99_3.startTime = new Time_1.Time(18, 63);
scriptTest99_3.endTime = new Time_1.Time(26, 98);
scriptTest99_3.text = '지난 16일 기준 4대 시중 은행 전세 자금 대출 금리는 연 4 ~ 6.2%로 나타났습니다.​';
let scriptTest99_4 = new Script_1.Script();
scriptTest99_4.startTime = new Time_1.Time(26, 98);
scriptTest99_4.endTime = new Time_1.Time(34, 29);
scriptTest99_4.text = '전세 대출 금리에 연동되는 코픽스가 2.38%까지 급등하면서 최고 금리가 6%를 넘은 건데요.';
let scriptTest99_5 = new Script_1.Script();
scriptTest99_5.startTime = new Time_1.Time(34, 29);
scriptTest99_5.endTime = new Time_1.Time(45, 26);
scriptTest99_5.text = '임대차법 시행 이후 전셋값이 치솟은 상황에서 대출 금리마저 급등하면 세입자들의 부담은 더욱 커지고 보증금을 감당하지 못하면 월세로 내몰릴 수밖에 없는데요.​';
let scriptTest99_6 = new Script_1.Script();
scriptTest99_6.startTime = new Time_1.Time(45, 26);
scriptTest99_6.endTime = new Time_1.Time(57, 39);
scriptTest99_6.text = '실제로 올 상반기 서울에서 월세가 낀 아파트 임대차 거래량은 4만 2000여건으로 역대 최다를 기록해 전세의 월세화가 가속화되고 있는 것으로 나타났습니다.';
// 100번 뉴스
let tagTest100_1 = new Tag_1.Tag();
tagTest100_1.name = '변희수하사';
let tagTest100_2 = new Tag_1.Tag();
tagTest100_2.name = '강제전역';
let tagTest100_3 = new Tag_1.Tag();
tagTest100_3.name = '성소수자';
let scriptTest100_1 = new Script_1.Script();
scriptTest100_1.startTime = new Time_1.Time(0, 0);
scriptTest100_1.endTime = new Time_1.Time(8, 59);
scriptTest100_1.text = '성전환 수술을 한 뒤에도 계속 군 복무를 원했던 육군 하사를 군 당국이 강제 전역시켰습니다.';
let scriptTest100_2 = new Script_1.Script();
scriptTest100_2.startTime = new Time_1.Time(8, 59);
scriptTest100_2.endTime = new Time_1.Time(17, 46);
scriptTest100_2.text = '군은 성전환 수술에 따른 신체 변화를 일종의 부상으로 간주하고 오늘 밤 12시 전역하라는 결정을 내렸습니다.';
let scriptTest100_3 = new Script_1.Script();
scriptTest100_3.startTime = new Time_1.Time(17, 46);
scriptTest100_3.endTime = new Time_1.Time(24, 97);
scriptTest100_3.text = '개인적 사유에 대한 판단이 아니라, 관계 법령에 근거한 적법한 결정이라는 게 군 당국의 설명입니다.​';
let scriptTest100_4 = new Script_1.Script();
scriptTest100_4.startTime = new Time_1.Time(24, 97);
scriptTest100_4.endTime = new Time_1.Time(33, 26);
scriptTest100_4.text = '군의 통보를 받은 육군 하사는 성 정체성을 떠나서 훌륭한 군인이 되는 걸 보여주고 싶었다며 오늘 기자회견을 열었습니다.';
let scriptTest100_5 = new Script_1.Script();
scriptTest100_5.startTime = new Time_1.Time(33, 26);
scriptTest100_5.endTime = new Time_1.Time(37, 60);
scriptTest100_5.text = '김아영 기자 리포트 먼저 보시고 좀 더 이야기를 해보겠습니다.​';
// 101번 뉴스
let tagTest101_1 = new Tag_1.Tag();
tagTest101_1.name = '변희수하사';
let tagTest101_2 = new Tag_1.Tag();
tagTest101_2.name = '강제전역';
let tagTest101_3 = new Tag_1.Tag();
tagTest101_3.name = '취소판결';
let scriptTest101_1 = new Script_1.Script();
scriptTest101_1.startTime = new Time_1.Time(0, 0);
scriptTest101_1.endTime = new Time_1.Time(6, 82);
scriptTest101_1.text = '자신의 성 정체성을 깨닫고 남성에서 여성으로 성전환 수술을 받은 군인이 있었습니다.';
let scriptTest101_2 = new Script_1.Script();
scriptTest101_2.startTime = new Time_1.Time(6, 82);
scriptTest101_2.endTime = new Time_1.Time(13, 93);
scriptTest101_2.text = '국가를 위해서 군인으로 남겠다는 각오를 밝혔지만, 군은 받아들이지 않았고, 강제로 전역을 시켰습니다.';
let scriptTest101_3 = new Script_1.Script();
scriptTest101_3.startTime = new Time_1.Time(13, 93);
scriptTest101_3.endTime = new Time_1.Time(15, 75);
scriptTest101_3.text = '고 변희수 하사 이야기입니다.';
let scriptTest101_4 = new Script_1.Script();
scriptTest101_4.startTime = new Time_1.Time(15, 75);
scriptTest101_4.endTime = new Time_1.Time(18, 97);
scriptTest101_4.text = '변 하사가 세상을 떠난 이후에도 소송은 계속됐습니다.';
let scriptTest101_5 = new Script_1.Script();
scriptTest101_5.startTime = new Time_1.Time(18, 97);
scriptTest101_5.endTime = new Time_1.Time(26, 61);
scriptTest101_5.text = '결국 법원은 강제 전역이 잘못된 거라고 변 하사 손을 들어줬고, 이번 주에 이 판결이 확정됐습니다.​';
let scriptTest101_6 = new Script_1.Script();
scriptTest101_6.startTime = new Time_1.Time(26, 61);
scriptTest101_6.endTime = new Time_1.Time(28, 42);
scriptTest101_6.text = '오늘 이 내용을 짚어보겠습니다.';
let scriptTest101_7 = new Script_1.Script();
scriptTest101_7.startTime = new Time_1.Time(28, 42);
scriptTest101_7.endTime = new Time_1.Time(33, 6);
scriptTest101_7.text = '먼저 지형철 기자의 리포트를 보시고 법률 전문가와 더 얘기해보겠습니다.​';
// 102번 뉴스
let tagTest102_1 = new Tag_1.Tag();
tagTest102_1.name = '국회의원';
let tagTest102_2 = new Tag_1.Tag();
tagTest102_2.name = '지역구';
let tagTest102_3 = new Tag_1.Tag();
tagTest102_3.name = '취소판결';
let scriptTest102_1 = new Script_1.Script();
scriptTest102_1.startTime = new Time_1.Time(0, 0);
scriptTest102_1.endTime = new Time_1.Time(9, 53);
scriptTest102_1.text = '새누리당 김무성 대표가 이재오·주호영 의원 등 비박계 주요 의원들이 공천 탈락한 것과 관련해 이를 수용할 수 없다는 견해를 밝혔습니다.';
let scriptTest102_2 = new Script_1.Script();
scriptTest102_2.startTime = new Time_1.Time(9, 53);
scriptTest102_2.endTime = new Time_1.Time(25, 57);
...
let scriptTest102_3 = new Script_1.Script();
scriptTest102_3.startTime = new Time_1.Time(25, 57);
scriptTest102_3.endTime = new Time_1.Time(40, 37);
...
let scriptTest102_4 = new Script_1.Script();
scriptTest102_4.startTime = new Time_1.Time(40, 37);
scriptTest102_4.endTime = new Time_1.Time(56, 68);
...
// 103번 뉴스
let tagTest103_1 = new Tag_1.Tag();
tagTest103_1.name = '북한';
let tagTest103_2 = new Tag_1.Tag();
tagTest103_2.name = '국정원';
let tagTest103_3 = new Tag_1.Tag();
tagTest103_3.name = '김정은';
let scriptTest103_1 = new Script_1.Script();
scriptTest103_1.startTime = new Time_1.Time(0, 0);
scriptTest103_1.endTime = new Time_1.Time(8, 4);
scriptTest103_1.text = '국가정보원이 2018년 판문점 정상회담 당시 김정은 위원장에게 제공된 USB 내용을 들여다보고 있는 것으로 확인됐습니다.';
let scriptTest103_2 = new Script_1.Script();
scriptTest103_2.startTime = new Time_1.Time(8, 4);
scriptTest103_2.endTime = new Time_1.Time(13, 87);
scriptTest103_2.text = 'USB 안에 \'북한 원전 건설\' 관련 내용이 있느냐를 두고 정치권 공방이 일기도 있는데,';
let scriptTest103_3 = new Script_1.Script();
scriptTest103_3.startTime = new Time_1.Time(13, 87);
scriptTest103_3.endTime = new Time_1.Time(17, 69);
scriptTest103_3.text = '원전 내용이 포함됐는지를 국정원이 분석하고 있습니다.';
let scriptTest103_4 = new Script_1.Script();
scriptTest103_4.startTime = new Time_1.Time(17, 69);
scriptTest103_4.endTime = new Time_1.Time(20, 4);
scriptTest103_4.text = '홍진아 기자가 보도합니다.';
// 104번 뉴스
let tagTest104_1 = new Tag_1.Tag();
tagTest104_1.name = '북한';
let tagTest104_2 = new Tag_1.Tag();
tagTest104_2.name = '북한경제';
let tagTest104_3 = new Tag_1.Tag();
tagTest104_3.name = '통계청';
let scriptTest104_1 = new Script_1.Script();
scriptTest104_1.startTime = new Time_1.Time(0, 0);
scriptTest104_1.endTime = new Time_1.Time(5, 4);
scriptTest104_1.text = '코로나19가 전 세계를 휩쓰는 상황이 2년째 이어지고 있죠.';
let scriptTest104_2 = new Script_1.Script();
scriptTest104_2.startTime = new Time_1.Time(5, 4);
scriptTest104_2.endTime = new Time_1.Time(12, 55);
scriptTest104_2.text = '이미 유엔의 대북 제재를 받고 있던 북한은 코로나19까지 덮치면서 경제가 더욱 악화된 것으로 파악됐습니다.';
let scriptTest104_3 = new Script_1.Script();
scriptTest104_3.startTime = new Time_1.Time(12, 55);
scriptTest104_3.endTime = new Time_1.Time(16, 96);
scriptTest104_3.text = '오늘의 그래픽 뉴스에서는 [북한 경제]를 한번 짚어보겠습니다.';
let scriptTest104_4 = new Script_1.Script();
scriptTest104_4.startTime = new Time_1.Time(16, 96);
scriptTest104_4.endTime = new Time_1.Time(27, 51);
scriptTest104_4.text = '오늘 통계청이 발표한 \'북한 주요 통계지표\'에 따르면, 2020년 북한의 인구는 2,537만 명으로 남한의 절반 수준으로 나타났습니다.';
let scriptTest104_5 = new Script_1.Script();
scriptTest104_5.startTime = new Time_1.Time(27, 51);
scriptTest104_5.endTime = new Time_1.Time(47, 14);
...
let scriptTest104_6 = new Script_1.Script();
scriptTest104_6.startTime = new Time_1.Time(47, 14);
scriptTest104_6.endTime = new Time_1.Time(50, 61);
scriptTest104_6.text = '고령인구 비율은 수명과도 관련이 있죠.';
let scriptTest104_7 = new Script_1.Script();
scriptTest104_7.startTime = new Time_1.Time(50, 61);
scriptTest104_7.endTime = new Time_1.Time(61, 41);
scriptTest104_7.text = '북한의 기대수명은 남자 66.9세, 여자 73.6세로 남한의 기대수명보다 각각 13.6세, 12.9세 짧았습니다.';
let scriptTest104_8 = new Script_1.Script();
scriptTest104_8.startTime = new Time_1.Time(61, 41);
scriptTest104_8.endTime = new Time_1.Time(68, 81);
scriptTest104_8.text = '지난해 북한 실질 국내총생산, GDP는 전년보다 4.5% 감소했습니다.';
let scriptTest104_9 = new Script_1.Script();
scriptTest104_9.startTime = new Time_1.Time(68, 81);
scriptTest104_9.endTime = new Time_1.Time(76, 66);
scriptTest104_9.text = '이는 최악의 식량난을 겪던 이른바 \'고난의 행군\' 시기인 1997년 이후 최대폭의 역성장인데요.';
let scriptTest104_10 = new Script_1.Script();
scriptTest104_10.startTime = new Time_1.Time(76, 66);
scriptTest104_10.endTime = new Time_1.Time(86, 57);
scriptTest104_10.text = '1인당 GNI, 즉 1인당 국민 총소득은 137.9만 원으로 남한의 27분의 1 수준에 불과한 것으로 나타났습니다.';
let scriptTest104_11 = new Script_1.Script();
scriptTest104_11.startTime = new Time_1.Time(86, 57);
scriptTest104_11.endTime = new Time_1.Time(90, 81);
scriptTest104_11.text = '남북한의 소득 격차는 점차 확대되는 추세입니다.';
let scriptTest104_12 = new Script_1.Script();
scriptTest104_12.startTime = new Time_1.Time(90, 81);
scriptTest104_12.endTime = new Time_1.Time(95, 71);
scriptTest104_12.text = '북한 경제의 역성장 이유로는 대외 무역의 감소가 꼽힙니다.';
let scriptTest104_13 = new Script_1.Script();
scriptTest104_13.startTime = new Time_1.Time(95, 71);
scriptTest104_13.endTime = new Time_1.Time(103, 25);
scriptTest104_13.text = '대북 제재로 이미 어렵던 북한 무역은 코로나19 이후 국경 봉쇄가 거듭되면서 더 큰 타격을 받고 있는데요.';
let scriptTest104_14 = new Script_1.Script();
scriptTest104_14.startTime = new Time_1.Time(103, 25);
scriptTest104_14.endTime = new Time_1.Time(111, 21);
scriptTest104_14.text = '지난해 북한의 무역총액은 8억6천만 달러로 전년보다 무려 73.4% 감소했습니다.';
let scriptTest104_15 = new Script_1.Script();
scriptTest104_15.startTime = new Time_1.Time(111, 21);
scriptTest104_15.endTime = new Time_1.Time(115, 44);
scriptTest104_15.text = '남한의 무역총액이 6%대로 감소한 것과는 차이가 큽니다.';
let scriptTest104_16 = new Script_1.Script();
scriptTest104_16.startTime = new Time_1.Time(115, 44);
scriptTest104_16.endTime = new Time_1.Time(119, 72);
scriptTest104_16.text = '이런 가운데 식량 사정마저 점점 어려워지고 있습니다.';
let scriptTest104_17 = new Script_1.Script();
scriptTest104_17.startTime = new Time_1.Time(119, 72);
scriptTest104_17.endTime = new Time_1.Time(129, 76);
scriptTest104_17.text = '작년 쌀, 보리 등 식량작물 생산량은 440만t으로 남한보다는 많았지만, 전년과 비교해 5.2% 감소했는데요.';
let scriptTest104_18 = new Script_1.Script();
scriptTest104_18.startTime = new Time_1.Time(129, 76);
scriptTest104_18.endTime = new Time_1.Time(135, 61);
scriptTest104_18.text = '특히 식량작물 중 쌀은 202만t으로 9.6%나 감소했습니다.';
let scriptTest104_19 = new Script_1.Script();
scriptTest104_19.startTime = new Time_1.Time(135, 61);
scriptTest104_19.endTime = new Time_1.Time(147, 67);
scriptTest104_19.text = '한편 북한에서 한 사람이 하루에 공급받는 에너지양은 2천19㎉로 전년보다 0.5% 감소했고요, 이는 남한 67% 수준으로 추정됐습니다.';
let scriptTest104_20 = new Script_1.Script();
scriptTest104_20.startTime = new Time_1.Time(147, 67);
scriptTest104_20.endTime = new Time_1.Time(149, 78);
scriptTest104_20.text = '지금까지 그래픽 뉴스였습니다.';
// 105번 뉴스
let tagTest105_1 = new Tag_1.Tag();
tagTest105_1.name = 'IPEF';
let tagTest105_2 = new Tag_1.Tag();
tagTest105_2.name = '미국';
let tagTest105_3 = new Tag_1.Tag();
tagTest105_3.name = '중국';
let scriptTest105_1 = new Script_1.Script();
scriptTest105_1.startTime = new Time_1.Time(0, 0);
scriptTest105_1.endTime = new Time_1.Time(11, 58);
scriptTest105_1.text = '조 바이든 미국 대통령과 정상회담을 통해 한미동맹을 다진 윤석열 대통령이 오늘 오후 IPEF 출범 선언 정상회의에 화상으로 참석했습니다.';
let scriptTest105_2 = new Script_1.Script();
scriptTest105_2.startTime = new Time_1.Time(11, 58);
scriptTest105_2.endTime = new Time_1.Time(17, 86);
scriptTest105_2.text = '한미 양국의 경제, 안보 공조가 IPEF를 계기로 더 본격화할 전망인데요.';
let scriptTest105_3 = new Script_1.Script();
scriptTest105_3.startTime = new Time_1.Time(17, 86);
scriptTest105_3.endTime = new Time_1.Time(20, 45);
scriptTest105_3.text = '오늘의 그래픽 뉴스, [IPEF]입니다.';
let scriptTest105_4 = new Script_1.Script();
scriptTest105_4.startTime = new Time_1.Time(20, 45);
scriptTest105_4.endTime = new Time_1.Time(31, 7);
scriptTest105_4.text = 'IPEF, 인도태평양경제프레임워크는 바이든 미 대통령이 지난해 제시한 인도 태평양 지역 경제 안보 협력체입니다.';
let scriptTest105_5 = new Script_1.Script();
scriptTest105_5.startTime = new Time_1.Time(31, 7);
scriptTest105_5.endTime = new Time_1.Time(43, 27);
scriptTest105_5.text = '공정하고 회복력 있는 무역, 공급망 안정성, 청정에너지 및 탈탄소화, 조세 및 반부패 등 총 4개 분야를 참여국 간의 협력 의제로 다루게 되는데요.';
let scriptTest105_6 = new Script_1.Script();
scriptTest105_6.startTime = new Time_1.Time(43, 27);
scriptTest105_6.endTime = new Time_1.Time(52, 31);
scriptTest105_6.text = '참여국을 살펴보면 한국과 미국을 비롯해서 일본, 호주, 뉴질랜드, 싱가포르 등 모두 13개 국가입니다.';
let scriptTest105_7 = new Script_1.Script();
scriptTest105_7.startTime = new Time_1.Time(52, 31);
scriptTest105_7.endTime = new Time_1.Time(60, 35);
scriptTest105_7.text = '보시는 것처럼 중국이 주도하는 알셉(RCEP), 즉 역내포괄적경제동반자협정의 참여국들과도 맞물려 있는데요.';
let scriptTest105_8 = new Script_1.Script();
scriptTest105_8.startTime = new Time_1.Time(60, 35);
scriptTest105_8.endTime = new Time_1.Time(71, 19);
scriptTest105_8.text = '때문에 IPEF의 출범이 인도 태평양 지역에서 중국의 영향력 확대를 억제하기 위한 미국의 \'대중국 견제\'의 성격을 띠고 있다는 평가도 나옵니다.';
let scriptTest105_9 = new Script_1.Script();
scriptTest105_9.startTime = new Time_1.Time(71, 19);
scriptTest105_9.endTime = new Time_1.Time(80, 8);
scriptTest105_9.text = '윤석열 대통령은 이번 한미 정상회담을 계기로 IPEF에서 주도적인 역할을 하겠다는 방침을 확고하게 밝힌 바가 있죠.';
let scriptTest105_10 = new Script_1.Script();
scriptTest105_10.startTime = new Time_1.Time(80, 8);
scriptTest105_10.endTime = new Time_1.Time(88, 16);
scriptTest105_10.text = '윤 대통령은 오늘 열린 IPEF 고위급 화상회의에 참석해 13개국 중 5번째로 발언했습니다.';
let scriptTest105_11 = new Script_1.Script();
scriptTest105_11.startTime = new Time_1.Time(88, 16);
scriptTest105_11.endTime = new Time_1.Time(98, 86);
scriptTest105_11.text = '출범식 성격의 이날 회의에서는, 한국에 이어서 일본과의 정상회담을 마친 조 바이든 미국 대통령이 IPEF 출범을 공식 선언했는데요.';
let scriptTest105_12 = new Script_1.Script();
scriptTest105_12.startTime = new Time_1.Time(98, 86);
scriptTest105_12.endTime = new Time_1.Time(102, 72);
scriptTest105_12.text = '중국은 불편한 속내를 감추지 않고 있습니다.';
let scriptTest105_13 = new Script_1.Script();
scriptTest105_13.startTime = new Time_1.Time(102, 72);
scriptTest105_13.endTime = new Time_1.Time(115, 3);
scriptTest105_13.text = '왕이 중국 외교부장은 어제 "분열과 대항을 만드는 도모에는 반대한다"면서 IPEF에 대해 "미국의 지역 경제 패권을 지키는 정치적 도구"라고 견제했습니다.';
let scriptTest105_14 = new Script_1.Script();
scriptTest105_14.startTime = new Time_1.Time(115, 3);
scriptTest105_14.endTime = new Time_1.Time(122, 54);
scriptTest105_14.text = '우리나라의 IPEF 참여가 중국과 외교적, 경제적 마찰을 초래하는 것 아니냐 하는 우려도 나오는데요.';
let scriptTest105_15 = new Script_1.Script();
scriptTest105_15.startTime = new Time_1.Time(122, 54);
scriptTest105_15.endTime = new Time_1.Time(136, 48);
...
// 106번 뉴스
let tagTest106_1 = new Tag_1.Tag();
tagTest106_1.name = '북한';
let tagTest106_2 = new Tag_1.Tag();
tagTest106_2.name = '남북연락사무소';
let tagTest106_3 = new Tag_1.Tag();
tagTest106_3.name = '폐쇄';
let scriptTest106_1 = new Script_1.Script();
scriptTest106_1.startTime = new Time_1.Time(0, 0);
scriptTest106_1.endTime = new Time_1.Time(1, 12);
scriptTest106_1.text = '다음 소식입니다.';
let scriptTest106_2 = new Script_1.Script();
scriptTest106_2.startTime = new Time_1.Time(1, 12);
scriptTest106_2.endTime = new Time_1.Time(7, 71);
scriptTest106_2.text = '지난주 북한 김여정이 남북연락사무소 폐쇄를 공언했는데, 오늘 우여곡절이 있었습니다.';
let scriptTest106_3 = new Script_1.Script();
scriptTest106_3.startTime = new Time_1.Time(7, 71);
scriptTest106_3.endTime = new Time_1.Time(15, 72);
scriptTest106_3.text = '오전에 북측이 우리 전화를 받지 않아 폐쇄에 들어가는 거냐는 관측이 나온 것인데, 오후에는 다시 통화가 됐습니다.';
let scriptTest106_4 = new Script_1.Script();
scriptTest106_4.startTime = new Time_1.Time(15, 72);
scriptTest106_4.endTime = new Time_1.Time(18, 95);
scriptTest106_4.text = '북한의 속내가 뭔지 좀 더 관찰이 필요해 보입니다.';
let scriptTest106_5 = new Script_1.Script();
scriptTest106_5.startTime = new Time_1.Time(18, 95);
scriptTest106_5.endTime = new Time_1.Time(21, 82);
scriptTest106_5.text = '안정식 북한전문기자입니다.';
// 107번 뉴스
let tagTest107_1 = new Tag_1.Tag();
tagTest107_1.name = '바이든';
let tagTest107_2 = new Tag_1.Tag();
tagTest107_2.name = '트럼프';
let tagTest107_3 = new Tag_1.Tag();
tagTest107_3.name = '의혹';
let scriptTest107_1 = new Script_1.Script();
scriptTest107_1.startTime = new Time_1.Time(0, 0);
scriptTest107_1.endTime = new Time_1.Time(5, 21);
scriptTest107_1.text = '지금부터는 코앞으로 다가온 미국 대통령 선거 이야기를 좀 해보겠습니다.';
let scriptTest107_2 = new Script_1.Script();
scriptTest107_2.startTime = new Time_1.Time(5, 21);
scriptTest107_2.endTime = new Time_1.Time(13, 54);
scriptTest107_2.text = 'TV 검증 무대에서, 민주당 조 바이든 후보의 시청률이 공화당 도널드 트럼프 대통령보다 높았던 것으로 나타났습니다.';
let scriptTest107_3 = new Script_1.Script();
scriptTest107_3.startTime = new Time_1.Time(13, 54);
scriptTest107_3.endTime = new Time_1.Time(20, 63);
scriptTest107_3.text = '바이든 후보 측은 반색했지만, 차남을 둘러싼 의혹이 언론보도로 다시 불거지면서 곤혹스러운 상황이 됐는데요.';
let scriptTest107_4 = new Script_1.Script();
scriptTest107_4.startTime = new Time_1.Time(20, 63);
scriptTest107_4.endTime = new Time_1.Time(23, 58);
scriptTest107_4.text = '워싱턴에서 임종주 특파원이 보도합니다.';
// 108번 뉴스
let tagTest108_1 = new Tag_1.Tag();
tagTest108_1.name = '반도체';
let tagTest108_2 = new Tag_1.Tag();
tagTest108_2.name = '인재양성';
let tagTest108_3 = new Tag_1.Tag();
tagTest108_3.name = '정원증원';
let scriptTest108_1 = new Script_1.Script();
scriptTest108_1.startTime = new Time_1.Time(0, 0);
scriptTest108_1.endTime = new Time_1.Time(12, 67);
scriptTest108_1.text = '자, 이렇게 당장은 쉽지 않을 거라는 전망이 많지만, 그래도 정부는 반도체 산업이 우리 미래의 먹거리가 될 거라고 보고, 2031년까지 15만 명을 양성하기로 했습니다.';
let scriptTest108_2 = new Script_1.Script();
scriptTest108_2.startTime = new Time_1.Time(12, 67);
scriptTest108_2.endTime = new Time_1.Time(19, 6);
scriptTest108_2.text = '그러기 위해서 반도체를 배울 수 있는 대학의 학과 정원을 2천 명까지 늘리기로 했습니다.';
let scriptTest108_3 = new Script_1.Script();
scriptTest108_3.startTime = new Time_1.Time(19, 6);
scriptTest108_3.endTime = new Time_1.Time(21, 58);
scriptTest108_3.text = '이 내용은 김경희 기자가 전하겠습니다.';
// 109번 뉴스
let tagTest109_1 = new Tag_1.Tag();
tagTest109_1.name = '우상혁';
let tagTest109_2 = new Tag_1.Tag();
tagTest109_2.name = '높이뛰기';
let tagTest109_3 = new Tag_1.Tag();
tagTest109_3.name = '은메달';
let scriptTest109_1 = new Script_1.Script();
scriptTest109_1.startTime = new Time_1.Time(0, 0);
scriptTest109_1.endTime = new Time_1.Time(2, 4);
scriptTest109_1.text = '다음 소식 이어가겠습니다.';
let scriptTest109_2 = new Script_1.Script();
scriptTest109_2.startTime = new Time_1.Time(2, 4);
scriptTest109_2.endTime = new Time_1.Time(9, 2);
scriptTest109_2.text = '세계육상선수권대회 높이뛰기에서 우리나라 우상혁 선수가 사상 처음으로 2위에 올랐습니다.';
let scriptTest109_3 = new Script_1.Script();
scriptTest109_3.startTime = new Time_1.Time(9, 2);
scriptTest109_3.endTime = new Time_1.Time(16, 18);
scriptTest109_3.text = '자기 키보다 50cm 정도 높은 2m 35cm를 훌쩍 뛰어넘었습니다.';
let scriptTest109_4 = new Script_1.Script();
scriptTest109_4.startTime = new Time_1.Time(16, 18);
scriptTest109_4.endTime = new Time_1.Time(24, 3);
scriptTest109_4.text = '우상혁 선수는 지난 도쿄올림픽 때와 마찬가지로 오늘도 표정에는 자신감이 넘쳤고, 경기 그 자체를 즐겼습니다.';
let scriptTest109_5 = new Script_1.Script();
scriptTest109_5.startTime = new Time_1.Time(24, 3);
scriptTest109_5.endTime = new Time_1.Time(26, 46);
scriptTest109_5.text = '먼저 배정훈 기자입니다.';
// 110번 뉴스
let tagTest110_1 = new Tag_1.Tag();
tagTest110_1.name = '시각장애인';
let tagTest110_2 = new Tag_1.Tag();
tagTest110_2.name = '안내견';
let tagTest110_3 = new Tag_1.Tag();
tagTest110_3.name = '출입거부';
let scriptTest110_1 = new Script_1.Script();
scriptTest110_1.startTime = new Time_1.Time(8, 98);
scriptTest110_1.endTime = new Time_1.Time(13, 55);
scriptTest110_1.text = '오픈마이크, 이번 주 다음 주는 장애인을 돕는 \'도우미견\' 이야기를 해보겠습니다.';
let scriptTest110_2 = new Script_1.Script();
scriptTest110_2.startTime = new Time_1.Time(13, 55);
scriptTest110_2.endTime = new Time_1.Time(15, 47);
scriptTest110_2.text = '먼저 시각장애인 안내견입니다.';
let scriptTest110_3 = new Script_1.Script();
scriptTest110_3.startTime = new Time_1.Time(16, 11);
scriptTest110_3.endTime = new Time_1.Time(25, 98);
scriptTest110_3.text = '흰 지팡이는 이렇게 짚고 다녀야 한다면, 안내견은 \'엘리베이터 찾아줘\' 이렇게 뭘 찾아달라 하면 그게 어디 있는지 대신 보고, 길을 안내해 줍니다.';
let scriptTest110_4 = new Script_1.Script();
scriptTest110_4.startTime = new Time_1.Time(25, 98);
scriptTest110_4.endTime = new Time_1.Time(29, 33);
scriptTest110_4.text = '그야말로 시각장애인의 \'눈\'이 돼주는 존재들이죠.';
let scriptTest110_5 = new Script_1.Script();
scriptTest110_5.startTime = new Time_1.Time(29, 33);
scriptTest110_5.endTime = new Time_1.Time(37, 12);
scriptTest110_5.text = '이런 안내견들은 어디든 갈 수 있도록 법으로 보장해 놓은 지도 20년인데, 여전히 여기저기서 출입을 거부당하고 있습니다.';
let scriptTest110_6 = new Script_1.Script();
scriptTest110_6.startTime = new Time_1.Time(37, 12);
scriptTest110_6.endTime = new Time_1.Time(39, 74);
scriptTest110_6.text = '안내견의 하루를 함께 해봤습니다.';
// 111번 뉴스
let tagTest111_1 = new Tag_1.Tag();
tagTest111_1.name = '프로파일러';
let tagTest111_2 = new Tag_1.Tag();
tagTest111_2.name = '직위해제';
let tagTest111_3 = new Tag_1.Tag();
tagTest111_3.name = '피의자';
let scriptTest111_1 = new Script_1.Script();
scriptTest111_1.startTime = new Time_1.Time(0, 0);
scriptTest111_1.endTime = new Time_1.Time(7, 33);
scriptTest111_1.text = '민간 학술 단체에서 활동하며 허가 없이 돈을 번 정황이 드러난 프로파일러가 형사 입건됐습니다.';
let scriptTest111_2 = new Script_1.Script();
scriptTest111_2.startTime = new Time_1.Time(7, 33);
scriptTest111_2.endTime = new Time_1.Time(20, 72);
...
let scriptTest111_3 = new Script_1.Script();
scriptTest111_3.startTime = new Time_1.Time(20, 72);
scriptTest111_3.endTime = new Time_1.Time(33, 7);
scriptTest111_3.text = '법 최면 수사 전문가로 알려진 A 경위는 2013년부터 \'임상 최면사\' 자격증 발급을 빌미로 돈을 받고 여성 제자들을 상대로 성범죄를 저질렀다는 의혹도 제기된 상탭니다.';
let scriptTest111_4 = new Script_1.Script();
scriptTest111_4.startTime = new Time_1.Time(33, 7);
scriptTest111_4.endTime = new Time_1.Time(37, 84);
scriptTest111_4.text = 'A 경위는 혐의를 일부 부인하는 입장인 것으로 알려졌습니다.';
// 112번 뉴스
let tagTest112_1 = new Tag_1.Tag();
tagTest112_1.name = '여권';
let tagTest112_2 = new Tag_1.Tag();
tagTest112_2.name = '국제순위';
let tagTest112_3 = new Tag_1.Tag();
tagTest112_3.name = '싱가포르';
let scriptTest112_1 = new Script_1.Script();
scriptTest112_1.startTime = new Time_1.Time(0, 0);
scriptTest112_1.endTime = new Time_1.Time(12, 55);
scriptTest112_1.text = '우리나라 여권을 가지면 무비자나 도착비자 등으로 쉽게 입국할 수 있는 국가와 속령이 192곳으로 집계됐다고 영국 국제교류 전문업체 헨리앤드파트너스가 발표했습니다.';
let scriptTest112_2 = new Script_1.Script();
scriptTest112_2.startTime = new Time_1.Time(12, 55);
scriptTest112_2.endTime = new Time_1.Time(18, 98);
scriptTest112_2.text = '해당 업체가 매긴 분기별 여권 지수 국제 순위에서 우리나라 여권은 세계 2위에 올랐습니다.';
let scriptTest112_3 = new Script_1.Script();
scriptTest112_3.startTime = new Time_1.Time(18, 98);
scriptTest112_3.endTime = new Time_1.Time(28, 76);
scriptTest112_3.text = '1위에 오른 나라는 일본으로, 간편 입국 가능 국가나 속령이 193개였고, 싱가포르가 우리나라와 함께 여권 지수 순위 공동 2위에 올랐습니다.';
let scriptTest112_4 = new Script_1.Script();
scriptTest112_4.startTime = new Time_1.Time(28, 76);
scriptTest112_4.endTime = new Time_1.Time(38, 95);
scriptTest112_4.text = '우리나라 여권은 해당 순위에서 2013년 13위까지 떨어진 후 2018년부터 2~3위 최상위권을 꾸준히 유지하고 있습니다';
// 113번 뉴스
let tagTest113_1 = new Tag_1.Tag();
tagTest113_1.name = '미국';
let tagTest113_2 = new Tag_1.Tag();
tagTest113_2.name = '텍사스총격사건';
let tagTest113_3 = new Tag_1.Tag();
tagTest113_3.name = '부실대응';
let scriptTest113_1 = new Script_1.Script();
scriptTest113_1.startTime = new Time_1.Time(0, 0);
scriptTest113_1.endTime = new Time_1.Time(7, 70);
scriptTest113_1.text = '열아홉 명의 어린이를 비롯해서 모두 스물한 명의 생명을 앗아간 미국 텍사스 초등학교 총격 사건.';
let scriptTest113_2 = new Script_1.Script();
scriptTest113_2.startTime = new Time_1.Time(7, 70);
scriptTest113_2.endTime = new Time_1.Time(15, 56);
scriptTest113_2.text = '당시 300명이 넘는 경찰이 현장에 출동했는데, 경찰의 대응이 완전히 실패했다는 조사 결과가 나왔습니다.';
let scriptTest113_3 = new Script_1.Script();
scriptTest113_3.startTime = new Time_1.Time(15, 56);
scriptTest113_3.endTime = new Time_1.Time(23, 69);
scriptTest113_3.text = '경찰들의 몸에 붙이고 있던 카메라 영상이 새롭게 공개가 됐는데요, 당시 경찰의 대응이 얼마나 부실했는지 담겨있습니다.';
let scriptTest113_4 = new Script_1.Script();
scriptTest113_4.startTime = new Time_1.Time(23, 69);
scriptTest113_4.endTime = new Time_1.Time(25, 72);
scriptTest113_4.text = '박소희 기자가 전해드리겠습니다.';
// 114번 뉴스
let tagTest114_1 = new Tag_1.Tag();
tagTest114_1.name = '유희열';
let tagTest114_2 = new Tag_1.Tag();
tagTest114_2.name = '표절논란';
let tagTest114_3 = new Tag_1.Tag();
tagTest114_3.name = '하차';
let scriptTest114_1 = new Script_1.Script();
scriptTest114_1.startTime = new Time_1.Time(0, 0);
scriptTest114_1.endTime = new Time_1.Time(7, 38);
scriptTest114_1.text = '가수이자 작곡가인 유희열 씨가 13년간 자신의 이름을 걸고 진행해 온 음악 프로그램에서 하차했습니다.';
let scriptTest114_2 = new Script_1.Script();
scriptTest114_2.startTime = new Time_1.Time(7, 38);
scriptTest114_2.endTime = new Time_1.Time(10, 34);
scriptTest114_2.text = '표절 논란이 불거진 지 약 한 달 만인데요.';
let scriptTest114_3 = new Script_1.Script();
scriptTest114_3.startTime = new Time_1.Time(10, 34);
scriptTest114_3.endTime = new Time_1.Time(18, 85);
scriptTest114_3.text = '최근 연이어 제기되고 있는 표절 의혹들에 대해서는 동의하기 어려운 부분도 있다면서도 자신을 더 엄격히 살피겠다고 밝혔습니다.';
let scriptTest114_4 = new Script_1.Script();
scriptTest114_4.startTime = new Time_1.Time(18, 85);
scriptTest114_4.endTime = new Time_1.Time(21, 44);
scriptTest114_4.text = '김정인 기자가 전해드립니다.';
// 115번 뉴스
let tagTest115_1 = new Tag_1.Tag();
tagTest115_1.name = '아베';
let tagTest115_2 = new Tag_1.Tag();
tagTest115_2.name = '총격범';
let tagTest115_3 = new Tag_1.Tag();
tagTest115_3.name = '통일교';
let scriptTest115_1 = new Script_1.Script();
scriptTest115_1.startTime = new Time_1.Time(0, 0);
scriptTest115_1.endTime = new Time_1.Time(8, 70);
scriptTest115_1.text = '아베 전 총리를 살해한 범인이 아베가 어머니가 빠진 종교 단체랑 관련이 있어서라고 범행 동기를 밝혔죠.';
let scriptTest115_2 = new Script_1.Script();
scriptTest115_2.startTime = new Time_1.Time(8, 70);
scriptTest115_2.endTime = new Time_1.Time(13, 48);
scriptTest115_2.text = '그런데 이 특정 종교 단체가 통일교였던 것으로 확인이 됐습니다.';
let scriptTest115_3 = new Script_1.Script();
scriptTest115_3.startTime = new Time_1.Time(13, 48);
scriptTest115_3.endTime = new Time_1.Time(19, 89);
scriptTest115_3.text = '범행을 하기 하루 전날 범인이 통일교 건물을 향해서 시험 발사를 했던 사실도 드러났습니다.';
let scriptTest115_4 = new Script_1.Script();
scriptTest115_4.startTime = new Time_1.Time(19, 89);
scriptTest115_4.endTime = new Time_1.Time(22, 0);
scriptTest115_4.text = '이필희 기자가 취재했습니다.';
// 116번 뉴스
let tagTest116_1 = new Tag_1.Tag();
tagTest116_1.name = '지방선거';
let tagTest116_2 = new Tag_1.Tag();
tagTest116_2.name = '최연소';
let tagTest116_3 = new Tag_1.Tag();
tagTest116_3.name = '청년정치인';
let scriptTest116_1 = new Script_1.Script();
scriptTest116_1.startTime = new Time_1.Time(0, 0);
scriptTest116_1.endTime = new Time_1.Time(4, 92);
scriptTest116_1.text = '공직선거에 출마할 수 있는 연령이 만 18살로 낮아졌죠.';
let scriptTest116_2 = new Script_1.Script();
scriptTest116_2.startTime = new Time_1.Time(4, 92);
scriptTest116_2.endTime = new Time_1.Time(11, 83);
scriptTest116_2.text = '그 첫 선거였던 이번 지방선거에서 20대 초중반은 물론 10대 후반 당선인도 나왔습니다.';
let scriptTest116_3 = new Script_1.Script();
scriptTest116_3.startTime = new Time_1.Time(11, 83);
scriptTest116_3.endTime = new Time_1.Time(19, 5);
scriptTest116_3.text = '청년 세대의 목소리를 대변하고 정치도 바꾸고 싶다는 젊은 당선인들을 김건휘 기자가 만나봤습니다.';
// 117번 뉴스
let tagTest117_1 = new Tag_1.Tag();
tagTest117_1.name = '송영길';
let tagTest117_2 = new Tag_1.Tag();
tagTest117_2.name = '서울시장';
let tagTest117_3 = new Tag_1.Tag();
tagTest117_3.name = '지방선거';
let scriptTest117_1 = new Script_1.Script();
scriptTest117_1.startTime = new Time_1.Time(0, 0);
scriptTest117_1.endTime = new Time_1.Time(5, 67);
scriptTest117_1.text = '더불어민주당의 6.1 지방선거 서울시장 후보로 송영길 전 대표가 선출됐습니다.';
let scriptTest117_2 = new Script_1.Script();
scriptTest117_2.startTime = new Time_1.Time(5, 67);
scriptTest117_2.endTime = new Time_1.Time(16, 12);
scriptTest117_2.text = '민주당 중앙당 선거관리위원회는 송 전 대표와 김진애 전 의원을 상대로 한 국민 여론 조사 결과 송영길 전 대표가 서울시장 후보로 결정됐다고 밝혔습니다.';
let scriptTest117_3 = new Script_1.Script();
scriptTest117_3.startTime = new Time_1.Time(16, 12);
scriptTest117_3.endTime = new Time_1.Time(23, 36);
scriptTest117_3.text = '이로써 송영길 전 대표는 이번 선거에서 국민의힘 오세훈 현 서울시장과 맞붙게 됐습니다.';
// 118번 뉴스
let tagTest118_1 = new Tag_1.Tag();
tagTest118_1.name = '최저임금';
let tagTest118_2 = new Tag_1.Tag();
tagTest118_2.name = '차등적용';
let tagTest118_3 = new Tag_1.Tag();
tagTest118_3.name = '갈등';
let scriptTest118_1 = new Script_1.Script();
scriptTest118_1.startTime = new Time_1.Time(0, 0);
scriptTest118_1.endTime = new Time_1.Time(3, 24);
scriptTest118_1.text = '시간당 9천 160원.';
let scriptTest118_2 = new Script_1.Script();
scriptTest118_2.startTime = new Time_1.Time(3, 24);
scriptTest118_2.endTime = new Time_1.Time(7, 78);
scriptTest118_2.text = '현재 모든 사업장에 적용되고 있는 최저임금입니다.';
let scriptTest118_3 = new Script_1.Script();
scriptTest118_3.startTime = new Time_1.Time(7, 78);
scriptTest118_3.endTime = new Time_1.Time(21, 16);
scriptTest118_3.text = '새 정부 들어 처음으로 최저임금 문제를 논의할 최저임금위원회 2차 전원회의가 내일 열리는데 최저임금을 업종별로 차등 적용할지에 대한 논의가 있을지 주목됩니다.';
let scriptTest118_4 = new Script_1.Script();
scriptTest118_4.startTime = new Time_1.Time(21, 16);
scriptTest118_4.endTime = new Time_1.Time(32, 30);
scriptTest118_4.text = '윤석열 대통령은 지난 대선에서 최저임금의 \'차등 적용 검토\'를 언급한 바 있고, 추경호 기획재정부 장관도 도입 논의가 필요하다는 입장입니다.';
let scriptTest118_5 = new Script_1.Script();
scriptTest118_5.startTime = new Time_1.Time(32, 30);
scriptTest118_5.endTime = new Time_1.Time(35, 17);
scriptTest118_5.text = '과거 정부와는 사뭇 달라진 분위기인데요.';
let scriptTest118_6 = new Script_1.Script();
scriptTest118_6.startTime = new Time_1.Time(35, 17);
scriptTest118_6.endTime = new Time_1.Time(38, 88);
scriptTest118_6.text = '하지만 노동계는 반대 입장을 분명히 하고 있습니다.';
let scriptTest118_7 = new Script_1.Script();
scriptTest118_7.startTime = new Time_1.Time(38, 88);
scriptTest118_7.endTime = new Time_1.Time(47, 19);
scriptTest118_7.text = '최저임금제가 시행됐던 첫해인 1988년을 제외하면 그동안 차등 적용을 한 적이 없다고 밝히고 있습니다.';
let scriptTest118_8 = new Script_1.Script();
scriptTest118_8.startTime = new Time_1.Time(47, 19);
scriptTest118_8.endTime = new Time_1.Time(55, 74);
scriptTest118_8.text = '민주당의 한 의원은 최저임금 차등적용의 근거가 되는 법 조항을 아예 삭제하는 법안까지 발의했습니다.';
let scriptTest118_9 = new Script_1.Script();
scriptTest118_9.startTime = new Time_1.Time(55, 74);
scriptTest118_9.endTime = new Time_1.Time(58, 16);
scriptTest118_9.text = '홍성희 기자가 취재했습니다.';
// 119번 뉴스
let tagTest119_1 = new Tag_1.Tag();
tagTest119_1.name = '가상화폐';
let tagTest119_2 = new Tag_1.Tag();
tagTest119_2.name = '국세청';
let tagTest119_3 = new Tag_1.Tag();
tagTest119_3.name = '상속';
let scriptTest119_1 = new Script_1.Script();
scriptTest119_1.startTime = new Time_1.Time(0, 0);
scriptTest119_1.endTime = new Time_1.Time(11, 31);
scriptTest119_1.text = '내년부터 가상화폐 등 가상자산을 상속·증여받는 경우, 상속개시일이나 증여일 전·후 각 한 달 동안 평균액으로 재산을 평가해서 과세합니다.';
let scriptTest119_2 = new Script_1.Script();
scriptTest119_2.startTime = new Time_1.Time(11, 31);
scriptTest119_2.endTime = new Time_1.Time(22, 58);
scriptTest119_2.text = '국세청은 오늘 가상자산을 상속·증여할 때 재산 평가를 위한 가상자산사업자 4곳을 고시하고 내년부터 평가액 산정 방법이 변경된다고 밝혔습니다.';
let scriptTest119_3 = new Script_1.Script();
scriptTest119_3.startTime = new Time_1.Time(22, 58);
scriptTest119_3.endTime = new Time_1.Time(28, 81);
scriptTest119_3.text = '가상자산사업자는 두나무와 빗썸코리아, 코빗과 코인원 등 4곳입니다.';
let scriptTest119_4 = new Script_1.Script();
scriptTest119_4.startTime = new Time_1.Time(28, 81);
scriptTest119_4.endTime = new Time_1.Time(39, 92);
scriptTest119_4.text = '가상자산에 대한 소득세 과세는 2023년 이후로 연기됐지만, 이와는 별개로 가상자산을 상속·증여받는 경우엔 상속·증여세가 부과됩니다.';
// 120번 뉴스
let tagTest120_1 = new Tag_1.Tag();
tagTest120_1.name = '외식물가';
let tagTest120_2 = new Tag_1.Tag();
tagTest120_2.name = '가격공개';
let tagTest120_3 = new Tag_1.Tag();
tagTest120_3.name = '물가상승';
let scriptTest120_1 = new Script_1.Script();
scriptTest120_1.startTime = new Time_1.Time(0, 0);
scriptTest120_1.endTime = new Time_1.Time(4, 10);
scriptTest120_1.text = '새우깡 한 봉지, 이제 100원 정도 비싸집니다.';
let scriptTest120_2 = new Script_1.Script();
scriptTest120_2.startTime = new Time_1.Time(4, 10);
scriptTest120_2.endTime = new Time_1.Time(8, 23);
scriptTest120_2.text = '농심이 과자 22개 값을 평균 6% 올리기로 한 겁니다.';
let scriptTest120_3 = new Script_1.Script();
scriptTest120_3.startTime = new Time_1.Time(8, 23);
scriptTest120_3.endTime = new Time_1.Time(14, 84);
scriptTest120_3.text = '참이슬 출고 가격도 오늘부터 올라서 식당 소주 5~6천 원 시대가 올 거란 예상이 나옵니다.';
let scriptTest120_4 = new Script_1.Script();
scriptTest120_4.startTime = new Time_1.Time(14, 84);
scriptTest120_4.endTime = new Time_1.Time(16, 50);
scriptTest120_4.text = '이뿐만이 아닙니다.';
let scriptTest120_5 = new Script_1.Script();
scriptTest120_5.startTime = new Time_1.Time(16, 50);
scriptTest120_5.endTime = new Time_1.Time(23, 50);
scriptTest120_5.text = '서울에서 냉면 한 그릇 사 먹으려면 평균 만 원 가까이 내야 하고, 김치찌개 값은 7,000원 정돕니다.';
let scriptTest120_6 = new Script_1.Script();
scriptTest120_6.startTime = new Time_1.Time(23, 50);
scriptTest120_6.endTime = new Time_1.Time(29, 69);
scriptTest120_6.text = '김밥도 한 줄에 2,700원 수준, 이제 1,000원 김밥은 찾아보기 어렵습니다.';
let scriptTest120_7 = new Script_1.Script();
scriptTest120_7.startTime = new Time_1.Time(29, 69);
scriptTest120_7.endTime = new Time_1.Time(39, 82);
scriptTest120_7.text = '이렇게 최근 계속 오르고 있는 먹을거리 물가, 특히 치솟는 외식 물가를 잡겠다는 취지로 정부가 오늘부터 매주 주요 음식 가격을 공개하기로 했습니다.';
let scriptTest120_8 = new Script_1.Script();
scriptTest120_8.startTime = new Time_1.Time(39, 82);
scriptTest120_8.endTime = new Time_1.Time(42, 75);
scriptTest120_8.text = '고아름 기자 보시고 더 들여다보겠습니다.';
// 121번 뉴스
let tagTest121_1 = new Tag_1.Tag();
tagTest121_1.name = '배달비';
let tagTest121_2 = new Tag_1.Tag();
tagTest121_2.name = '자엽업자';
let tagTest121_3 = new Tag_1.Tag();
tagTest121_3.name = '경쟁';
let scriptTest121_1 = new Script_1.Script();
scriptTest121_1.startTime = new Time_1.Time(0, 0);
scriptTest121_1.endTime = new Time_1.Time(8, 5);
scriptTest121_1.text = '날이 궂으면 음식 배달비가 만 원까지 올라가자 정부가 배달비를 공개해서 경쟁을 유도하기로 했습니다.';
let scriptTest121_2 = new Script_1.Script();
scriptTest121_2.startTime = new Time_1.Time(8, 5);
scriptTest121_2.endTime = new Time_1.Time(17, 29);
scriptTest121_2.text = '그런데 실제로 누가 얼마나 부담하는지 들여다보면 정부가 의도한 대로 효과를 낼 수 있을지 장담하기 어렵습니다.';
let scriptTest121_3 = new Script_1.Script();
scriptTest121_3.startTime = new Time_1.Time(17, 29);
scriptTest121_3.endTime = new Time_1.Time(19, 3);
scriptTest121_3.text = '임경아 기자입니다.';
// 122번 뉴스
let tagTest122_1 = new Tag_1.Tag();
tagTest122_1.name = 'NFT';
let tagTest122_2 = new Tag_1.Tag();
tagTest122_2.name = '디지털작품';
let tagTest122_3 = new Tag_1.Tag();
tagTest122_3.name = '투자';
let scriptTest122_1 = new Script_1.Script();
scriptTest122_1.startTime = new Time_1.Time(0, 0);
scriptTest122_1.endTime = new Time_1.Time(4, 73);
scriptTest122_1.text = '거대한 괴물, 미사일이 쏟아지는 붉은 하늘.';
let scriptTest122_2 = new Script_1.Script();
scriptTest122_2.startTime = new Time_1.Time(4, 73);
scriptTest122_2.endTime = new Time_1.Time(9, 46);
scriptTest122_2.text = '한 구석에서는 어른과 아이가 손을 잡고 몸을 피하고 있죠.';
let scriptTest122_3 = new Script_1.Script();
scriptTest122_3.startTime = new Time_1.Time(9, 46);
scriptTest122_3.endTime = new Time_1.Time(12, 91);
scriptTest122_3.text = '침공 소식을 전하는 BBC 뉴스 화면도 보이는데요.';
let scriptTest122_4 = new Script_1.Script();
scriptTest122_4.startTime = new Time_1.Time(12, 91);
scriptTest122_4.endTime = new Time_1.Time(18, 33);
scriptTest122_4.text = '러시아가 우크라이나를 침공한 2월 24일 새벽 5시 45분.';
let scriptTest122_5 = new Script_1.Script();
scriptTest122_5.startTime = new Time_1.Time(18, 33);
scriptTest122_5.endTime = new Time_1.Time(20, 74);
scriptTest122_5.text = '그 순간을 보여주는 작품입니다.';
let scriptTest122_6 = new Script_1.Script();
scriptTest122_6.startTime = new Time_1.Time(20, 74);
scriptTest122_6.endTime = new Time_1.Time(26, 39);
scriptTest122_6.text = '이 작품은 우크라이나 정부가 기부금을 모으려고 만든 디지털 예술 작품인데요.';
let scriptTest122_7 = new Script_1.Script();
scriptTest122_7.startTime = new Time_1.Time(26, 39);
scriptTest122_7.endTime = new Time_1.Time(34, 68);
scriptTest122_7.text = '가짜가 아니라 진품이라는 걸 증명하기 위해서 NFT, 그러니까 암호 기술로 만든 꼬리표를 붙였습니다.';
let scriptTest122_8 = new Script_1.Script();
scriptTest122_8.startTime = new Time_1.Time(34, 68);
scriptTest122_8.endTime = new Time_1.Time(43, 58);
scriptTest122_8.text = '이 작품은 60만 원에 팔렸는데 우크라이나 정부는 하루 만에 54종류의 디지털 작품을 팔아서 7억 원이나 모았습니다.';
let scriptTest122_9 = new Script_1.Script();
scriptTest122_9.startTime = new Time_1.Time(43, 58);
scriptTest122_9.endTime = new Time_1.Time(47, 79);
scriptTest122_9.text = '우크라이나를 도우려는 전 세계 사람들이 이 작품을 사준 건데요.';
let scriptTest122_10 = new Script_1.Script();
scriptTest122_10.startTime = new Time_1.Time(47, 79);
scriptTest122_10.endTime = new Time_1.Time(55, 23);
scriptTest122_10.text = '지불은 암호화폐, 이더리움으로 하고 우크라이나 정부가 개설한 암호화폐 지갑으로 입금이 되는 겁니다.';
let scriptTest122_11 = new Script_1.Script();
scriptTest122_11.startTime = new Time_1.Time(55, 23);
scriptTest122_11.endTime = new Time_1.Time(58, 28);
scriptTest122_11.text = '하지만 가짜도 돌아다닙니다.';
let scriptTest122_12 = new Script_1.Script();
scriptTest122_12.startTime = new Time_1.Time(58, 28);
scriptTest122_12.endTime = new Time_1.Time(64, 76);
scriptTest122_12.text = '디지털 작품을 복제해서 우크라이나 정부를 사칭한 가짜 NFT 꼬리표를 붙여서 파는 건데요.';
let scriptTest122_13 = new Script_1.Script();
scriptTest122_13.startTime = new Time_1.Time(64, 76);
scriptTest122_13.endTime = new Time_1.Time(70, 6);
scriptTest122_13.text = '우크라이나 정부는 공식 사이트에서만 구매할 수 있다 이렇게 당부까지 했습니다.';
let scriptTest122_14 = new Script_1.Script();
scriptTest122_14.startTime = new Time_1.Time(70, 6);
scriptTest122_14.endTime = new Time_1.Time(76, 1);
scriptTest122_14.text = '그러니까 NFT가 붙어 있다고 해서 다 믿을 수 있는 건 아니라는 뜻입니다.';
let scriptTest122_15 = new Script_1.Script();
scriptTest122_15.startTime = new Time_1.Time(76, 1);
scriptTest122_15.endTime = new Time_1.Time(83, 41);
scriptTest122_15.text = '폭발적으로 성장하고 있는 NFT의 세계, 큰돈이 몰려들고 있지만 위험도 도사리고 있습니다.';
let scriptTest122_16 = new Script_1.Script();
scriptTest122_16.startTime = new Time_1.Time(83, 41);
scriptTest122_16.endTime = new Time_1.Time(86, 4);
scriptTest122_16.text = '김아영 기자가 전해드리겠습니다.';
// 123번 뉴스
let tagTest123_1 = new Tag_1.Tag();
tagTest123_1.name = '엔디비아';
let tagTest123_2 = new Tag_1.Tag();
tagTest123_2.name = 'ARM';
let tagTest123_3 = new Tag_1.Tag();
tagTest123_3.name = '인수';
let scriptTest123_1 = new Script_1.Script();
scriptTest123_1.startTime = new Time_1.Time(0, 0);
scriptTest123_1.endTime = new Time_1.Time(5, 76);
scriptTest123_1.text = '화웨이 거래 중단만큼이나 우리 반도체 업체가 촉각을 곤두세우는 소식이 또 있습니다.';
let scriptTest123_2 = new Script_1.Script();
scriptTest123_2.startTime = new Time_1.Time(5, 76);
scriptTest123_2.endTime = new Time_1.Time(9, 69);
scriptTest123_2.text = '반도체 업계의 사상 최대 규모의 인수합병인데요.';
let scriptTest123_3 = new Script_1.Script();
scriptTest123_3.startTime = new Time_1.Time(9, 69);
scriptTest123_3.endTime = new Time_1.Time(19, 22);
scriptTest123_3.text = '그래픽 칩 세계 1위 회사인 엔비디아가 반도체를 설계하는 1위 회사인 ARM이라는 회사를 47조 원에 인수하기로 한 겁니다.';
let scriptTest123_4 = new Script_1.Script();
scriptTest123_4.startTime = new Time_1.Time(19, 22);
scriptTest123_4.endTime = new Time_1.Time(30, 95);
scriptTest123_4.text = '이 ARM이라는 회사는 반도체 설계도를 만들어서 삼성, 애플 같은 기업에 파는데 스마트폰에 들어가는 반도체의 95%가 이 회사 설계를 바탕으로 하고 있습니다.';
let scriptTest123_5 = new Script_1.Script();
scriptTest123_5.startTime = new Time_1.Time(30, 95);
scriptTest123_5.endTime = new Time_1.Time(38, 21);
scriptTest123_5.text = '문제는 이런 ARM을 인수한 곳이 삼성전자처럼 칩을 만드는 경쟁 회사라는 점입니다.';
let scriptTest123_6 = new Script_1.Script();
scriptTest123_6.startTime = new Time_1.Time(38, 21);
scriptTest123_6.endTime = new Time_1.Time(43, 33);
scriptTest123_6.text = '앞으로 불리한 일이 생길 수 있다는 걱정이 나오는데요, 이성훈 기자가 전해드립니다.';
// 124번 뉴스
let tagTest124_1 = new Tag_1.Tag();
tagTest124_1.name = '토스';
let tagTest124_2 = new Tag_1.Tag();
tagTest124_2.name = '간편결제';
let tagTest124_3 = new Tag_1.Tag();
tagTest124_3.name = '피해';
let scriptTest124_1 = new Script_1.Script();
scriptTest124_1.startTime = new Time_1.Time(0, 0);
scriptTest124_1.endTime = new Time_1.Time(6, 2);
scriptTest124_1.text = '온라인 금융서비스 토스에서 본인도 모르게 결제가 이루어지는 사고가 발생했습니다.';
let scriptTest124_2 = new Script_1.Script();
scriptTest124_2.startTime = new Time_1.Time(6, 2);
scriptTest124_2.endTime = new Time_1.Time(16, 74);
scriptTest124_2.text = '토스에 따르면 지난 6월 3일 토스 간편 결제 서비스를 이용하는 고객 8명이 일부 온라인 사이트에서 자신도 모르게 900여만 원이 결제되는 피해를 입었습니다.';
let scriptTest124_3 = new Script_1.Script();
scriptTest124_3.startTime = new Time_1.Time(16, 74);
scriptTest124_3.endTime = new Time_1.Time(31, 69);
...
// 125번 뉴스
let tagTest125_1 = new Tag_1.Tag();
tagTest125_1.name = '카드번호';
let tagTest125_2 = new Tag_1.Tag();
tagTest125_2.name = '보안코드';
let tagTest125_3 = new Tag_1.Tag();
tagTest125_3.name = '금융';
let scriptTest125_1 = new Script_1.Script();
scriptTest125_1.startTime = new Time_1.Time(0, 0);
scriptTest125_1.endTime = new Time_1.Time(7, 44);
scriptTest125_1.text = '보통 신용카드 앞면에는 카드 번호가, 뒷면에는 \'CVV, CVC\'라고 하는 보안 코드가 있죠.';
let scriptTest125_2 = new Script_1.Script();
scriptTest125_2.startTime = new Time_1.Time(7, 44);
scriptTest125_2.endTime = new Time_1.Time(11, 14);
scriptTest125_2.text = '이러한 정보들이 빠진 카드가 속속 등장하고 있습니다.';
let scriptTest125_3 = new Script_1.Script();
scriptTest125_3.startTime = new Time_1.Time(12, 32);
scriptTest125_3.endTime = new Time_1.Time(16, 54);
scriptTest125_3.text = '최근 출범한 인터넷전문은행, \'토스뱅크\'의 체크카든데요.';
let scriptTest125_4 = new Script_1.Script();
scriptTest125_4.startTime = new Time_1.Time(16, 54);
scriptTest125_4.endTime = new Time_1.Time(21, 54);
scriptTest125_4.text = '기존 카드와는 다르게 카드 번호와 보안 코드 없이 유효기간만 표시돼 있습니다.';
let scriptTest125_5 = new Script_1.Script();
scriptTest125_5.startTime = new Time_1.Time(21, 54);
scriptTest125_5.endTime = new Time_1.Time(24, 69);
scriptTest125_5.text = '대신 모바일 앱에서 정보를 확인하는 방식인데요.';
let scriptTest125_6 = new Script_1.Script();
scriptTest125_6.startTime = new Time_1.Time(24, 69);
scriptTest125_6.endTime = new Time_1.Time(33, 8);
scriptTest125_6.text = '앞서 하나카드도 실물 카드에 카드 번호와 CVV 표기 여부를 고객이 직접 선택할 수 있는 옵션을 도입하기도 했습니다.';
let scriptTest125_7 = new Script_1.Script();
scriptTest125_7.startTime = new Time_1.Time(33, 8);
scriptTest125_7.endTime = new Time_1.Time(41, 39);
scriptTest125_7.text = '이는 금융위원회가 소비자 선택에 따라 실물 카드에 카드 번호와 보안 코드를 생략할 수 있도록 제도를 개선한 데 따른 건데요.';
let scriptTest125_8 = new Script_1.Script();
scriptTest125_8.startTime = new Time_1.Time(41, 39);
scriptTest125_8.endTime = new Time_1.Time(47, 28);
scriptTest125_8.text = '분실된 카드의 카드 정보를 이용해서 온라인 결제를 하는 부정 사용 피해를 줄이려는 조치입니다.';
let scriptTest125_9 = new Script_1.Script();
scriptTest125_9.startTime = new Time_1.Time(47, 28);
scriptTest125_9.endTime = new Time_1.Time(60, 17);
scriptTest125_9.text = '하지만 카드 번호나 보안 코드를 요구하는 일부 해외 매장에서는 이런 카드를 사용하는 게 불편할 수 있고, 금융 앱을 잘 활용하지 못하는 사람은 쓰기가 어려울 거라는 우려도 있습니다.';
//126번 뉴스
let tagTest126_1 = new Tag_1.Tag();
tagTest126_1.name = '헤어질결심';
let tagTest126_2 = new Tag_1.Tag();
tagTest126_2.name = '박찬욱';
let tagTest126_3 = new Tag_1.Tag();
tagTest126_3.name = '영화';
let scriptTest126_1 = new Script_1.Script();
scriptTest126_1.startTime = new Time_1.Time(0, 0);
scriptTest126_1.endTime = new Time_1.Time(2, 69);
scriptTest126_1.text = '문화 연예 플러스입니다.';
let scriptTest126_2 = new Script_1.Script();
scriptTest126_2.startTime = new Time_1.Time(2, 69);
scriptTest126_2.endTime = new Time_1.Time(9, 74);
scriptTest126_2.text = '칸 국제영화제 감독상을 받은 박찬욱 감독의 영화 헤어질 결심이 촬영 현장 사진을 대거 공개했는데요.';
let scriptTest126_3 = new Script_1.Script();
scriptTest126_3.startTime = new Time_1.Time(9, 74);
scriptTest126_3.endTime = new Time_1.Time(16, 85);
scriptTest126_3.text = '주연을 맡은 박해일과 탕웨이뿐만 아니라 이정현과 박정민, 김신영 등 친근한 얼굴들이 눈에 띕니다.';
let scriptTest126_4 = new Script_1.Script();
scriptTest126_4.startTime = new Time_1.Time(16, 85);
scriptTest126_4.endTime = new Time_1.Time(24, 44);
scriptTest126_4.text = '박감독은 특히 코미디언 김신영에 대한 애정을 드러냈는데요.';
let scriptTest126_5 = new Script_1.Script();
scriptTest126_5.startTime = new Time_1.Time(24, 44);
scriptTest126_5.endTime = new Time_1.Time(30, 75);
scriptTest126_5.text = '행님아 때부터 팬이었고 코미디를 잘하는 사람은 다른 연기도 잘한다는 확신을 갖고 캐스팅했다고 말했습니다.';
let scriptTest126_6 = new Script_1.Script();
scriptTest126_6.startTime = new Time_1.Time(30, 75);
scriptTest126_6.endTime = new Time_1.Time(35, 81);
scriptTest126_6.text = '또 그 이상으로 잘해줘 보배라 생각한다며 칭찬을 아끼지 않았는데요.';
let scriptTest126_7 = new Script_1.Script();
scriptTest126_7.startTime = new Time_1.Time(35, 81);
scriptTest126_7.endTime = new Time_1.Time(43, 24);
scriptTest126_7.text = '주인공 박해일의 아내를 연기한 이정현과 용의자를 맡은 박정민 사진도 공개돼 영화에 대한 궁금증을 자아냈습니다.';
let scriptTest126_8 = new Script_1.Script();
scriptTest126_8.startTime = new Time_1.Time(43, 24);
scriptTest126_8.endTime = new Time_1.Time(46, 98);
scriptTest126_8.text = '수사 멜로극 헤어질 결심은 다음 주 수요일 개봉합니다.';
// 127번 뉴스
let tagTest127_1 = new Tag_1.Tag();
tagTest127_1.name = '이준석';
let tagTest127_2 = new Tag_1.Tag();
tagTest127_2.name = '박지현';
let tagTest127_3 = new Tag_1.Tag();
tagTest127_3.name = '청년대표';
let scriptTest127_1 = new Script_1.Script();
scriptTest127_1.startTime = new Time_1.Time(0, 0);
scriptTest127_1.endTime = new Time_1.Time(7, 76);
scriptTest127_1.text = '얼마 전까지만 해도 청년 정치의 상징이던 여야 대표들이 나란히 어려움에 처해있습니다.';
let scriptTest127_2 = new Script_1.Script();
scriptTest127_2.startTime = new Time_1.Time(7, 76);
scriptTest127_2.endTime = new Time_1.Time(19, 24);
scriptTest127_2.text = '오늘부로 당원권 정지가 확정된 국민의힘 이준석 대표는 장외 정치 중이고, 민주당 박지현 전 비대위원장은 당 대표 출마 서류 접수조차 거부당했습니다.';
let scriptTest127_3 = new Script_1.Script();
scriptTest127_3.startTime = new Time_1.Time(19, 24);
scriptTest127_3.endTime = new Time_1.Time(21, 69);
scriptTest127_3.text = '강청완 기자의 보도입니다.';
// 128번 뉴스
let tagTest128_1 = new Tag_1.Tag();
tagTest128_1.name = '코로나19';
let tagTest128_2 = new Tag_1.Tag();
tagTest128_2.name = '수학여행';
let tagTest128_3 = new Tag_1.Tag();
tagTest128_3.name = '159명확진';
let scriptTest128_1 = new Script_1.Script();
scriptTest128_1.startTime = new Time_1.Time(0, 0);
scriptTest128_1.endTime = new Time_1.Time(2, 57);
scriptTest128_1.text = '다음은 코로나 소식으로 이어가겠습니다.';
let scriptTest128_2 = new Script_1.Script();
scriptTest128_2.startTime = new Time_1.Time(2, 57);
scriptTest128_2.endTime = new Time_1.Time(6, 97);
scriptTest128_2.text = '추가 확진자는 이틀 연속 7만 명대를 기록했습니다.';
let scriptTest128_3 = new Script_1.Script();
scriptTest128_3.startTime = new Time_1.Time(6, 97);
scriptTest128_3.endTime = new Time_1.Time(14, 63);
scriptTest128_3.text = '확진자들의 나이대를 분석해보면, 최근 들어서 20대가 가장 많고 그다음이 10대가 많았습니다.';
let scriptTest128_4 = new Script_1.Script();
scriptTest128_4.startTime = new Time_1.Time(14, 63);
scriptTest128_4.endTime = new Time_1.Time(24, 40);
scriptTest128_4.text = '특히 10대 청소년들 사이에서 환자가 빠르게 늘고 있는데, 수학여행을 다녀온 한 고등학교에서 100명 넘는 확진자가 나왔습니다.';
let scriptTest128_5 = new Script_1.Script();
scriptTest128_5.startTime = new Time_1.Time(24, 40);
scriptTest128_5.endTime = new Time_1.Time(26, 32);
scriptTest128_5.text = '유덕기 기자입니다.';
// 129번 뉴스
let tagTest129_1 = new Tag_1.Tag();
tagTest129_1.name = '콜롬비아';
let tagTest129_2 = new Tag_1.Tag();
tagTest129_2.name = '마약';
let tagTest129_3 = new Tag_1.Tag();
tagTest129_3.name = '마리화나';
let scriptTest129_1 = new Script_1.Script();
scriptTest129_1.startTime = new Time_1.Time(0, 0);
scriptTest129_1.endTime = new Time_1.Time(13, 22);
scriptTest129_1.text = 'SNS를 통해 오늘 하루 관심사와 솔직한 반응을 알아보는 오클릭 시간입니다.';
let scriptTest129_2 = new Script_1.Script();
scriptTest129_2.startTime = new Time_1.Time(13, 22);
scriptTest129_2.endTime = new Time_1.Time(19, 12);
scriptTest129_2.text = '콜롬비아의 한 마을에서 주민 수백 명이 집단으로 마약에 취하는 사건이 벌어졌습니다.';
let scriptTest129_3 = new Script_1.Script();
scriptTest129_3.startTime = new Time_1.Time(19, 12);
scriptTest129_3.endTime = new Time_1.Time(23, 14);
scriptTest129_3.text = '오클릭 첫 번째 검색어는 마리화나 연기 테러입니다.';
let scriptTest129_4 = new Script_1.Script();
scriptTest129_4.startTime = new Time_1.Time(23, 14);
scriptTest129_4.endTime = new Time_1.Time(29, 14);
scriptTest129_4.text = '콜롬비아의 한 마을 외곽에서 하얀 연기가 솟구칩니다.';
let scriptTest129_5 = new Script_1.Script();
scriptTest129_5.startTime = new Time_1.Time(29, 14);
scriptTest129_5.endTime = new Time_1.Time(37, 69);
scriptTest129_5.text = '이상한 냄새를 풍기는 연기가 계속해서 피어오르는 걸 보고 주민들은 긴급 대피했는데 연기는 단순한 화재 때문이 아니었습니다.';
let scriptTest129_6 = new Script_1.Script();
scriptTest129_6.startTime = new Time_1.Time(37, 69);
scriptTest129_6.endTime = new Time_1.Time(48, 88);
scriptTest129_6.text = '콜롬비아 경찰이 인근에서 트럭에 실어 운반하던 마리화나 1.6톤을 압류했는데 압류한 마리화나를 전량 소각하기 위해 장소를 물색하다 군부대를 선택한 겁니다.';
let scriptTest129_7 = new Script_1.Script();
scriptTest129_7.startTime = new Time_1.Time(48, 88);
scriptTest129_7.endTime = new Time_1.Time(54, 51);
scriptTest129_7.text = '하지만 부대와 마을은 예상보다 가까웠고 연기는 순식간에 마을을 덮쳤습니다.';
let scriptTest129_8 = new Script_1.Script();
scriptTest129_8.startTime = new Time_1.Time(54, 51);
scriptTest129_8.endTime = new Time_1.Time(60, 26);
scriptTest129_8.text = '주민들은 특유의 냄새와 환각 효과 때문에 두통과 어지럼증 등 고통을 호소했는데요.';
let scriptTest129_9 = new Script_1.Script();
scriptTest129_9.startTime = new Time_1.Time(60, 26);
scriptTest129_9.endTime = new Time_1.Time(70, 52);
scriptTest129_9.text = '그러면서 압류한 마리화나를 소각하는 건 당연하지만 왜 하필이면 민가와 가까운 곳이냐, 결정을 내린 사람을 찾아 책임을 물어야 한다고 항의했습니다.';
let scriptTest129_10 = new Script_1.Script();
scriptTest129_10.startTime = new Time_1.Time(70, 52);
scriptTest129_10.endTime = new Time_1.Time(75, 34);
scriptTest129_10.text = '누리꾼들은 말 그대로 테러네요. 경찰이 뭐 이렇게 허술하죠?';
let scriptTest129_11 = new Script_1.Script();
scriptTest129_11.startTime = new Time_1.Time(75, 34);
scriptTest129_11.endTime = new Time_1.Time(81, 36);
scriptTest129_11.text = '어렵게 압류해서 주민에게 마시게 한 셈이라니 황당하다라는 반응을 보였습니다.';
// 130번 뉴스
let tagTest130_1 = new Tag_1.Tag();
tagTest130_1.name = '2030';
let tagTest130_2 = new Tag_1.Tag();
tagTest130_2.name = '이재명';
let tagTest130_3 = new Tag_1.Tag();
tagTest130_3.name = '윤석열';
let scriptTest130_1 = new Script_1.Script();
scriptTest130_1.startTime = new Time_1.Time(0, 0);
scriptTest130_1.endTime = new Time_1.Time(3, 13);
scriptTest130_1.text = '시청자 여러분, 뉴스룸을 시작하겠습니다.';
let scriptTest130_2 = new Script_1.Script();
scriptTest130_2.startTime = new Time_1.Time(3, 13);
scriptTest130_2.endTime = new Time_1.Time(9, 12);
scriptTest130_2.text = '이재명·윤석열 두 후보, 오늘도 2030 세대에게 구애하는 행보를 이어갔습니다.';
let scriptTest130_3 = new Script_1.Script();
scriptTest130_3.startTime = new Time_1.Time(9, 12);
scriptTest130_3.endTime = new Time_1.Time(16, 61);
scriptTest130_3.text = '이재명 후보는 2030 연구원을 만났고, 윤석열 후보는 야구점퍼 입고 청년들 많은 야구장을 찾았습니다.';
let scriptTest130_4 = new Script_1.Script();
scriptTest130_4.startTime = new Time_1.Time(16, 61);
scriptTest130_4.endTime = new Time_1.Time(25, 84);
scriptTest130_4.text = '행사 내용만 달라졌을 뿐 요즘 두 후보는 그야말로 2030에 올인하는 모습인데, 공들이는 만큼의 지지율은 나오지 않고 있습니다.';
let scriptTest130_5 = new Script_1.Script();
scriptTest130_5.startTime = new Time_1.Time(25, 84);
scriptTest130_5.endTime = new Time_1.Time(32, 8);
scriptTest130_5.text = '그러면서 청년층의 마음을 얻었던 패자 홍준표 의원의 활동폭이 커지는 모습인데요.';
let scriptTest130_6 = new Script_1.Script();
scriptTest130_6.startTime = new Time_1.Time(32, 8);
scriptTest130_6.endTime = new Time_1.Time(37, 82);
scriptTest130_6.text = '먼저 황예린 기자가 이재명·윤석열 두 후보의 오늘 행보부터 전해드립니다.';
// 131번 뉴스
let tagTest131_1 = new Tag_1.Tag();
tagTest131_1.name = '러시아';
let tagTest131_2 = new Tag_1.Tag();
tagTest131_2.name = '천연가스';
let tagTest131_3 = new Tag_1.Tag();
tagTest131_3.name = '유럽';
let scriptTest131_1 = new Script_1.Script();
scriptTest131_1.startTime = new Time_1.Time(0, 0);
scriptTest131_1.endTime = new Time_1.Time(8, 26);
scriptTest131_1.text = '러시아의 우크라이나 침공에서 비롯된 위기가 올겨울 세계 에너지 대란으로 번질거라는 전망이 나오고 있는데요.';
let scriptTest131_2 = new Script_1.Script();
scriptTest131_2.startTime = new Time_1.Time(8, 26);
scriptTest131_2.endTime = new Time_1.Time(14, 22);
scriptTest131_2.text = '유럽은 러시아에서 들어오는 천연가스가 끊길거라는 위기감이 커지고 있습니다.';
let scriptTest131_3 = new Script_1.Script();
scriptTest131_3.startTime = new Time_1.Time(14, 22);
scriptTest131_3.endTime = new Time_1.Time(22, 6);
scriptTest131_3.text = '우리나라도 이런 위기를 피해가긴 어려울거라는 우려가 나오고 있는데 배주환 기자가 자세히 전해드리겠습니다.';
// 132번 뉴스
let tagTest132_1 = new Tag_1.Tag();
tagTest132_1.name = '미국';
let tagTest132_2 = new Tag_1.Tag();
tagTest132_2.name = '사이버공격';
let tagTest132_3 = new Tag_1.Tag();
tagTest132_3.name = '국방부';
let scriptTest132_1 = new Script_1.Script();
scriptTest132_1.startTime = new Time_1.Time(0, 0);
scriptTest132_1.endTime = new Time_1.Time(7, 4);
scriptTest132_1.text = '남북은 내일 오전 판문점 평화의집에서 고위급회담을 열고 평양공동선언 이행안을 논의합니다.';
let scriptTest132_2 = new Script_1.Script();
scriptTest132_2.startTime = new Time_1.Time(7, 4);
scriptTest132_2.endTime = new Time_1.Time(14, 44);
scriptTest132_2.text = '통일부에 따르면 조명균 통일부 장관과 북측 리선권 조평통 위원장을 수석대표로 하는 남북 대표단이 내일 오전 고위급 회담을 진행합니다.';
let scriptTest132_3 = new Script_1.Script();
scriptTest132_3.startTime = new Time_1.Time(14, 44);
scriptTest132_3.endTime = new Time_1.Time(20, 6);
scriptTest132_3.text = '대표단에는 우리측 김정렬 국토교통부 2차관, 북측 김윤혁 철도성 부상과 박호영 국토환경보호성 부상 등 철도.도로 분야를 담당하는 고위 당국자가 포함됐습니다.';
let scriptTest132_4 = new Script_1.Script();
scriptTest132_4.startTime = new Time_1.Time(20, 6);
scriptTest132_4.endTime = new Time_1.Time(32, 75);
scriptTest132_4.text = '따라서 이번 회담에서는 정부가 이달 중으로 추진 중인 북측 철도·도로공동조사 논의가 집중적으로 이뤄질 것으로 보입니다.';
// 133번 뉴스
let tagTest133_1 = new Tag_1.Tag();
tagTest133_1.name = '채식';
let tagTest133_2 = new Tag_1.Tag();
tagTest133_2.name = '급식';
let tagTest133_3 = new Tag_1.Tag();
tagTest133_3.name = '탄소배출';
let scriptTest133_1 = new Script_1.Script();
scriptTest133_1.startTime = new Time_1.Time(0, 0);
scriptTest133_1.endTime = new Time_1.Time(5, 59);
scriptTest133_1.text = '탄소 배출을 줄이기 위한 채식 급식이 이달부터 서울지역 전 학교에 도입됩니다.';
let scriptTest133_2 = new Script_1.Script();
scriptTest133_2.startTime = new Time_1.Time(5, 59);
scriptTest133_2.endTime = new Time_1.Time(15, 46);
scriptTest133_2.text = '서울시교육청은 학생들이 기후 위기에 대응해 육식 섭취를 줄이는 습관을 들이도록 매달 두 차례 그린 급식의 날을 운영한다고 밝혔습니다.';
let scriptTest133_3 = new Script_1.Script();
scriptTest133_3.startTime = new Time_1.Time(15, 46);
scriptTest133_3.endTime = new Time_1.Time(21, 97);
scriptTest133_3.text = '시 교육청은 또 관련 교육을 기존 교육과정과 연계해 운영할 방침이라고 덧붙였습니다.';
// 134번 뉴스
let tagTest134_1 = new Tag_1.Tag();
tagTest134_1.name = '북한';
let tagTest134_2 = new Tag_1.Tag();
tagTest134_2.name = '판문점';
let tagTest134_3 = new Tag_1.Tag();
tagTest134_3.name = '고위급회담';
let scriptTest134_1 = new Script_1.Script();
scriptTest134_1.startTime = new Time_1.Time(0, 0);
scriptTest134_1.endTime = new Time_1.Time(7, 42);
scriptTest134_1.text = '남북은 내일 오전 판문점 평화의집에서 고위급회담을 열고 평양공동선언 이행안을 논의합니다.';
let scriptTest134_2 = new Script_1.Script();
scriptTest134_2.startTime = new Time_1.Time(7, 42);
scriptTest134_2.endTime = new Time_1.Time(18, 26);
scriptTest134_2.text = '통일부에 따르면 조명균 통일부 장관과 북측 리선권 조평통 위원장을 수석대표로 하는 남북 대표단이 내일 오전 고위급 회담을 진행합니다.';
let scriptTest134_3 = new Script_1.Script();
scriptTest134_3.startTime = new Time_1.Time(18, 26);
scriptTest134_3.endTime = new Time_1.Time(30, 69);
scriptTest134_3.text = '대표단에는 우리측 김정렬 국토교통부 2차관, 북측 김윤혁 철도성 부상과 박호영 국토환경보호성 부상 등 철도.도로 분야를 담당하는 고위 당국자가 포함됐습니다.';
let scriptTest134_4 = new Script_1.Script();
scriptTest134_4.startTime = new Time_1.Time(30, 69);
scriptTest134_4.endTime = new Time_1.Time(39, 92);
scriptTest134_4.text = '따라서 이번 회담에서는 정부가 이달 중으로 추진 중인 북측 철도·도로공동조사 논의가 집중적으로 이뤄질 것으로 보입니다.';
// 135번 뉴스
let tagTest135_1 = new Tag_1.Tag();
tagTest135_1.name = '미국';
let tagTest135_2 = new Tag_1.Tag();
tagTest135_2.name = '바이든';
let tagTest135_3 = new Tag_1.Tag();
tagTest135_3.name = '사우디아라비아';
let scriptTest135_1 = new Script_1.Script();
scriptTest135_1.startTime = new Time_1.Time(0, 0);
scriptTest135_1.endTime = new Time_1.Time(7, 31);
scriptTest135_1.text = '조 바이든 미국 대통령이 현지 시간으로 15일 중동 방문 마지막 대상국인 사우디아라비아에 도착했습니다.';
let scriptTest135_2 = new Script_1.Script();
scriptTest135_2.startTime = new Time_1.Time(7, 31);
scriptTest135_2.endTime = new Time_1.Time(18, 46);
scriptTest135_2.text = '바이든 대통령은 사우디 해변 도시 제다의 왕궁에 도착해 전용 리무진에서 내린 다음 마중 나온 무함마드 빈 살만 사우디 왕세자와 주먹으로 인사를 나눴습니다.';
let scriptTest135_3 = new Script_1.Script();
scriptTest135_3.startTime = new Time_1.Time(18, 46);
scriptTest135_3.endTime = new Time_1.Time(23, 67);
scriptTest135_3.text = '바이든 대통령은 이어 빈 살만 왕세자 등과 확대 실무 회의를 했습니다.';
let scriptTest135_4 = new Script_1.Script();
scriptTest135_4.startTime = new Time_1.Time(23, 67);
scriptTest135_4.endTime = new Time_1.Time(37, 23);
...
// 136번 뉴스
let tagTest136_1 = new Tag_1.Tag();
tagTest136_1.name = 'MBTI';
let tagTest136_2 = new Tag_1.Tag();
tagTest136_2.name = '성격검사';
let tagTest136_3 = new Tag_1.Tag();
tagTest136_3.name = '선입견';
let scriptTest136_1 = new Script_1.Script();
scriptTest136_1.startTime = new Time_1.Time(0, 0);
scriptTest136_1.endTime = new Time_1.Time(4, 16);
scriptTest136_1.text = '\'엠비티아이\' 검사라고, 한 번쯤 들어보셨을 겁니다.';
let scriptTest136_2 = new Script_1.Script();
scriptTest136_2.startTime = new Time_1.Time(4, 16);
scriptTest136_2.endTime = new Time_1.Time(13, 71);
scriptTest136_2.text = '간단한 문답을 통해서 사람 성격을 열여섯 가지로 구분하는데 자신이 어떤 성향인지, 줄줄 외우고 있는 젊은이들도 많습니다.';
let scriptTest136_3 = new Script_1.Script();
scriptTest136_3.startTime = new Time_1.Time(13, 71);
scriptTest136_3.endTime = new Time_1.Time(18, 15);
scriptTest136_3.text = '혈액형이나 별자리로 성격을 따져보던 것과는 또 다르죠.';
let scriptTest136_4 = new Script_1.Script();
scriptTest136_4.startTime = new Time_1.Time(18, 15);
scriptTest136_4.endTime = new Time_1.Time(27, 5);
scriptTest136_4.text = '그런데 이런 구분 짓기가 재미로 알아보거나 가볍게 참고하는 데 그치는 게 아니라 실제 채용에까지 영향을 미치기도 합니다.';
let scriptTest136_5 = new Script_1.Script();
scriptTest136_5.startTime = new Time_1.Time(27, 5);
scriptTest136_5.endTime = new Time_1.Time(32, 74);
scriptTest136_5.text = '아르바이트생을 뽑는데 이렇게 MBTI를 따지는 사례가 알려져 논란이 되기도 했습니다.';
let scriptTest136_6 = new Script_1.Script();
scriptTest136_6.startTime = new Time_1.Time(32, 74);
scriptTest136_6.endTime = new Time_1.Time(40, 5);
scriptTest136_6.text = '다양한 성향을 이해하기보다 상대를 쉽게 단정 짓고, 또 편견을 만든다는 지적도 나옵니다.';
let scriptTest136_7 = new Script_1.Script();
scriptTest136_7.startTime = new Time_1.Time(40, 5);
scriptTest136_7.endTime = new Time_1.Time(43, 62);
scriptTest136_7.text = '이충헌 의학 전문기자가 취재했습니다.';
// 137번 뉴스
let tagTest137_1 = new Tag_1.Tag();
tagTest137_1.name = '유럽';
let tagTest137_2 = new Tag_1.Tag();
tagTest137_2.name = '독일';
let tagTest137_3 = new Tag_1.Tag();
tagTest137_3.name = '소녀상';
let scriptTest137_1 = new Script_1.Script();
scriptTest137_1.startTime = new Time_1.Time(0, 0);
scriptTest137_1.endTime = new Time_1.Time(6, 79);
scriptTest137_1.text = '독일의 한 주립대학에 일본군 위안부 피해자의 상징인 평화의 소녀상이 설치됐습니다.';
let scriptTest137_2 = new Script_1.Script();
scriptTest137_2.startTime = new Time_1.Time(6, 79);
scriptTest137_2.endTime = new Time_1.Time(14, 19);
scriptTest137_2.text = '최근 베를린 소녀상이 어려운 상황에 처한 사실을 알게 된 독일 학생들이 자발적으로 설치를 이끌어 낸 건데요.';
let scriptTest137_3 = new Script_1.Script();
scriptTest137_3.startTime = new Time_1.Time(14, 19);
scriptTest137_3.endTime = new Time_1.Time(19, 68);
scriptTest137_3.text = '소녀상이 영원히 자리 잡게 된 학교에 김귀수 특파원이 다녀왔습니다.';
// 138번 뉴스
let tagTest138_1 = new Tag_1.Tag();
tagTest138_1.name = '코로나19';
let tagTest138_2 = new Tag_1.Tag();
tagTest138_2.name = '스리랑카';
let tagTest138_3 = new Tag_1.Tag();
tagTest138_3.name = '전쟁';
let scriptTest138_1 = new Script_1.Script();
scriptTest138_1.startTime = new Time_1.Time(0, 0);
scriptTest138_1.endTime = new Time_1.Time(5, 99);
scriptTest138_1.text = '3년째 이어지고 있는 코로나19 대유행 러시아와 우크라이나의 전쟁까지.';
let scriptTest138_2 = new Script_1.Script();
scriptTest138_2.startTime = new Time_1.Time(5, 99);
scriptTest138_2.endTime = new Time_1.Time(11, 92);
scriptTest138_2.text = '전세계에 영향을 끼치는 이런 일들은 가난한 나라들부터 타격을 주고 있습니다.';
let scriptTest138_3 = new Script_1.Script();
scriptTest138_3.startTime = new Time_1.Time(11, 92);
scriptTest138_3.endTime = new Time_1.Time(18, 55);
scriptTest138_3.text = '동남아의 스리랑카는 최악의 경제 위기로 전기가 끊겼고 상점들도 문을 닫았는데요.';
let scriptTest138_4 = new Script_1.Script();
scriptTest138_4.startTime = new Time_1.Time(18, 55);
scriptTest138_4.endTime = new Time_1.Time(22, 52);
scriptTest138_4.text = '대통령의 퇴진을 요구하는 시위도 거세게 일고 있습니다.';
let scriptTest138_5 = new Script_1.Script();
scriptTest138_5.startTime = new Time_1.Time(22, 52);
scriptTest138_5.endTime = new Time_1.Time(24, 98);
scriptTest138_5.text = '박소희 기자가 전해드리겠습니다.';
// 139번 뉴스
let tagTest139_1 = new Tag_1.Tag();
tagTest139_1.name = '핵전쟁';
let tagTest139_2 = new Tag_1.Tag();
tagTest139_2.name = '우크라이나';
let tagTest139_3 = new Tag_1.Tag();
tagTest139_3.name = '러시아';
let scriptTest139_1 = new Script_1.Script();
scriptTest139_1.startTime = new Time_1.Time(6, 84);
scriptTest139_1.endTime = new Time_1.Time(10, 58);
scriptTest139_1.text = '핵사용을 대놓고 언급하는 건 북한뿐만이 아닙니다.';
let scriptTest139_2 = new Script_1.Script();
scriptTest139_2.startTime = new Time_1.Time(10, 58);
scriptTest139_2.endTime = new Time_1.Time(16, 41);
scriptTest139_2.text = '우크라이나에서 고전하고 있는 러시아는 핵전쟁을 들먹이며 서방을 위협하고 있습니다.';
let scriptTest139_3 = new Script_1.Script();
scriptTest139_3.startTime = new Time_1.Time(16, 41);
scriptTest139_3.endTime = new Time_1.Time(25, 71);
scriptTest139_3.text = '여기에 미국과 맞서는 중국은 핵무기 수를 빠르게 늘리고 있고 미국도 유사시에는 핵무기를 사용할 수 있다며 맞서고 있죠.';
let scriptTest139_4 = new Script_1.Script();
scriptTest139_4.startTime = new Time_1.Time(25, 71);
scriptTest139_4.endTime = new Time_1.Time(32, 94);
scriptTest139_4.text = '냉전 이후 그동안 잊고 있던 핵전쟁이 난데 없이 실제로 일어날 수 있다는 위기감이 퍼지고 있습니다.';
let scriptTest139_5 = new Script_1.Script();
scriptTest139_5.startTime = new Time_1.Time(32, 94);
scriptTest139_5.endTime = new Time_1.Time(36, 68);
scriptTest139_5.text = '권희진 국제 문제 전문 기자가 자세히 전해드립니다.';
// 140번 뉴스
let tagTest140_1 = new Tag_1.Tag();
tagTest140_1.name = '퀴어축제';
let tagTest140_2 = new Tag_1.Tag();
tagTest140_2.name = '성소수자';
let tagTest140_3 = new Tag_1.Tag();
tagTest140_3.name = '차별금지';
let scriptTest140_1 = new Script_1.Script();
scriptTest140_1.startTime = new Time_1.Time(0, 0);
scriptTest140_1.endTime = new Time_1.Time(7, 45);
scriptTest140_1.text = '코로나19로 멈췄던 다양성 축제의 장 서울 퀴어축제가 3년 만에 다시 열렸습니다.';
let scriptTest140_2 = new Script_1.Script();
scriptTest140_2.startTime = new Time_1.Time(7, 45);
scriptTest140_2.endTime = new Time_1.Time(12, 32);
scriptTest140_2.text = '이번 축제에는 주최 측 추산으로 10만 명이 넘는 시민들이 모였는데요.';
let scriptTest140_3 = new Script_1.Script();
scriptTest140_3.startTime = new Time_1.Time(12, 32);
scriptTest140_3.endTime = new Time_1.Time(17, 61);
scriptTest140_3.text = '주한 미국대사 등 여러 외국 대사들도 참여해서 함께 차별 금지를 외쳤습니다.';
let scriptTest140_4 = new Script_1.Script();
scriptTest140_4.startTime = new Time_1.Time(17, 61);
scriptTest140_4.endTime = new Time_1.Time(20, 36);
scriptTest140_4.text = '김정우 기자가 다녀왔습니다.';
const insertNewsData = (connection) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const tagRepository = yield Tag_1.Tag.getRepository();
    const scriptRepository = yield Script_1.Script.getRepository();
    yield tagRepository.query(`set FOREIGN_KEY_CHECKS = 0`);
    yield tagRepository.clear();
    yield scriptRepository.query(`set FOREIGN_KEY_CHECKS = 0`);
    yield scriptRepository.clear();
    yield newsRepository.query(`set FOREIGN_KEY_CHECKS = 0`);
    yield newsRepository.clear();
    yield tagRepository.query(`set FOREIGN_KEY_CHECKS = 1`);
    yield scriptRepository.query(`set FOREIGN_KEY_CHECKS = 1`);
    yield newsRepository.query(`set FOREIGN_KEY_CHECKS = 1`);
    // 추천 태그 객체 생성
    ...
    const newsInfo = [
        // 1번 뉴스
        {
            ...
            category: Category_1.Category.ECONOMY,
            tags: [tag1_1, tag1_2, tag1_3, tagRecommend],
            scripts: [script1_1, script1_2, script1_3, script1_4, script1_5],
            announcerGender: Gender_1.Gender.MEN,
            channel: Channel_1.Channel.SBS,
            link: 'S_gtbu2VRlI',
            thumbnail: 'https://img.youtube.com/vi/S_gtbu2VRlI/hqdefault.jpg',
            startTime: new Time_1.Time(0, 0),
            endTime: new Time_1.Time(35, 4),
            suitability: Suitability_1.Suitability.HIGH,
            isEmbeddable: true,
        ...
        // 3번 뉴스
        {
            ...
            announcerGender: Gender_1.Gender.WOMEN,
            channel: Channel_1.Channel.SBS,
            link: '45IAfzlB_tQ',
            thumbnail: 'https://img.youtube.com/vi/45IAfzlB_tQ/hqdefault.jpg',
            startTime: new Time_1.Time(0, 0),
            endTime: new Time_1.Time(37, 80),
            suitability: Suitability_1.Suitability.HIGH,
            isEmbeddable: true,
        ...
        // 5번 뉴스
        {
            ...
            category: Category_1.Category.POLITICS,
        ...
        // 6번 뉴스
        {
            ...
            category: Category_1.Category.WORLD,
        ...
        // 7번 뉴스
        {
            ...
            startTime: new Time_1.Time(0, 0),
            endTime: new Time_1.Time(42, 78),
            suitability: Suitability_1.Suitability.MEDIUM,
            isEmbeddable: true,
        ...
        // 15번 뉴스
        {
            ...
            category: Category_1.Category.ENTERTAINMENT,
        ...
        // 37번 뉴스
        {
            ...
            startTime: new Time_1.Time(10, 33),
            endTime: new Time_1.Time(65, 34),
            suitability: Suitability_1.Suitability.HIGH,
            isEmbeddable: true,
            reportDate: new Date('2022-07-05'),
        },
        ...
        // 48번 뉴스            
        {
            ...
            category: Category_1.Category.UNSPECIFIED,
            ...
            startTime: new Time_1.Time(0, 0),
            endTime: new Time_1.Time(39, 16),
            suitability: Suitability_1.Suitability.UNSPECIFIED,
            isEmbeddable: true,
        ...
        // 94번 뉴스
        {
            ...
            startTime: new Time_1.Time(7, 23),
            endTime: new Time_1.Time(69, 41),
            suitability: Suitability_1.Suitability.HIGH,
            isEmbeddable: true,
            reportDate: new Date('2022-07-14'),
        },
        ...
        // 99번 뉴스            
        {
            ...
            startTime: new Time_1.Time(8, 84),
            endTime: new Time_1.Time(57, 39),
            suitability: Suitability_1.Suitability.HIGH,
            isEmbeddable: true,
        ...
        // 104번 뉴스            
        {
            ...
            startTime: new Time_1.Time(0, 0),
            endTime: new Time_1.Time(149, 78),
            suitability: Suitability_1.Suitability.HIGH,
            isEmbeddable: true,
        ...
        // 105번 뉴스            
        {
            ...
            startTime: new Time_1.Time(0, 0),
            endTime: new Time_1.Time(136, 48),
            suitability: Suitability_1.Suitability.HIGH,
            isEmbeddable: true,
            reportDate: new Date('2022-05-23'),
        },
        ...
        // 110번 뉴스            
        {
            ...
            startTime: new Time_1.Time(8, 98),
            endTime: new Time_1.Time(39, 74),
            suitability: Suitability_1.Suitability.HIGH,
            isEmbeddable: true,
    ...
    const news2 = yield newsRepository.save(news);
    for (let i in news2) {
        // console.log(i);
        const news3 = yield newsRepository.find({
            relations: ['tags'],
            where: {
                id: news2[i].id,
            },
...
// insertNewsData();
// 
//# sourceMappingURL=insertNews.js.map