...
describe.skip('GET /v2/highlight', () => {
	it('하이라이트 조회 성공', done => {
...
describe.skip('POST /v2/highlight/create', () => {
	it('하이라이트 생성 성공', done => {
		request('http://127.0.0.1:8080')
...
describe.skip('POST /v2/highlight/remove', () => {
	it('하이라이트 삭제 성공', done => {
		request('http://127.0.0.1:8080')
...
describe.skip('POST /v2/highlight/memo/add', () => {
	it('메모 추가 성공', done => {
		request('http://127.0.0.1:8080')
...
describe.skip('POST /v2/highlight/memo/update', () => {
	it('메모 수정 성공', done => {
		request('http://127.0.0.1:8080')
...
describe.skip('POST /v2/highlight/memo/remove', () => {
	it('메모 삭제 성공', done => {
		request('http://127.0.0.1:8080')
